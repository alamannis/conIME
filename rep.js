function roCon(strIn) {
	...
	val = val.replace(/sjis/g,'찃');
	val = val.replace(/sjiz/g,'찄');
	val = val.replace(/sjil/g,'쯸');
	val = val.replace(/sjin/g,'쯴');
	val = val.replace(/sjit/g,'찉');
	val = val.replace(/sjid/g,'쯷');
	val = val.replace(/sjim/g,'찀');
	val = val.replace(/sjip/g,'찊');
	val = val.replace(/sjib/g,'찁');
	val = val.replace(/sjic/g,'찋');
	val = val.replace(/sjif/g,'쯾');
	val = val.replace(/sjiv/g,'찂');
	val = val.replace(/sjich/g,'찆');
	val = val.replace(/sjidj/g,'찇');
	val = val.replace(/sjik/g,'찈');
	val = val.replace(/sjig/g,'쯱');
	val = val.replace(/sji/g,'쯰');
	val = val.replace(/sjiq/g,'찅');
	...
	val = val.replace(/sjus/g,'쭛');
	val = val.replace(/sjuz/g,'쭜');
	val = val.replace(/sjul/g,'쭐');
	val = val.replace(/sjun/g,'쭌');
	val = val.replace(/sjut/g,'쭡');
	val = val.replace(/sjud/g,'쭏');
	val = val.replace(/sjum/g,'쭘');
	val = val.replace(/sjup/g,'쭢');
	val = val.replace(/sjub/g,'쭙');
	val = val.replace(/sjuc/g,'쭣');
	val = val.replace(/sjuf/g,'쭖');
	val = val.replace(/sjuv/g,'쭚');
	val = val.replace(/sjuch/g,'쭞');
	val = val.replace(/sjudj/g,'쭟');
	val = val.replace(/sjuk/g,'쭠');
	val = val.replace(/sjug/g,'쭉');
	val = val.replace(/sju/g,'쭈');
	val = val.replace(/sjuq/g,'쭝');
	...
	val = val.replace(/sjes/g,'쪳');
	val = val.replace(/sjez/g,'쪴');
	val = val.replace(/sjel/g,'쪨');
	val = val.replace(/sjen/g,'쪤');
	val = val.replace(/sjet/g,'쪹');
	val = val.replace(/sjed/g,'쪧');
	val = val.replace(/sjem/g,'쪰');
	val = val.replace(/sjep/g,'쪺');
	val = val.replace(/sjeb/g,'쪱');
	val = val.replace(/sjec/g,'쪻');
	val = val.replace(/sjef/g,'쪮');
	val = val.replace(/sjev/g,'쪲');
	val = val.replace(/sjech/g,'쪶');
	val = val.replace(/sjedj/g,'쪷');
	val = val.replace(/sjek/g,'쪸');
	val = val.replace(/sjeg/g,'쪡');
	val = val.replace(/sje/g,'쪠');
	val = val.replace(/sjeq/g,'쪵');
	...
	val = val.replace(/sjos/g,'쬿');
	val = val.replace(/sjoz/g,'쭀');
	val = val.replace(/sjol/g,'쬴');
	val = val.replace(/sjon/g,'쬰');
	val = val.replace(/sjot/g,'쭅');
	val = val.replace(/sjod/g,'쬳');
	val = val.replace(/sjom/g,'쬼');
	val = val.replace(/sjop/g,'쭆');
	val = val.replace(/sjob/g,'쬽');
	val = val.replace(/sjoc/g,'쭇');
	val = val.replace(/sjof/g,'쬺');
	val = val.replace(/sjov/g,'쬾');
	val = val.replace(/sjoch/g,'쭂');
	val = val.replace(/sjodj/g,'쭃');
	val = val.replace(/sjok/g,'쭄');
	val = val.replace(/sjog/g,'쬭');
	val = val.replace(/sjo/g,'쬬');
	val = val.replace(/sjoq/g,'쭁');
	...
	val = val.replace(/swoch/g,'쬦');
	val = val.replace(/swodj/g,'쬧');
	val = val.replace(/swok/g,'쬨');
	val = val.replace(/swog/g,'쬑');
	val = val.replace(/swo/g,'쬐');
	val = val.replace(/swoq/g,'쬥');
	val = val.replace(/sjès/g,'쪗');
	val = val.replace(/sjèz/g,'쪘');
	val = val.replace(/sjèl/g,'쪌');
	val = val.replace(/sjèn/g,'쪈');
	val = val.replace(/sjèt/g,'쪝');
	val = val.replace(/sjèd/g,'쪋');
	val = val.replace(/sjèm/g,'쪔');
	val = val.replace(/sjèp/g,'쪞');
	val = val.replace(/sjèb/g,'쪕');
	val = val.replace(/sjèc/g,'쪟');
	val = val.replace(/sjèf/g,'쪒');
	val = val.replace(/sjèv/g,'쪖');
	val = val.replace(/sjèch/g,'쪚');
	val = val.replace(/sjèdj/g,'쪛');
	val = val.replace(/sjèk/g,'쪜');
	val = val.replace(/sjèg/g,'쪅');
	val = val.replace(/sjè/g,'쪄');
	val = val.replace(/sjèq/g,'쪙');
	...
	val = val.replace(/swèch/g,'쭺');
	val = val.replace(/swèdj/g,'쭻');
	val = val.replace(/swèk/g,'쭼');
	val = val.replace(/swèg/g,'쭥');
	val = val.replace(/swè/g,'쭤');
	val = val.replace(/swèq/g,'쭹');
	val = val.replace(/sjùs/g,'쩃');
	val = val.replace(/sjùz/g,'쩄');
	val = val.replace(/sjùl/g,'쨸');
	val = val.replace(/sjùn/g,'쨴');
	val = val.replace(/sjùt/g,'쩉');
	val = val.replace(/sjùd/g,'쨷');
	val = val.replace(/sjùm/g,'쩀');
	val = val.replace(/sjùp/g,'쩊');
	val = val.replace(/sjùb/g,'쩁');
	val = val.replace(/sjùc/g,'쩋');
	val = val.replace(/sjùf/g,'쨾');
	val = val.replace(/sjùv/g,'쩂');
	val = val.replace(/sjùch/g,'쩆');
	val = val.replace(/sjùdj/g,'쩇');
	val = val.replace(/sjùk/g,'쩈');
	val = val.replace(/sjùg/g,'쨱');
	val = val.replace(/sjù/g,'쨰');
	val = val.replace(/sjùq/g,'쩅');
	...
	val = val.replace(/swùch/g,'쬊');
	val = val.replace(/swùdj/g,'쬋');
	val = val.replace(/swùk/g,'쬌');
	val = val.replace(/swùg/g,'쫵');
	val = val.replace(/swù/g,'쫴');
	val = val.replace(/swùq/g,'쬉');
	val = val.replace(/sjas/g,'쨧');
	val = val.replace(/sjaz/g,'쨨');
	val = val.replace(/sjal/g,'쨜');
	val = val.replace(/sjan/g,'쨘');
	val = val.replace(/sjat/g,'쨭');
	val = val.replace(/sjad/g,'쨛');
	val = val.replace(/sjam/g,'쨤');
	val = val.replace(/sjap/g,'쨮');
	val = val.replace(/sjab/g,'쨥');
	val = val.replace(/sjac/g,'쨯');
	val = val.replace(/sjaf/g,'쨢');
	val = val.replace(/sjav/g,'쨦');
	val = val.replace(/sjach/g,'쨪');
	val = val.replace(/sjadj/g,'쨫');
	val = val.replace(/sjak/g,'쨬');
	val = val.replace(/sjag/g,'쨕');
	val = val.replace(/sja/g,'쨔');
	val = val.replace(/sjaq/g,'쨩');
	...
	val = val.replace(/swach/g,'쫮');
	val = val.replace(/swadj/g,'쫯');
	...
	val = val.replace(/zjis/g,'씟');
	val = val.replace(/zjiz/g,'씠');
	val = val.replace(/zjil/g,'씔');
	val = val.replace(/zjin/g,'씐');
	val = val.replace(/zjit/g,'씥');
	val = val.replace(/zjid/g,'씓');
	val = val.replace(/zjim/g,'씜');
	val = val.replace(/zjip/g,'씦');
	val = val.replace(/zjib/g,'씝');
	val = val.replace(/zjic/g,'씧');
	val = val.replace(/zjif/g,'씚');
	val = val.replace(/zjiv/g,'씞');
	val = val.replace(/zjich/g,'씢');
	val = val.replace(/zjidj/g,'씣');
	val = val.replace(/zjik/g,'씤');
	val = val.replace(/zjig/g,'씍');
	val = val.replace(/zji/g,'씌');
	val = val.replace(/zjiq/g,'씡');
	...
	val = val.replace(/zwich/g,'쓎');
	val = val.replace(/zwidj/g,'쓏');
	val = val.replace(/zwik/g,'쓐');
	val = val.replace(/zwig/g,'쒹');
	val = val.replace(/zwi/g,'쒸');
	val = val.replace(/zwiq/g,'쓍');
	val = val.replace(/zjus/g,'쑷');
	val = val.replace(/zjuz/g,'쑸');
	val = val.replace(/zjul/g,'쑬');
	val = val.replace(/zjun/g,'쑨');
	val = val.replace(/zjut/g,'쑽');
	val = val.replace(/zjud/g,'쑫');
	val = val.replace(/zjum/g,'쑴');
	val = val.replace(/zjup/g,'쑾');
	val = val.replace(/zjub/g,'쑵');
	val = val.replace(/zjuc/g,'쑿');
	val = val.replace(/zjuf/g,'쑲');
	val = val.replace(/zjuv/g,'쑶');
	val = val.replace(/zjuch/g,'쑺');
	val = val.replace(/zjudj/g,'쑻');
	val = val.replace(/zjuk/g,'쑼');
	val = val.replace(/zjug/g,'쑥');
	val = val.replace(/zju/g,'쑤');
	val = val.replace(/zjuq/g,'쑹');
	...
	val = val.replace(/zwuch/g,'쓪');
	val = val.replace(/zwudj/g,'쓫');
	val = val.replace(/zwuk/g,'쓬');
	val = val.replace(/zwug/g,'쓕');
	val = val.replace(/zwu/g,'쓔');
	val = val.replace(/zwuq/g,'쓩');
	val = val.replace(/zjes/g,'쏏');
	val = val.replace(/zjez/g,'쏐');
	val = val.replace(/zjel/g,'쏄');
	val = val.replace(/zjen/g,'쏀');
	val = val.replace(/zjet/g,'쏕');
	val = val.replace(/zjed/g,'쏃');
	val = val.replace(/zjem/g,'쏌');
	val = val.replace(/zjep/g,'쏖');
	val = val.replace(/zjeb/g,'쏍');
	val = val.replace(/zjec/g,'쏗');
	val = val.replace(/zjef/g,'쏊');
	val = val.replace(/zjev/g,'쏎');
	val = val.replace(/zjech/g,'쏒');
	val = val.replace(/zjedj/g,'쏓');
	val = val.replace(/zjek/g,'쏔');
	val = val.replace(/zjeg/g,'쎽');
	val = val.replace(/zje/g,'쎼');
	val = val.replace(/zjeq/g,'쏑');
	...
	val = val.replace(/zwech/g,'쒲');
	val = val.replace(/zwedj/g,'쒳');
	val = val.replace(/zwek/g,'쒴');
	val = val.replace(/zweg/g,'쒝');
	val = val.replace(/zwe/g,'쒜');
	val = val.replace(/zweq/g,'쒱');
	val = val.replace(/zjos/g,'쑛');
	val = val.replace(/zjoz/g,'쑜');
	val = val.replace(/zjol/g,'쑐');
	val = val.replace(/zjon/g,'쑌');
	val = val.replace(/zjot/g,'쑡');
	val = val.replace(/zjod/g,'쑏');
	val = val.replace(/zjom/g,'쑘');
	val = val.replace(/zjop/g,'쑢');
	val = val.replace(/zjob/g,'쑙');
	val = val.replace(/zjoc/g,'쑣');
	val = val.replace(/zjof/g,'쑖');
	val = val.replace(/zjov/g,'쑚');
	val = val.replace(/zjoch/g,'쑞');
	val = val.replace(/zjodj/g,'쑟');
	val = val.replace(/zjok/g,'쑠');
	val = val.replace(/zjog/g,'쑉');
	val = val.replace(/zjo/g,'쑈');
	val = val.replace(/zjoq/g,'쑝');
	...
	val = val.replace(/zjès/g,'쎳');
	val = val.replace(/zjèz/g,'쎴');
	val = val.replace(/zjèl/g,'쎨');
	val = val.replace(/zjèn/g,'쎤');
	val = val.replace(/zjèt/g,'쎹');
	val = val.replace(/zjèd/g,'쎧');
	val = val.replace(/zjèm/g,'쎰');
	val = val.replace(/zjèp/g,'쎺');
	val = val.replace(/zjèb/g,'쎱');
	val = val.replace(/zjèc/g,'쎻');
	val = val.replace(/zjèf/g,'쎮');
	val = val.replace(/zjèv/g,'쎲');
	val = val.replace(/zjèch/g,'쎶');
	val = val.replace(/zjèdj/g,'쎷');
	val = val.replace(/zjèk/g,'쎸');
	val = val.replace(/zjèg/g,'쎡');
	val = val.replace(/zjè/g,'쎠');
	val = val.replace(/zjèq/g,'쎵');
	...
	val = val.replace(/zjùs/g,'썟');
	val = val.replace(/zjùz/g,'썠');
	val = val.replace(/zjùl/g,'썔');
	val = val.replace(/zjùn/g,'썐');
	val = val.replace(/zjùt/g,'썥');
	val = val.replace(/zjùd/g,'썓');
	val = val.replace(/zjùm/g,'썜');
	val = val.replace(/zjùp/g,'썦');
	val = val.replace(/zjùb/g,'썝');
	val = val.replace(/zjùc/g,'썧');
	val = val.replace(/zjùf/g,'썚');
	val = val.replace(/zjùv/g,'썞');
	val = val.replace(/zjùch/g,'썢');
	val = val.replace(/zjùdj/g,'썣');
	val = val.replace(/zjùk/g,'썤');
	val = val.replace(/zjùg/g,'썍');
	val = val.replace(/zjù/g,'썌');
	val = val.replace(/zjùq/g,'썡');
	...
	val = val.replace(/zjas/g,'썃');
	val = val.replace(/zjaz/g,'썄');
	val = val.replace(/zjal/g,'쌸');
	val = val.replace(/zjan/g,'쌴');
	val = val.replace(/zjat/g,'썉');
	val = val.replace(/zjad/g,'쌷');
	val = val.replace(/zjam/g,'썀');
	val = val.replace(/zjap/g,'썊');
	val = val.replace(/zjab/g,'썁');
	val = val.replace(/zjac/g,'썋');
	val = val.replace(/zjaf/g,'쌾');
	val = val.replace(/zjav/g,'썂');
	val = val.replace(/zjach/g,'썆');
	val = val.replace(/zjadj/g,'썇');
	val = val.replace(/zjak/g,'썈');
	val = val.replace(/zjag/g,'쌱');
	val = val.replace(/zja/g,'쌰');
	val = val.replace(/zjaq/g,'썅');
	...
	val = val.replace(/tsjis/g,'띗');
	val = val.replace(/tsjiz/g,'띘');
	val = val.replace(/tsjil/g,'띌');
	val = val.replace(/tsjin/g,'띈');
	val = val.replace(/tsjit/g,'띝');
	val = val.replace(/tsjid/g,'띋');
	val = val.replace(/tsjim/g,'띔');
	val = val.replace(/tsjip/g,'띞');
	val = val.replace(/tsjib/g,'띕');
	val = val.replace(/tsjic/g,'띟');
	val = val.replace(/tsjif/g,'띒');
	val = val.replace(/tsjiv/g,'띖');
	val = val.replace(/tsjich/g,'띚');
	val = val.replace(/tsjidj/g,'띛');
	val = val.replace(/tsjik/g,'띜');
	val = val.replace(/tsjig/g,'띅');
	val = val.replace(/tsji/g,'띄');
	val = val.replace(/tsjiq/g,'띙');
	...
	val = val.replace(/tswich/g,'뜆');
	val = val.replace(/tswidj/g,'뜇');
	val = val.replace(/tswik/g,'뜈');
	val = val.replace(/tswig/g,'뛱');
	val = val.replace(/tswi/g,'뛰');
	val = val.replace(/tswiq/g,'뜅');
	val = val.replace(/tsjus/g,'뚯');
	val = val.replace(/tsjuz/g,'뚰');
	val = val.replace(/tsjul/g,'뚤');
	val = val.replace(/tsjun/g,'뚠');
	val = val.replace(/tsjut/g,'뚵');
	val = val.replace(/tsjud/g,'뚣');
	val = val.replace(/tsjum/g,'뚬');
	val = val.replace(/tsjup/g,'뚶');
	val = val.replace(/tsjub/g,'뚭');
	val = val.replace(/tsjuc/g,'뚷');
	val = val.replace(/tsjuf/g,'뚪');
	val = val.replace(/tsjuv/g,'뚮');
	val = val.replace(/tsjuch/g,'뚲');
	val = val.replace(/tsjudj/g,'뚳');
	val = val.replace(/tsjuk/g,'뚴');
	val = val.replace(/tsjug/g,'뚝');
	val = val.replace(/tsju/g,'뚜');
	val = val.replace(/tsjuq/g,'뚱');
	...
	val = val.replace(/tswuch/g,'뜢');
	val = val.replace(/tswudj/g,'뜣');
	val = val.replace(/tswuk/g,'뜤');
	val = val.replace(/tswug/g,'뜍');
	val = val.replace(/tswu/g,'뜌');
	val = val.replace(/tswuq/g,'뜡');
	val = val.replace(/tsjes/g,'똇');
	val = val.replace(/tsjez/g,'똈');
	val = val.replace(/tsjel/g,'뗼');
	val = val.replace(/tsjen/g,'뗸');
	val = val.replace(/tsjet/g,'똍');
	val = val.replace(/tsjed/g,'뗻');
	val = val.replace(/tsjem/g,'똄');
	val = val.replace(/tsjep/g,'똎');
	val = val.replace(/tsjeb/g,'똅');
	val = val.replace(/tsjec/g,'똏');
	val = val.replace(/tsjef/g,'똂');
	val = val.replace(/tsjev/g,'똆');
	val = val.replace(/tsjech/g,'똊');
	val = val.replace(/tsjedj/g,'똋');
	val = val.replace(/tsjek/g,'똌');
	val = val.replace(/tsjeg/g,'뗵');
	val = val.replace(/tsje/g,'뗴');
	val = val.replace(/tsjeq/g,'똉');
	...
	val = val.replace(/tswech/g,'뛪');
	val = val.replace(/tswedj/g,'뛫');
	val = val.replace(/tswek/g,'뛬');
	val = val.replace(/tsweg/g,'뛕');
	val = val.replace(/tswe/g,'뛔');
	val = val.replace(/tsweq/g,'뛩');
	val = val.replace(/tsjos/g,'뚓');
	val = val.replace(/tsjoz/g,'뚔');
	val = val.replace(/tsjol/g,'뚈');
	val = val.replace(/tsjon/g,'뚄');
	val = val.replace(/tsjot/g,'뚙');
	val = val.replace(/tsjod/g,'뚇');
	val = val.replace(/tsjom/g,'뚐');
	val = val.replace(/tsjop/g,'뚚');
	val = val.replace(/tsjob/g,'뚑');
	val = val.replace(/tsjoc/g,'뚛');
	val = val.replace(/tsjof/g,'뚎');
	val = val.replace(/tsjov/g,'뚒');
	val = val.replace(/tsjoch/g,'뚖');
	val = val.replace(/tsjodj/g,'뚗');
	val = val.replace(/tsjok/g,'뚘');
	val = val.replace(/tsjog/g,'뚁');
	val = val.replace(/tsjo/g,'뚀');
	val = val.replace(/tsjoq/g,'뚕');
	...
	val = val.replace(/tswoch/g,'뙺');
	val = val.replace(/tswodj/g,'뙻');
	val = val.replace(/tswok/g,'뙼');
	val = val.replace(/tswog/g,'뙥');
	val = val.replace(/tswo/g,'뙤');
	val = val.replace(/tswoq/g,'뙹');
	val = val.replace(/tsjès/g,'뗫');
	val = val.replace(/tsjèz/g,'뗬');
	val = val.replace(/tsjèl/g,'뗠');
	val = val.replace(/tsjèn/g,'뗜');
	val = val.replace(/tsjèt/g,'뗱');
	val = val.replace(/tsjèd/g,'뗟');
	val = val.replace(/tsjèm/g,'뗨');
	val = val.replace(/tsjèp/g,'뗲');
	val = val.replace(/tsjèb/g,'뗩');
	val = val.replace(/tsjèc/g,'뗳');
	val = val.replace(/tsjèf/g,'뗦');
	val = val.replace(/tsjèv/g,'뗪');
	val = val.replace(/tsjèch/g,'뗮');
	val = val.replace(/tsjèdj/g,'뗯');
	val = val.replace(/tsjèk/g,'뗰');
	val = val.replace(/tsjèg/g,'뗙');
	val = val.replace(/tsjè/g,'뗘');
	val = val.replace(/tsjèq/g,'뗭');
	...
	val = val.replace(/tswèch/g,'뛎');
	val = val.replace(/tswèdj/g,'뛏');
	val = val.replace(/tswèk/g,'뛐');
	val = val.replace(/tswèg/g,'뚹');
	val = val.replace(/tswè/g,'뚸');
	val = val.replace(/tswèq/g,'뛍');
	val = val.replace(/tsjùs/g,'떗');
	val = val.replace(/tsjùz/g,'떘');
	val = val.replace(/tsjùl/g,'떌');
	val = val.replace(/tsjùn/g,'떈');
	val = val.replace(/tsjùt/g,'떝');
	val = val.replace(/tsjùd/g,'떋');
	val = val.replace(/tsjùm/g,'떔');
	val = val.replace(/tsjùp/g,'떞');
	val = val.replace(/tsjùb/g,'떕');
	val = val.replace(/tsjùc/g,'떟');
	val = val.replace(/tsjùf/g,'떒');
	val = val.replace(/tsjùv/g,'떖');
	val = val.replace(/tsjùch/g,'떚');
	val = val.replace(/tsjùdj/g,'떛');
	val = val.replace(/tsjùk/g,'떜');
	val = val.replace(/tsjùg/g,'떅');
	val = val.replace(/tsjù/g,'떄');
	val = val.replace(/tsjùq/g,'떙');
	...
	val = val.replace(/tswùch/g,'뙞');
	val = val.replace(/tswùdj/g,'뙟');
	val = val.replace(/tswùk/g,'뙠');
	val = val.replace(/tswùg/g,'뙉');
	val = val.replace(/tswù/g,'뙈');
	val = val.replace(/tswùq/g,'뙝');
	val = val.replace(/tsjas/g,'땻');
	val = val.replace(/tsjaz/g,'땼');
	val = val.replace(/tsjal/g,'땰');
	val = val.replace(/tsjan/g,'땬');
	val = val.replace(/tsjat/g,'떁');
	val = val.replace(/tsjad/g,'땯');
	val = val.replace(/tsjam/g,'땸');
	val = val.replace(/tsjap/g,'떂');
	val = val.replace(/tsjab/g,'땹');
	val = val.replace(/tsjac/g,'떃');
	val = val.replace(/tsjaf/g,'땶');
	val = val.replace(/tsjav/g,'땺');
	val = val.replace(/tsjach/g,'땾');
	val = val.replace(/tsjadj/g,'땿');
	val = val.replace(/tsjak/g,'떀');
	val = val.replace(/tsjag/g,'땩');
	val = val.replace(/tsja/g,'땨');
	val = val.replace(/tsjaq/g,'땽');
	...
	val = val.replace(/tswach/g,'뙂');
	val = val.replace(/tswadj/g,'뙃');
	...
	val = val.replace(/dzuch/g,'쁮');
	val = val.replace(/dzudj/g,'쁯');
	...
	val = val.replace(/dzich/g,'삦');
	val = val.replace(/dzidj/g,'삧');
	...
	val = val.replace(/dzùch/g,'뺒');
	val = val.replace(/dzùdj/g,'뺓');
	...
	val = val.replace(/dzèch/g,'뻦');
	val = val.replace(/dzèdj/g,'뻧');
	...
	val = val.replace(/dzoch/g,'뽖');
	val = val.replace(/dzodj/g,'뽗');
	...
	val = val.replace(/dzech/g,'뼂');
	val = val.replace(/dzedj/g,'뼃');
	...
	val = val.replace(/dzach/g,'빶');
	val = val.replace(/dzadj/g,'빷');
	val = val.replace(/dzak/g,'빸');
	val = val.replace(/dzag/g,'빡');
	val = val.replace(/dza/g,'빠');
	val = val.replace(/dzaq/g,'빵');
	val = val.replace(/dzjis/g,'삇');
	val = val.replace(/dzjiz/g,'삈');
	val = val.replace(/dzjil/g,'쁼');
	val = val.replace(/dzjin/g,'쁸');
	val = val.replace(/dzjit/g,'삍');
	val = val.replace(/dzjid/g,'쁻');
	val = val.replace(/dzjim/g,'삄');
	val = val.replace(/dzjip/g,'삎');
	val = val.replace(/dzjib/g,'삅');
	val = val.replace(/dzjic/g,'삏');
	val = val.replace(/dzjif/g,'삂');
	val = val.replace(/dzjiv/g,'삆');
	val = val.replace(/dzjich/g,'삊');
	val = val.replace(/dzjidj/g,'삋');
	val = val.replace(/dzjik/g,'삌');
	val = val.replace(/dzjig/g,'쁵');
	val = val.replace(/dzji/g,'쁴');
	val = val.replace(/dzjiq/g,'삉');
	val = val.replace(/dzwis/g,'쀳');
	val = val.replace(/dzwiz/g,'쀴');
	val = val.replace(/dzwil/g,'쀨');
	val = val.replace(/dzwin/g,'쀤');
	val = val.replace(/dzwit/g,'쀹');
	val = val.replace(/dzwid/g,'쀧');
	val = val.replace(/dzwim/g,'쀰');
	val = val.replace(/dzwip/g,'쀺');
	val = val.replace(/dzwib/g,'쀱');
	val = val.replace(/dzwic/g,'쀻');
	val = val.replace(/dzwif/g,'쀮');
	val = val.replace(/dzwiv/g,'쀲');
	val = val.replace(/dzwich/g,'쀶');
	val = val.replace(/dzwidj/g,'쀷');
	val = val.replace(/dzwik/g,'쀸');
	val = val.replace(/dzwig/g,'쀡');
	val = val.replace(/dzwi/g,'쀠');
	val = val.replace(/dzwiq/g,'쀵');
	val = val.replace(/dzjus/g,'뿟');
	val = val.replace(/dzjuz/g,'뿠');
	val = val.replace(/dzjul/g,'뿔');
	val = val.replace(/dzjun/g,'뿐');
	val = val.replace(/dzjut/g,'뿥');
	val = val.replace(/dzjud/g,'뿓');
	val = val.replace(/dzjum/g,'뿜');
	val = val.replace(/dzjup/g,'뿦');
	val = val.replace(/dzjub/g,'뿝');
	val = val.replace(/dzjuc/g,'뿧');
	val = val.replace(/dzjuf/g,'뿚');
	val = val.replace(/dzjuv/g,'뿞');
	val = val.replace(/dzjuch/g,'뿢');
	val = val.replace(/dzjudj/g,'뿣');
	val = val.replace(/dzjuk/g,'뿤');
	val = val.replace(/dzjug/g,'뿍');
	val = val.replace(/dzju/g,'뿌');
	val = val.replace(/dzjuq/g,'뿡');
	val = val.replace(/dzwus/g,'쁏');
	val = val.replace(/dzwuz/g,'쁐');
	val = val.replace(/dzwul/g,'쁄');
	val = val.replace(/dzwun/g,'쁀');
	val = val.replace(/dzwut/g,'쁕');
	val = val.replace(/dzwud/g,'쁃');
	val = val.replace(/dzwum/g,'쁌');
	val = val.replace(/dzwup/g,'쁖');
	val = val.replace(/dzwub/g,'쁍');
	val = val.replace(/dzwuc/g,'쁗');
	val = val.replace(/dzwuf/g,'쁊');
	val = val.replace(/dzwuv/g,'쁎');
	val = val.replace(/dzwuch/g,'쁒');
	val = val.replace(/dzwudj/g,'쁓');
	val = val.replace(/dzwuk/g,'쁔');
	val = val.replace(/dzwug/g,'쀽');
	val = val.replace(/dzwu/g,'쀼');
	val = val.replace(/dzwuq/g,'쁑');
	val = val.replace(/dzjes/g,'뼷');
	val = val.replace(/dzjez/g,'뼸');
	val = val.replace(/dzjel/g,'뼬');
	val = val.replace(/dzjen/g,'뼨');
	val = val.replace(/dzjet/g,'뼽');
	val = val.replace(/dzjed/g,'뼫');
	val = val.replace(/dzjem/g,'뼴');
	val = val.replace(/dzjep/g,'뼾');
	val = val.replace(/dzjeb/g,'뼵');
	val = val.replace(/dzjec/g,'뼿');
	val = val.replace(/dzjef/g,'뼲');
	val = val.replace(/dzjev/g,'뼶');
	val = val.replace(/dzjech/g,'뼺');
	val = val.replace(/dzjedj/g,'뼻');
	val = val.replace(/dzjek/g,'뼼');
	val = val.replace(/dzjeg/g,'뼥');
	val = val.replace(/dzje/g,'뼤');
	val = val.replace(/dzjeq/g,'뼹');
	val = val.replace(/dzwes/g,'쀗');
	val = val.replace(/dzwez/g,'쀘');
	val = val.replace(/dzwel/g,'쀌');
	val = val.replace(/dzwen/g,'쀈');
	val = val.replace(/dzwet/g,'쀝');
	val = val.replace(/dzwed/g,'쀋');
	val = val.replace(/dzwem/g,'쀔');
	val = val.replace(/dzwep/g,'쀞');
	val = val.replace(/dzweb/g,'쀕');
	val = val.replace(/dzwec/g,'쀟');
	val = val.replace(/dzwef/g,'쀒');
	val = val.replace(/dzwev/g,'쀖');
	val = val.replace(/dzwech/g,'쀚');
	val = val.replace(/dzwedj/g,'쀛');
	val = val.replace(/dzwek/g,'쀜');
	val = val.replace(/dzweg/g,'쀅');
	val = val.replace(/dzwe/g,'쀄');
	val = val.replace(/dzweq/g,'쀙');
	val = val.replace(/dzjos/g,'뿃');
	val = val.replace(/dzjoz/g,'뿄');
	val = val.replace(/dzjol/g,'뾸');
	val = val.replace(/dzjon/g,'뾴');
	val = val.replace(/dzjot/g,'뿉');
	val = val.replace(/dzjod/g,'뾷');
	val = val.replace(/dzjom/g,'뿀');
	val = val.replace(/dzjop/g,'뿊');
	val = val.replace(/dzjob/g,'뿁');
	val = val.replace(/dzjoc/g,'뿋');
	val = val.replace(/dzjof/g,'뾾');
	val = val.replace(/dzjov/g,'뿂');
	val = val.replace(/dzjoch/g,'뿆');
	val = val.replace(/dzjodj/g,'뿇');
	val = val.replace(/dzjok/g,'뿈');
	val = val.replace(/dzjog/g,'뾱');
	val = val.replace(/dzjo/g,'뾰');
	val = val.replace(/dzjoq/g,'뿅');
	val = val.replace(/dzwos/g,'뾧');
	val = val.replace(/dzwoz/g,'뾨');
	val = val.replace(/dzwol/g,'뾜');
	val = val.replace(/dzwon/g,'뾘');
	val = val.replace(/dzwot/g,'뾭');
	val = val.replace(/dzwod/g,'뾛');
	val = val.replace(/dzwom/g,'뾤');
	val = val.replace(/dzwop/g,'뾮');
	val = val.replace(/dzwob/g,'뾥');
	val = val.replace(/dzwoc/g,'뾯');
	val = val.replace(/dzwof/g,'뾢');
	val = val.replace(/dzwov/g,'뾦');
	val = val.replace(/dzwoch/g,'뾪');
	val = val.replace(/dzwodj/g,'뾫');
	val = val.replace(/dzwok/g,'뾬');
	val = val.replace(/dzwog/g,'뾕');
	val = val.replace(/dzwo/g,'뾔');
	val = val.replace(/dzwoq/g,'뾩');
	val = val.replace(/dzjès/g,'뼛');
	val = val.replace(/dzjèz/g,'뼜');
	val = val.replace(/dzjèl/g,'뼐');
	val = val.replace(/dzjèn/g,'뼌');
	val = val.replace(/dzjèt/g,'뼡');
	val = val.replace(/dzjèd/g,'뼏');
	val = val.replace(/dzjèm/g,'뼘');
	val = val.replace(/dzjèp/g,'뼢');
	val = val.replace(/dzjèb/g,'뼙');
	val = val.replace(/dzjèc/g,'뼣');
	val = val.replace(/dzjèf/g,'뼖');
	val = val.replace(/dzjèv/g,'뼚');
	val = val.replace(/dzjèch/g,'뼞');
	val = val.replace(/dzjèdj/g,'뼟');
	val = val.replace(/dzjèk/g,'뼠');
	val = val.replace(/dzjèg/g,'뼉');
	val = val.replace(/dzjè/g,'뼈');
	val = val.replace(/dzjèq/g,'뼝');
	val = val.replace(/dzwès/g,'뿻');
	val = val.replace(/dzwèz/g,'뿼');
	val = val.replace(/dzwèl/g,'뿰');
	val = val.replace(/dzwèn/g,'뿬');
	val = val.replace(/dzwèt/g,'쀁');
	val = val.replace(/dzwèd/g,'뿯');
	val = val.replace(/dzwèm/g,'뿸');
	val = val.replace(/dzwèp/g,'쀂');
	val = val.replace(/dzwèb/g,'뿹');
	val = val.replace(/dzwèc/g,'쀃');
	val = val.replace(/dzwèf/g,'뿶');
	val = val.replace(/dzwèv/g,'뿺');
	val = val.replace(/dzwèch/g,'뿾');
	val = val.replace(/dzwèdj/g,'뿿');
	val = val.replace(/dzwèk/g,'쀀');
	val = val.replace(/dzwèg/g,'뿩');
	val = val.replace(/dzwè/g,'뿨');
	val = val.replace(/dzwèq/g,'뿽');
	val = val.replace(/dzjùs/g,'뻇');
	val = val.replace(/dzjùz/g,'뻈');
	val = val.replace(/dzjùl/g,'뺼');
	val = val.replace(/dzjùn/g,'뺸');
	val = val.replace(/dzjùt/g,'뻍');
	val = val.replace(/dzjùd/g,'뺻');
	val = val.replace(/dzjùm/g,'뻄');
	val = val.replace(/dzjùp/g,'뻎');
	val = val.replace(/dzjùb/g,'뻅');
	val = val.replace(/dzjùc/g,'뻏');
	val = val.replace(/dzjùf/g,'뻂');
	val = val.replace(/dzjùv/g,'뻆');
	val = val.replace(/dzjùch/g,'뻊');
	val = val.replace(/dzjùdj/g,'뻋');
	val = val.replace(/dzjùk/g,'뻌');
	val = val.replace(/dzjùg/g,'뺵');
	val = val.replace(/dzjù/g,'뺴');
	val = val.replace(/dzjùq/g,'뻉');
	val = val.replace(/dzwùs/g,'뾋');
	val = val.replace(/dzwùz/g,'뾌');
	val = val.replace(/dzwùl/g,'뾀');
	val = val.replace(/dzwùn/g,'뽼');
	val = val.replace(/dzwùt/g,'뾑');
	val = val.replace(/dzwùd/g,'뽿');
	val = val.replace(/dzwùm/g,'뾈');
	val = val.replace(/dzwùp/g,'뾒');
	val = val.replace(/dzwùb/g,'뾉');
	val = val.replace(/dzwùc/g,'뾓');
	val = val.replace(/dzwùf/g,'뾆');
	val = val.replace(/dzwùv/g,'뾊');
	val = val.replace(/dzwùch/g,'뾎');
	val = val.replace(/dzwùdj/g,'뾏');
	val = val.replace(/dzwùk/g,'뾐');
	val = val.replace(/dzwùg/g,'뽹');
	val = val.replace(/dzwù/g,'뽸');
	val = val.replace(/dzwùq/g,'뾍');
	val = val.replace(/dzjas/g,'뺫');
	val = val.replace(/dzjaz/g,'뺬');
	val = val.replace(/dzjal/g,'뺠');
	val = val.replace(/dzjan/g,'뺜');
	val = val.replace(/dzjat/g,'뺱');
	val = val.replace(/dzjad/g,'뺟');
	val = val.replace(/dzjam/g,'뺨');
	val = val.replace(/dzjap/g,'뺲');
	val = val.replace(/dzjab/g,'뺩');
	val = val.replace(/dzjac/g,'뺳');
	val = val.replace(/dzjaf/g,'뺦');
	val = val.replace(/dzjav/g,'뺪');
	val = val.replace(/dzjach/g,'뺮');
	val = val.replace(/dzjadj/g,'뺯');
	val = val.replace(/dzjak/g,'뺰');
	val = val.replace(/dzjag/g,'뺙');
	val = val.replace(/dzja/g,'뺘');
	val = val.replace(/dzjaq/g,'뺭');
	val = val.replace(/dzwas/g,'뽯');
	val = val.replace(/dzwaz/g,'뽰');
	val = val.replace(/dzwal/g,'뽤');
	val = val.replace(/dzwan/g,'뽠');
	val = val.replace(/dzwat/g,'뽵');
	val = val.replace(/dzwad/g,'뽣');
	val = val.replace(/dzwam/g,'뽬');
	val = val.replace(/dzwap/g,'뽶');
	val = val.replace(/dzwab/g,'뽭');
	val = val.replace(/dzwac/g,'뽷');
	val = val.replace(/dzwaf/g,'뽪');
	val = val.replace(/dzwav/g,'뽮');
	val = val.replace(/dzwach/g,'뽲');
	val = val.replace(/dzwadj/g,'뽳');
	val = val.replace(/dzwak/g,'뽴');
	val = val.replace(/dzwag/g,'뽝');
	val = val.replace(/dzwa/g,'뽜');
	val = val.replace(/dzwaq/g,'뽱');
	...
	val = val.replace(/ljis/g,'릣');
	val = val.replace(/ljiz/g,'릤');
	val = val.replace(/ljil/g,'릘');
	val = val.replace(/ljin/g,'릔');
	val = val.replace(/ljit/g,'릩');
	val = val.replace(/ljid/g,'릗');
	val = val.replace(/ljim/g,'릠');
	val = val.replace(/ljip/g,'릪');
	val = val.replace(/ljib/g,'릡');
	val = val.replace(/ljic/g,'릫');
	val = val.replace(/ljif/g,'릞');
	val = val.replace(/ljiv/g,'릢');
	val = val.replace(/ljich/g,'릦');
	val = val.replace(/ljidj/g,'릧');
	val = val.replace(/ljik/g,'릨');
	val = val.replace(/ljig/g,'릑');
	val = val.replace(/lji/g,'릐');
	val = val.replace(/ljiq/g,'릥');
	...
	val = val.replace(/lwich/g,'륒');
	val = val.replace(/lwidj/g,'륓');
	val = val.replace(/lwik/g,'륔');
	val = val.replace(/lwig/g,'뤽');
	val = val.replace(/lwi/g,'뤼');
	val = val.replace(/lwiq/g,'륑');
	val = val.replace(/ljus/g,'룻');
	val = val.replace(/ljuz/g,'룼');
	val = val.replace(/ljul/g,'룰');
	val = val.replace(/ljun/g,'룬');
	val = val.replace(/ljut/g,'뤁');
	val = val.replace(/ljud/g,'룯');
	val = val.replace(/ljum/g,'룸');
	val = val.replace(/ljup/g,'뤂');
	val = val.replace(/ljub/g,'룹');
	val = val.replace(/ljuc/g,'뤃');
	val = val.replace(/ljuf/g,'룶');
	val = val.replace(/ljuv/g,'룺');
	val = val.replace(/ljuch/g,'룾');
	val = val.replace(/ljudj/g,'룿');
	val = val.replace(/ljuk/g,'뤀');
	val = val.replace(/ljug/g,'룩');
	val = val.replace(/lju/g,'루');
	val = val.replace(/ljuq/g,'룽');
	...
	val = val.replace(/lwuch/g,'륮');
	val = val.replace(/lwudj/g,'륯');
	val = val.replace(/lwuk/g,'륰');
	val = val.replace(/lwug/g,'륙');
	val = val.replace(/lwu/g,'류');
	val = val.replace(/lwuq/g,'륭');
	val = val.replace(/ljes/g,'롓');
	val = val.replace(/ljez/g,'롔');
	val = val.replace(/ljel/g,'롈');
	val = val.replace(/ljen/g,'롄');
	val = val.replace(/ljet/g,'롙');
	val = val.replace(/ljed/g,'롇');
	val = val.replace(/ljem/g,'롐');
	val = val.replace(/ljep/g,'롚');
	val = val.replace(/ljeb/g,'롑');
	val = val.replace(/ljec/g,'롛');
	val = val.replace(/ljef/g,'롎');
	val = val.replace(/ljev/g,'롒');
	val = val.replace(/ljech/g,'롖');
	val = val.replace(/ljedj/g,'롗');
	val = val.replace(/ljek/g,'롘');
	val = val.replace(/ljeg/g,'롁');
	val = val.replace(/lje/g,'례');
	val = val.replace(/ljeq/g,'롕');
	...
	val = val.replace(/lwech/g,'뤶');
	val = val.replace(/lwedj/g,'뤷');
	val = val.replace(/lwek/g,'뤸');
	val = val.replace(/lweg/g,'뤡');
	val = val.replace(/lwe/g,'뤠');
	val = val.replace(/lweq/g,'뤵');
	val = val.replace(/ljos/g,'룟');
	val = val.replace(/ljoz/g,'룠');
	val = val.replace(/ljol/g,'룔');
	val = val.replace(/ljon/g,'룐');
	val = val.replace(/ljot/g,'룥');
	val = val.replace(/ljod/g,'룓');
	val = val.replace(/ljom/g,'룜');
	val = val.replace(/ljop/g,'룦');
	val = val.replace(/ljob/g,'룝');
	val = val.replace(/ljoc/g,'룧');
	val = val.replace(/ljof/g,'룚');
	val = val.replace(/ljov/g,'룞');
	val = val.replace(/ljoch/g,'룢');
	val = val.replace(/ljodj/g,'룣');
	val = val.replace(/ljok/g,'룤');
	val = val.replace(/ljog/g,'룍');
	val = val.replace(/ljo/g,'료');
	val = val.replace(/ljoq/g,'룡');
	...
	val = val.replace(/ljès/g,'렷');
	val = val.replace(/ljèz/g,'렸');
	val = val.replace(/ljèl/g,'렬');
	val = val.replace(/ljèn/g,'련');
	val = val.replace(/ljèt/g,'렽');
	val = val.replace(/ljèd/g,'렫');
	val = val.replace(/ljèm/g,'렴');
	val = val.replace(/ljèp/g,'렾');
	val = val.replace(/ljèb/g,'렵');
	val = val.replace(/ljèc/g,'렿');
	val = val.replace(/ljèf/g,'렲');
	val = val.replace(/ljèv/g,'렶');
	val = val.replace(/ljèch/g,'렺');
	val = val.replace(/ljèdj/g,'렻');
	val = val.replace(/ljèk/g,'렼');
	val = val.replace(/ljèg/g,'력');
	val = val.replace(/ljè/g,'려');
	val = val.replace(/ljèq/g,'령');
	...
	val = val.replace(/ljùs/g,'럣');
	val = val.replace(/ljùz/g,'럤');
	val = val.replace(/ljùl/g,'럘');
	val = val.replace(/ljùn/g,'럔');
	val = val.replace(/ljùt/g,'럩');
	val = val.replace(/ljùd/g,'럗');
	val = val.replace(/ljùm/g,'럠');
	val = val.replace(/ljùp/g,'럪');
	val = val.replace(/ljùb/g,'럡');
	val = val.replace(/ljùc/g,'럫');
	val = val.replace(/ljùf/g,'럞');
	val = val.replace(/ljùv/g,'럢');
	val = val.replace(/ljùch/g,'럦');
	val = val.replace(/ljùdj/g,'럧');
	val = val.replace(/ljùk/g,'럨');
	val = val.replace(/ljùg/g,'럑');
	val = val.replace(/ljù/g,'럐');
	val = val.replace(/ljùq/g,'럥');
	...
	val = val.replace(/ljas/g,'럇');
	val = val.replace(/ljaz/g,'럈');
	val = val.replace(/ljal/g,'랼');
	val = val.replace(/ljan/g,'랸');
	val = val.replace(/ljat/g,'럍');
	val = val.replace(/ljad/g,'랻');
	val = val.replace(/ljam/g,'럄');
	val = val.replace(/ljap/g,'럎');
	val = val.replace(/ljab/g,'럅');
	val = val.replace(/ljac/g,'럏');
	val = val.replace(/ljaf/g,'럂');
	val = val.replace(/ljav/g,'럆');
	val = val.replace(/ljach/g,'럊');
	val = val.replace(/ljadj/g,'럋');
	val = val.replace(/ljak/g,'럌');
	val = val.replace(/ljag/g,'략');
	val = val.replace(/lja/g,'랴');
	val = val.replace(/ljaq/g,'량');
	...
	val = val.replace(/njis/g,'늿');
	val = val.replace(/njiz/g,'닀');
	val = val.replace(/njil/g,'늴');
	val = val.replace(/njin/g,'늰');
	val = val.replace(/njit/g,'닅');
	val = val.replace(/njid/g,'늳');
	val = val.replace(/njim/g,'늼');
	val = val.replace(/njip/g,'닆');
	val = val.replace(/njib/g,'늽');
	val = val.replace(/njic/g,'닇');
	val = val.replace(/njif/g,'늺');
	val = val.replace(/njiv/g,'늾');
	val = val.replace(/njich/g,'닂');
	val = val.replace(/njidj/g,'닃');
	val = val.replace(/njik/g,'닄');
	val = val.replace(/njig/g,'늭');
	val = val.replace(/nji/g,'늬');
	val = val.replace(/njiq/g,'닁');
	...
	val = val.replace(/njus/g,'눗');
	val = val.replace(/njuz/g,'눘');
	val = val.replace(/njul/g,'눌');
	val = val.replace(/njun/g,'눈');
	val = val.replace(/njut/g,'눝');
	val = val.replace(/njud/g,'눋');
	val = val.replace(/njum/g,'눔');
	val = val.replace(/njup/g,'눞');
	val = val.replace(/njub/g,'눕');
	val = val.replace(/njuc/g,'눟');
	val = val.replace(/njuf/g,'눒');
	val = val.replace(/njuv/g,'눖');
	val = val.replace(/njuch/g,'눚');
	val = val.replace(/njudj/g,'눛');
	val = val.replace(/njuk/g,'눜');
	val = val.replace(/njug/g,'눅');
	val = val.replace(/nju/g,'누');
	val = val.replace(/njuq/g,'눙');
	...
	val = val.replace(/njes/g,'녯');
	val = val.replace(/njez/g,'녰');
	val = val.replace(/njel/g,'녤');
	val = val.replace(/njen/g,'녠');
	val = val.replace(/njet/g,'녵');
	val = val.replace(/njed/g,'녣');
	val = val.replace(/njem/g,'녬');
	val = val.replace(/njep/g,'녶');
	val = val.replace(/njeb/g,'녭');
	val = val.replace(/njec/g,'녷');
	val = val.replace(/njef/g,'녪');
	val = val.replace(/njev/g,'녮');
	val = val.replace(/njech/g,'녲');
	val = val.replace(/njedj/g,'녳');
	val = val.replace(/njek/g,'녴');
	val = val.replace(/njeg/g,'녝');
	val = val.replace(/nje/g,'녜');
	val = val.replace(/njeq/g,'녱');
	...
	val = val.replace(/njos/g,'뇻');
	val = val.replace(/njoz/g,'뇼');
	val = val.replace(/njol/g,'뇰');
	val = val.replace(/njon/g,'뇬');
	val = val.replace(/njot/g,'눁');
	val = val.replace(/njod/g,'뇯');
	val = val.replace(/njom/g,'뇸');
	val = val.replace(/njop/g,'눂');
	val = val.replace(/njob/g,'뇹');
	val = val.replace(/njoc/g,'눃');
	val = val.replace(/njof/g,'뇶');
	val = val.replace(/njov/g,'뇺');
	val = val.replace(/njoch/g,'뇾');
	val = val.replace(/njodj/g,'뇿');
	val = val.replace(/njok/g,'눀');
	val = val.replace(/njog/g,'뇩');
	val = val.replace(/njo/g,'뇨');
	val = val.replace(/njoq/g,'뇽');
	...
	val = val.replace(/njès/g,'녓');
	val = val.replace(/njèz/g,'녔');
	val = val.replace(/njèl/g,'녈');
	val = val.replace(/njèn/g,'년');
	val = val.replace(/njèt/g,'녙');
	val = val.replace(/njèd/g,'녇');
	val = val.replace(/njèm/g,'념');
	val = val.replace(/njèp/g,'녚');
	val = val.replace(/njèb/g,'녑');
	val = val.replace(/njèc/g,'녛');
	val = val.replace(/njèf/g,'녎');
	val = val.replace(/njèv/g,'녒');
	val = val.replace(/njèch/g,'녖');
	val = val.replace(/njèdj/g,'녗');
	val = val.replace(/njèk/g,'녘');
	val = val.replace(/njèg/g,'녁');
	val = val.replace(/njè/g,'녀');
	val = val.replace(/njèq/g,'녕');
	...
	val = val.replace(/njùs/g,'냿');
	val = val.replace(/njùz/g,'넀');
	val = val.replace(/njùl/g,'냴');
	val = val.replace(/njùn/g,'냰');
	val = val.replace(/njùt/g,'넅');
	val = val.replace(/njùd/g,'냳');
	val = val.replace(/njùm/g,'냼');
	val = val.replace(/njùp/g,'넆');
	val = val.replace(/njùb/g,'냽');
	val = val.replace(/njùc/g,'넇');
	val = val.replace(/njùf/g,'냺');
	val = val.replace(/njùv/g,'냾');
	val = val.replace(/njùch/g,'넂');
	val = val.replace(/njùdj/g,'넃');
	val = val.replace(/njùk/g,'넄');
	val = val.replace(/njùg/g,'냭');
	val = val.replace(/njù/g,'냬');
	val = val.replace(/njùq/g,'넁');
	...
	val = val.replace(/njas/g,'냣');
	val = val.replace(/njaz/g,'냤');
	val = val.replace(/njal/g,'냘');
	val = val.replace(/njan/g,'냔');
	val = val.replace(/njat/g,'냩');
	val = val.replace(/njad/g,'냗');
	val = val.replace(/njam/g,'냠');
	val = val.replace(/njap/g,'냪');
	val = val.replace(/njab/g,'냡');
	val = val.replace(/njac/g,'냫');
	val = val.replace(/njaf/g,'냞');
	val = val.replace(/njav/g,'냢');
	val = val.replace(/njach/g,'냦');
	val = val.replace(/njadj/g,'냧');
	val = val.replace(/njak/g,'냨');
	val = val.replace(/njag/g,'냑');
	val = val.replace(/nja/g,'냐');
	val = val.replace(/njaq/g,'냥');
	...
	val = val.replace(/tjis/g,'틧');
	val = val.replace(/tjiz/g,'틨');
	val = val.replace(/tjil/g,'틜');
	val = val.replace(/tjin/g,'틘');
	val = val.replace(/tjit/g,'틭');
	val = val.replace(/tjid/g,'틛');
	val = val.replace(/tjim/g,'틤');
	val = val.replace(/tjip/g,'틮');
	val = val.replace(/tjib/g,'틥');
	val = val.replace(/tjic/g,'틯');
	val = val.replace(/tjif/g,'틢');
	val = val.replace(/tjiv/g,'틦');
	val = val.replace(/tjich/g,'틪');
	val = val.replace(/tjidj/g,'틫');
	val = val.replace(/tjik/g,'틬');
	val = val.replace(/tjig/g,'틕');
	val = val.replace(/tji/g,'틔');
	val = val.replace(/tjiq/g,'틩');
	...
	val = val.replace(/tjus/g,'툿');
	val = val.replace(/tjuz/g,'퉀');
	val = val.replace(/tjul/g,'툴');
	val = val.replace(/tjun/g,'툰');
	val = val.replace(/tjut/g,'퉅');
	val = val.replace(/tjud/g,'툳');
	val = val.replace(/tjum/g,'툼');
	val = val.replace(/tjup/g,'퉆');
	val = val.replace(/tjub/g,'툽');
	val = val.replace(/tjuc/g,'퉇');
	val = val.replace(/tjuf/g,'툺');
	val = val.replace(/tjuv/g,'툾');
	val = val.replace(/tjuch/g,'퉂');
	val = val.replace(/tjudj/g,'퉃');
	val = val.replace(/tjuk/g,'퉄');
	val = val.replace(/tjug/g,'툭');
	val = val.replace(/tju/g,'투');
	val = val.replace(/tjuq/g,'퉁');
	...
	val = val.replace(/tjes/g,'톗');
	val = val.replace(/tjez/g,'톘');
	val = val.replace(/tjel/g,'톌');
	val = val.replace(/tjen/g,'톈');
	val = val.replace(/tjet/g,'톝');
	val = val.replace(/tjed/g,'톋');
	val = val.replace(/tjem/g,'톔');
	val = val.replace(/tjep/g,'톞');
	val = val.replace(/tjeb/g,'톕');
	val = val.replace(/tjec/g,'톟');
	val = val.replace(/tjef/g,'톒');
	val = val.replace(/tjev/g,'톖');
	val = val.replace(/tjech/g,'톚');
	val = val.replace(/tjedj/g,'톛');
	val = val.replace(/tjek/g,'톜');
	val = val.replace(/tjeg/g,'톅');
	val = val.replace(/tje/g,'톄');
	val = val.replace(/tjeq/g,'톙');
	...
	val = val.replace(/tjos/g,'툣');
	val = val.replace(/tjoz/g,'툤');
	val = val.replace(/tjol/g,'툘');
	val = val.replace(/tjon/g,'툔');
	val = val.replace(/tjot/g,'툩');
	val = val.replace(/tjod/g,'툗');
	val = val.replace(/tjom/g,'툠');
	val = val.replace(/tjop/g,'툪');
	val = val.replace(/tjob/g,'툡');
	val = val.replace(/tjoc/g,'툫');
	val = val.replace(/tjof/g,'툞');
	val = val.replace(/tjov/g,'툢');
	val = val.replace(/tjoch/g,'툦');
	val = val.replace(/tjodj/g,'툧');
	val = val.replace(/tjok/g,'툨');
	val = val.replace(/tjog/g,'툑');
	val = val.replace(/tjo/g,'툐');
	val = val.replace(/tjoq/g,'툥');
	...
	val = val.replace(/tjès/g,'텻');
	val = val.replace(/tjèz/g,'텼');
	val = val.replace(/tjèl/g,'텰');
	val = val.replace(/tjèn/g,'텬');
	val = val.replace(/tjèt/g,'톁');
	val = val.replace(/tjèd/g,'텯');
	val = val.replace(/tjèm/g,'텸');
	val = val.replace(/tjèp/g,'톂');
	val = val.replace(/tjèb/g,'텹');
	val = val.replace(/tjèc/g,'톃');
	val = val.replace(/tjèf/g,'텶');
	val = val.replace(/tjèv/g,'텺');
	val = val.replace(/tjèch/g,'텾');
	val = val.replace(/tjèdj/g,'텿');
	val = val.replace(/tjèk/g,'톀');
	val = val.replace(/tjèg/g,'텩');
	val = val.replace(/tjè/g,'텨');
	val = val.replace(/tjèq/g,'텽');
	...
	val = val.replace(/tjùs/g,'턧');
	val = val.replace(/tjùz/g,'턨');
	val = val.replace(/tjùl/g,'턜');
	val = val.replace(/tjùn/g,'턘');
	val = val.replace(/tjùt/g,'턭');
	val = val.replace(/tjùd/g,'턛');
	val = val.replace(/tjùm/g,'턤');
	val = val.replace(/tjùp/g,'턮');
	val = val.replace(/tjùb/g,'턥');
	val = val.replace(/tjùc/g,'턯');
	val = val.replace(/tjùf/g,'턢');
	val = val.replace(/tjùv/g,'턦');
	val = val.replace(/tjùch/g,'턪');
	val = val.replace(/tjùdj/g,'턫');
	val = val.replace(/tjùk/g,'턬');
	val = val.replace(/tjùg/g,'턕');
	val = val.replace(/tjù/g,'턔');
	val = val.replace(/tjùq/g,'턩');
	...
	val = val.replace(/tjas/g,'턋');
	val = val.replace(/tjaz/g,'턌');
	val = val.replace(/tjal/g,'턀');
	val = val.replace(/tjan/g,'탼');
	val = val.replace(/tjat/g,'턑');
	val = val.replace(/tjad/g,'탿');
	val = val.replace(/tjam/g,'턈');
	val = val.replace(/tjap/g,'턒');
	val = val.replace(/tjab/g,'턉');
	val = val.replace(/tjac/g,'턓');
	val = val.replace(/tjaf/g,'턆');
	val = val.replace(/tjav/g,'턊');
	val = val.replace(/tjach/g,'턎');
	val = val.replace(/tjadj/g,'턏');
	val = val.replace(/tjak/g,'턐');
	val = val.replace(/tjag/g,'탹');
	val = val.replace(/tja/g,'탸');
	val = val.replace(/tjaq/g,'턍');
	...
	val = val.replace(/rjis/g,'릣');
	val = val.replace(/rjiz/g,'릤');
	val = val.replace(/rjil/g,'릘');
	val = val.replace(/rjin/g,'릔');
	val = val.replace(/rjit/g,'릩');
	val = val.replace(/rjid/g,'릗');
	val = val.replace(/rjim/g,'릠');
	val = val.replace(/rjip/g,'릪');
	val = val.replace(/rjib/g,'릡');
	val = val.replace(/rjic/g,'릫');
	val = val.replace(/rjif/g,'릞');
	val = val.replace(/rjiv/g,'릢');
	val = val.replace(/rjich/g,'릦');
	val = val.replace(/rjidj/g,'릧');
	val = val.replace(/rjik/g,'릨');
	val = val.replace(/rjig/g,'릑');
	val = val.replace(/rji/g,'릐');
	val = val.replace(/rjiq/g,'릥');
	...
	val = val.replace(/rjus/g,'룻');
	val = val.replace(/rjuz/g,'룼');
	val = val.replace(/rjul/g,'룰');
	val = val.replace(/rjun/g,'룬');
	val = val.replace(/rjut/g,'뤁');
	val = val.replace(/rjud/g,'룯');
	val = val.replace(/rjum/g,'룸');
	val = val.replace(/rjup/g,'뤂');
	val = val.replace(/rjub/g,'룹');
	val = val.replace(/rjuc/g,'뤃');
	val = val.replace(/rjuf/g,'룶');
	val = val.replace(/rjuv/g,'룺');
	val = val.replace(/rjuch/g,'룾');
	val = val.replace(/rjudj/g,'룿');
	val = val.replace(/rjuk/g,'뤀');
	val = val.replace(/rjug/g,'룩');
	val = val.replace(/rju/g,'루');
	val = val.replace(/rjuq/g,'룽');
	...
	val = val.replace(/rjes/g,'롓');
	val = val.replace(/rjez/g,'롔');
	val = val.replace(/rjel/g,'롈');
	val = val.replace(/rjen/g,'롄');
	val = val.replace(/rjet/g,'롙');
	val = val.replace(/rjed/g,'롇');
	val = val.replace(/rjem/g,'롐');
	val = val.replace(/rjep/g,'롚');
	val = val.replace(/rjeb/g,'롑');
	val = val.replace(/rjec/g,'롛');
	val = val.replace(/rjef/g,'롎');
	val = val.replace(/rjev/g,'롒');
	val = val.replace(/rjech/g,'롖');
	val = val.replace(/rjedj/g,'롗');
	val = val.replace(/rjek/g,'롘');
	val = val.replace(/rjeg/g,'롁');
	val = val.replace(/rje/g,'례');
	val = val.replace(/rjeq/g,'롕');
	...
	val = val.replace(/rjos/g,'룟');
	val = val.replace(/rjoz/g,'룠');
	val = val.replace(/rjol/g,'룔');
	val = val.replace(/rjon/g,'룐');
	val = val.replace(/rjot/g,'룥');
	val = val.replace(/rjod/g,'룓');
	val = val.replace(/rjom/g,'룜');
	val = val.replace(/rjop/g,'룦');
	val = val.replace(/rjob/g,'룝');
	val = val.replace(/rjoc/g,'룧');
	val = val.replace(/rjof/g,'룚');
	val = val.replace(/rjov/g,'룞');
	val = val.replace(/rjoch/g,'룢');
	val = val.replace(/rjodj/g,'룣');
	val = val.replace(/rjok/g,'룤');
	val = val.replace(/rjog/g,'룍');
	val = val.replace(/rjo/g,'료');
	val = val.replace(/rjoq/g,'룡');
	...
	val = val.replace(/rjès/g,'렷');
	val = val.replace(/rjèz/g,'렸');
	val = val.replace(/rjèl/g,'렬');
	val = val.replace(/rjèn/g,'련');
	val = val.replace(/rjèt/g,'렽');
	val = val.replace(/rjèd/g,'렫');
	val = val.replace(/rjèm/g,'렴');
	val = val.replace(/rjèp/g,'렾');
	val = val.replace(/rjèb/g,'렵');
	val = val.replace(/rjèc/g,'렿');
	val = val.replace(/rjèf/g,'렲');
	val = val.replace(/rjèv/g,'렶');
	val = val.replace(/rjèch/g,'렺');
	val = val.replace(/rjèdj/g,'렻');
	val = val.replace(/rjèk/g,'렼');
	val = val.replace(/rjèg/g,'력');
	val = val.replace(/rjè/g,'려');
	val = val.replace(/rjèq/g,'령');
	...
	val = val.replace(/rjùs/g,'럣');
	val = val.replace(/rjùz/g,'럤');
	val = val.replace(/rjùl/g,'럘');
	val = val.replace(/rjùn/g,'럔');
	val = val.replace(/rjùt/g,'럩');
	val = val.replace(/rjùd/g,'럗');
	val = val.replace(/rjùm/g,'럠');
	val = val.replace(/rjùp/g,'럪');
	val = val.replace(/rjùb/g,'럡');
	val = val.replace(/rjùc/g,'럫');
	val = val.replace(/rjùf/g,'럞');
	val = val.replace(/rjùv/g,'럢');
	val = val.replace(/rjùch/g,'럦');
	val = val.replace(/rjùdj/g,'럧');
	val = val.replace(/rjùk/g,'럨');
	val = val.replace(/rjùg/g,'럑');
	val = val.replace(/rjù/g,'럐');
	val = val.replace(/rjùq/g,'럥');
	...
	val = val.replace(/rjas/g,'럇');
	val = val.replace(/rjaz/g,'럈');
	val = val.replace(/rjal/g,'랼');
	val = val.replace(/rjan/g,'랸');
	val = val.replace(/rjat/g,'럍');
	val = val.replace(/rjad/g,'랻');
	val = val.replace(/rjam/g,'럄');
	val = val.replace(/rjap/g,'럎');
	val = val.replace(/rjab/g,'럅');
	val = val.replace(/rjac/g,'럏');
	val = val.replace(/rjaf/g,'럂');
	val = val.replace(/rjav/g,'럆');
	val = val.replace(/rjach/g,'럊');
	val = val.replace(/rjadj/g,'럋');
	val = val.replace(/rjak/g,'럌');
	val = val.replace(/rjag/g,'략');
	val = val.replace(/rja/g,'랴');
	val = val.replace(/rjaq/g,'량');
	...
	val = val.replace(/mjis/g,'믯');
	val = val.replace(/mjiz/g,'믰');
	val = val.replace(/mjil/g,'믤');
	val = val.replace(/mjin/g,'믠');
	val = val.replace(/mjit/g,'믵');
	val = val.replace(/mjid/g,'믣');
	val = val.replace(/mjim/g,'믬');
	val = val.replace(/mjip/g,'믶');
	val = val.replace(/mjib/g,'믭');
	val = val.replace(/mjic/g,'믷');
	val = val.replace(/mjif/g,'믪');
	val = val.replace(/mjiv/g,'믮');
	val = val.replace(/mjich/g,'믲');
	val = val.replace(/mjidj/g,'믳');
	val = val.replace(/mjik/g,'믴');
	val = val.replace(/mjig/g,'믝');
	val = val.replace(/mji/g,'믜');
	val = val.replace(/mjiq/g,'믱');
	...
	val = val.replace(/mwich/g,'뮞');
	val = val.replace(/mwidj/g,'뮟');
	val = val.replace(/mwik/g,'뮠');
	val = val.replace(/mwig/g,'뮉');
	val = val.replace(/mwi/g,'뮈');
	val = val.replace(/mwiq/g,'뮝');
	val = val.replace(/mjus/g,'뭇');
	val = val.replace(/mjuz/g,'뭈');
	val = val.replace(/mjul/g,'물');
	val = val.replace(/mjun/g,'문');
	val = val.replace(/mjut/g,'뭍');
	val = val.replace(/mjud/g,'묻');
	val = val.replace(/mjum/g,'뭄');
	val = val.replace(/mjup/g,'뭎');
	val = val.replace(/mjub/g,'뭅');
	val = val.replace(/mjuc/g,'뭏');
	val = val.replace(/mjuf/g,'뭂');
	val = val.replace(/mjuv/g,'뭆');
	val = val.replace(/mjuch/g,'뭊');
	val = val.replace(/mjudj/g,'뭋');
	val = val.replace(/mjuk/g,'뭌');
	val = val.replace(/mjug/g,'묵');
	val = val.replace(/mju/g,'무');
	val = val.replace(/mjuq/g,'뭉');
	...
	val = val.replace(/mwuch/g,'뮺');
	val = val.replace(/mwudj/g,'뮻');
	val = val.replace(/mwuk/g,'뮼');
	val = val.replace(/mwug/g,'뮥');
	val = val.replace(/mwu/g,'뮤');
	val = val.replace(/mwuq/g,'뮹');
	val = val.replace(/mjes/g,'몟');
	val = val.replace(/mjez/g,'몠');
	val = val.replace(/mjel/g,'몔');
	val = val.replace(/mjen/g,'몐');
	val = val.replace(/mjet/g,'몥');
	val = val.replace(/mjed/g,'몓');
	val = val.replace(/mjem/g,'몜');
	val = val.replace(/mjep/g,'몦');
	val = val.replace(/mjeb/g,'몝');
	val = val.replace(/mjec/g,'몧');
	val = val.replace(/mjef/g,'몚');
	val = val.replace(/mjev/g,'몞');
	val = val.replace(/mjech/g,'몢');
	val = val.replace(/mjedj/g,'몣');
	val = val.replace(/mjek/g,'몤');
	val = val.replace(/mjeg/g,'몍');
	val = val.replace(/mje/g,'몌');
	val = val.replace(/mjeq/g,'몡');
	...
	val = val.replace(/mwech/g,'뮂');
	val = val.replace(/mwedj/g,'뮃');
	val = val.replace(/mwek/g,'뮄');
	val = val.replace(/mweg/g,'뭭');
	val = val.replace(/mwe/g,'뭬');
	val = val.replace(/mweq/g,'뮁');
	val = val.replace(/mjos/g,'묫');
	val = val.replace(/mjoz/g,'묬');
	val = val.replace(/mjol/g,'묠');
	val = val.replace(/mjon/g,'묜');
	val = val.replace(/mjot/g,'묱');
	val = val.replace(/mjod/g,'묟');
	val = val.replace(/mjom/g,'묨');
	val = val.replace(/mjop/g,'묲');
	val = val.replace(/mjob/g,'묩');
	val = val.replace(/mjoc/g,'묳');
	val = val.replace(/mjof/g,'묦');
	val = val.replace(/mjov/g,'묪');
	val = val.replace(/mjoch/g,'묮');
	val = val.replace(/mjodj/g,'묯');
	val = val.replace(/mjok/g,'묰');
	val = val.replace(/mjog/g,'묙');
	val = val.replace(/mjo/g,'묘');
	val = val.replace(/mjoq/g,'묭');
	...
	val = val.replace(/mwoch/g,'묒');
	val = val.replace(/mwodj/g,'묓');
	val = val.replace(/mwok/g,'묔');
	val = val.replace(/mwog/g,'뫽');
	val = val.replace(/mwo/g,'뫼');
	val = val.replace(/mwoq/g,'묑');
	val = val.replace(/mjès/g,'몃');
	val = val.replace(/mjèz/g,'몄');
	val = val.replace(/mjèl/g,'멸');
	val = val.replace(/mjèn/g,'면');
	val = val.replace(/mjèt/g,'몉');
	val = val.replace(/mjèd/g,'멷');
	val = val.replace(/mjèm/g,'몀');
	val = val.replace(/mjèp/g,'몊');
	val = val.replace(/mjèb/g,'몁');
	val = val.replace(/mjèc/g,'몋');
	val = val.replace(/mjèf/g,'멾');
	val = val.replace(/mjèv/g,'몂');
	val = val.replace(/mjèch/g,'몆');
	val = val.replace(/mjèdj/g,'몇');
	val = val.replace(/mjèk/g,'몈');
	val = val.replace(/mjèg/g,'멱');
	val = val.replace(/mjè/g,'며');
	val = val.replace(/mjèq/g,'명');
	...
	val = val.replace(/mwèch/g,'뭦');
	val = val.replace(/mwèdj/g,'뭧');
	val = val.replace(/mwèk/g,'뭨');
	val = val.replace(/mwèg/g,'뭑');
	val = val.replace(/mwè/g,'뭐');
	val = val.replace(/mwèq/g,'뭥');
	val = val.replace(/mjùs/g,'먯');
	val = val.replace(/mjùz/g,'먰');
	val = val.replace(/mjùl/g,'먤');
	val = val.replace(/mjùn/g,'먠');
	val = val.replace(/mjùt/g,'먵');
	val = val.replace(/mjùd/g,'먣');
	val = val.replace(/mjùm/g,'먬');
	val = val.replace(/mjùp/g,'먶');
	val = val.replace(/mjùb/g,'먭');
	val = val.replace(/mjùc/g,'먷');
	val = val.replace(/mjùf/g,'먪');
	val = val.replace(/mjùv/g,'먮');
	val = val.replace(/mjùch/g,'먲');
	val = val.replace(/mjùdj/g,'먳');
	val = val.replace(/mjùk/g,'먴');
	val = val.replace(/mjùg/g,'먝');
	val = val.replace(/mjù/g,'먜');
	val = val.replace(/mjùq/g,'먱');
	...
	val = val.replace(/mwùch/g,'뫶');
	val = val.replace(/mwùdj/g,'뫷');
	val = val.replace(/mwùk/g,'뫸');
	val = val.replace(/mwùg/g,'뫡');
	val = val.replace(/mwù/g,'뫠');
	val = val.replace(/mwùq/g,'뫵');
	val = val.replace(/mjas/g,'먓');
	val = val.replace(/mjaz/g,'먔');
	val = val.replace(/mjal/g,'먈');
	val = val.replace(/mjan/g,'먄');
	val = val.replace(/mjat/g,'먙');
	val = val.replace(/mjad/g,'먇');
	val = val.replace(/mjam/g,'먐');
	val = val.replace(/mjap/g,'먚');
	val = val.replace(/mjab/g,'먑');
	val = val.replace(/mjac/g,'먛');
	val = val.replace(/mjaf/g,'먎');
	val = val.replace(/mjav/g,'먒');
	val = val.replace(/mjach/g,'먖');
	val = val.replace(/mjadj/g,'먗');
	val = val.replace(/mjak/g,'먘');
	val = val.replace(/mjag/g,'먁');
	val = val.replace(/mja/g,'먀');
	val = val.replace(/mjaq/g,'먕');
	...
	val = val.replace(/mwach/g,'뫚');
	val = val.replace(/mwadj/g,'뫛');
	...
	val = val.replace(/pjis/g,'픳');
	val = val.replace(/pjiz/g,'픴');
	val = val.replace(/pjil/g,'픨');
	val = val.replace(/pjin/g,'픤');
	val = val.replace(/pjit/g,'픹');
	val = val.replace(/pjid/g,'픧');
	val = val.replace(/pjim/g,'픰');
	val = val.replace(/pjip/g,'픺');
	val = val.replace(/pjib/g,'픱');
	val = val.replace(/pjic/g,'픻');
	val = val.replace(/pjif/g,'픮');
	val = val.replace(/pjiv/g,'픲');
	val = val.replace(/pjich/g,'픶');
	val = val.replace(/pjidj/g,'픷');
	val = val.replace(/pjik/g,'픸');
	val = val.replace(/pjig/g,'픡');
	val = val.replace(/pji/g,'픠');
	val = val.replace(/pjiq/g,'픵');
	...
	val = val.replace(/pwich/g,'퓢');
	val = val.replace(/pwidj/g,'퓣');
	val = val.replace(/pwik/g,'퓤');
	val = val.replace(/pwig/g,'퓍');
	val = val.replace(/pwi/g,'퓌');
	val = val.replace(/pwiq/g,'퓡');
	val = val.replace(/pjus/g,'풋');
	val = val.replace(/pjuz/g,'풌');
	val = val.replace(/pjul/g,'풀');
	val = val.replace(/pjun/g,'푼');
	val = val.replace(/pjut/g,'풑');
	val = val.replace(/pjud/g,'푿');
	val = val.replace(/pjum/g,'품');
	val = val.replace(/pjup/g,'풒');
	val = val.replace(/pjub/g,'풉');
	val = val.replace(/pjuc/g,'풓');
	val = val.replace(/pjuf/g,'풆');
	val = val.replace(/pjuv/g,'풊');
	val = val.replace(/pjuch/g,'풎');
	val = val.replace(/pjudj/g,'풏');
	val = val.replace(/pjuk/g,'풐');
	val = val.replace(/pjug/g,'푹');
	val = val.replace(/pju/g,'푸');
	val = val.replace(/pjuq/g,'풍');
	...
	val = val.replace(/pwuch/g,'퓾');
	val = val.replace(/pwudj/g,'퓿');
	val = val.replace(/pwuk/g,'픀');
	val = val.replace(/pwug/g,'퓩');
	val = val.replace(/pwu/g,'퓨');
	val = val.replace(/pwuq/g,'퓽');
	val = val.replace(/pjes/g,'폣');
	val = val.replace(/pjez/g,'폤');
	val = val.replace(/pjel/g,'폘');
	val = val.replace(/pjen/g,'폔');
	val = val.replace(/pjet/g,'폩');
	val = val.replace(/pjed/g,'폗');
	val = val.replace(/pjem/g,'폠');
	val = val.replace(/pjep/g,'폪');
	val = val.replace(/pjeb/g,'폡');
	val = val.replace(/pjec/g,'폫');
	val = val.replace(/pjef/g,'폞');
	val = val.replace(/pjev/g,'폢');
	val = val.replace(/pjech/g,'폦');
	val = val.replace(/pjedj/g,'폧');
	val = val.replace(/pjek/g,'폨');
	val = val.replace(/pjeg/g,'폑');
	val = val.replace(/pje/g,'폐');
	val = val.replace(/pjeq/g,'폥');
	...
	val = val.replace(/pwech/g,'퓆');
	val = val.replace(/pwedj/g,'퓇');
	val = val.replace(/pwek/g,'퓈');
	val = val.replace(/pweg/g,'풱');
	val = val.replace(/pwe/g,'풰');
	val = val.replace(/pweq/g,'퓅');
	val = val.replace(/pjos/g,'푯');
	val = val.replace(/pjoz/g,'푰');
	val = val.replace(/pjol/g,'푤');
	val = val.replace(/pjon/g,'푠');
	val = val.replace(/pjot/g,'푵');
	val = val.replace(/pjod/g,'푣');
	val = val.replace(/pjom/g,'푬');
	val = val.replace(/pjop/g,'푶');
	val = val.replace(/pjob/g,'푭');
	val = val.replace(/pjoc/g,'푷');
	val = val.replace(/pjof/g,'푪');
	val = val.replace(/pjov/g,'푮');
	val = val.replace(/pjoch/g,'푲');
	val = val.replace(/pjodj/g,'푳');
	val = val.replace(/pjok/g,'푴');
	val = val.replace(/pjog/g,'푝');
	val = val.replace(/pjo/g,'표');
	val = val.replace(/pjoq/g,'푱');
	...
	val = val.replace(/pwoch/g,'푖');
	val = val.replace(/pwodj/g,'푗');
	val = val.replace(/pwok/g,'푘');
	val = val.replace(/pwog/g,'푁');
	val = val.replace(/pwo/g,'푀');
	val = val.replace(/pwoq/g,'푕');
	val = val.replace(/pjès/g,'폇');
	val = val.replace(/pjèz/g,'폈');
	val = val.replace(/pjèl/g,'펼');
	val = val.replace(/pjèn/g,'편');
	val = val.replace(/pjèt/g,'폍');
	val = val.replace(/pjèd/g,'펻');
	val = val.replace(/pjèm/g,'폄');
	val = val.replace(/pjèp/g,'폎');
	val = val.replace(/pjèb/g,'폅');
	val = val.replace(/pjèc/g,'폏');
	val = val.replace(/pjèf/g,'폂');
	val = val.replace(/pjèv/g,'폆');
	val = val.replace(/pjèch/g,'폊');
	val = val.replace(/pjèdj/g,'폋');
	val = val.replace(/pjèk/g,'폌');
	val = val.replace(/pjèg/g,'펵');
	val = val.replace(/pjè/g,'펴');
	val = val.replace(/pjèq/g,'평');
	...
	val = val.replace(/pwèch/g,'풪');
	val = val.replace(/pwèdj/g,'풫');
	val = val.replace(/pwèk/g,'풬');
	val = val.replace(/pwèg/g,'풕');
	val = val.replace(/pwè/g,'풔');
	val = val.replace(/pwèq/g,'풩');
	val = val.replace(/pjùs/g,'퍳');
	val = val.replace(/pjùz/g,'퍴');
	val = val.replace(/pjùl/g,'퍨');
	val = val.replace(/pjùn/g,'퍤');
	val = val.replace(/pjùt/g,'퍹');
	val = val.replace(/pjùd/g,'퍧');
	val = val.replace(/pjùm/g,'퍰');
	val = val.replace(/pjùp/g,'퍺');
	val = val.replace(/pjùb/g,'퍱');
	val = val.replace(/pjùc/g,'퍻');
	val = val.replace(/pjùf/g,'퍮');
	val = val.replace(/pjùv/g,'퍲');
	val = val.replace(/pjùch/g,'퍶');
	val = val.replace(/pjùdj/g,'퍷');
	val = val.replace(/pjùk/g,'퍸');
	val = val.replace(/pjùg/g,'퍡');
	val = val.replace(/pjù/g,'퍠');
	val = val.replace(/pjùq/g,'퍵');
	...
	val = val.replace(/pwùch/g,'퐺');
	val = val.replace(/pwùdj/g,'퐻');
	val = val.replace(/pwùk/g,'퐼');
	val = val.replace(/pwùg/g,'퐥');
	val = val.replace(/pwù/g,'퐤');
	val = val.replace(/pwùq/g,'퐹');
	val = val.replace(/pjas/g,'퍗');
	val = val.replace(/pjaz/g,'퍘');
	val = val.replace(/pjal/g,'퍌');
	val = val.replace(/pjan/g,'퍈');
	val = val.replace(/pjat/g,'퍝');
	val = val.replace(/pjad/g,'퍋');
	val = val.replace(/pjam/g,'퍔');
	val = val.replace(/pjap/g,'퍞');
	val = val.replace(/pjab/g,'퍕');
	val = val.replace(/pjac/g,'퍟');
	val = val.replace(/pjaf/g,'퍒');
	val = val.replace(/pjav/g,'퍖');
	val = val.replace(/pjach/g,'퍚');
	val = val.replace(/pjadj/g,'퍛');
	val = val.replace(/pjak/g,'퍜');
	val = val.replace(/pjag/g,'퍅');
	val = val.replace(/pja/g,'퍄');
	val = val.replace(/pjaq/g,'퍙');
	...
	val = val.replace(/pwach/g,'퐞');
	val = val.replace(/pwadj/g,'퐟');
	...
	val = val.replace(/bjis/g,'븻');
	val = val.replace(/bjiz/g,'븼');
	val = val.replace(/bjil/g,'븰');
	val = val.replace(/bjin/g,'븬');
	val = val.replace(/bjit/g,'빁');
	val = val.replace(/bjid/g,'븯');
	val = val.replace(/bjim/g,'븸');
	val = val.replace(/bjip/g,'빂');
	val = val.replace(/bjib/g,'븹');
	val = val.replace(/bjic/g,'빃');
	val = val.replace(/bjif/g,'븶');
	val = val.replace(/bjiv/g,'븺');
	val = val.replace(/bjich/g,'븾');
	val = val.replace(/bjidj/g,'븿');
	val = val.replace(/bjik/g,'빀');
	val = val.replace(/bjig/g,'븩');
	val = val.replace(/bji/g,'븨');
	val = val.replace(/bjiq/g,'븽');
	...
	val = val.replace(/bwich/g,'뷪');
	val = val.replace(/bwidj/g,'뷫');
	val = val.replace(/bwik/g,'뷬');
	val = val.replace(/bwig/g,'뷕');
	val = val.replace(/bwi/g,'뷔');
	val = val.replace(/bwiq/g,'뷩');
	val = val.replace(/bjus/g,'붓');
	val = val.replace(/bjuz/g,'붔');
	val = val.replace(/bjul/g,'불');
	val = val.replace(/bjun/g,'분');
	val = val.replace(/bjut/g,'붙');
	val = val.replace(/bjud/g,'붇');
	val = val.replace(/bjum/g,'붐');
	val = val.replace(/bjup/g,'붚');
	val = val.replace(/bjub/g,'붑');
	val = val.replace(/bjuc/g,'붛');
	val = val.replace(/bjuf/g,'붎');
	val = val.replace(/bjuv/g,'붒');
	val = val.replace(/bjuch/g,'붖');
	val = val.replace(/bjudj/g,'붗');
	val = val.replace(/bjuk/g,'붘');
	val = val.replace(/bjug/g,'북');
	val = val.replace(/bju/g,'부');
	val = val.replace(/bjuq/g,'붕');
	...
	val = val.replace(/bwuch/g,'븆');
	val = val.replace(/bwudj/g,'븇');
	val = val.replace(/bwuk/g,'븈');
	val = val.replace(/bwug/g,'뷱');
	val = val.replace(/bwu/g,'뷰');
	val = val.replace(/bwuq/g,'븅');
	val = val.replace(/bjes/g,'볫');
	val = val.replace(/bjez/g,'볬');
	val = val.replace(/bjel/g,'볠');
	val = val.replace(/bjen/g,'볜');
	val = val.replace(/bjet/g,'볱');
	val = val.replace(/bjed/g,'볟');
	val = val.replace(/bjem/g,'볨');
	val = val.replace(/bjep/g,'볲');
	val = val.replace(/bjeb/g,'볩');
	val = val.replace(/bjec/g,'볳');
	val = val.replace(/bjef/g,'볦');
	val = val.replace(/bjev/g,'볪');
	val = val.replace(/bjech/g,'볮');
	val = val.replace(/bjedj/g,'볯');
	val = val.replace(/bjek/g,'볰');
	val = val.replace(/bjeg/g,'볙');
	val = val.replace(/bje/g,'볘');
	val = val.replace(/bjeq/g,'볭');
	...
	val = val.replace(/bwech/g,'뷎');
	val = val.replace(/bwedj/g,'뷏');
	val = val.replace(/bwek/g,'뷐');
	val = val.replace(/bweg/g,'붹');
	val = val.replace(/bwe/g,'붸');
	val = val.replace(/bweq/g,'뷍');
	val = val.replace(/bjos/g,'뵷');
	val = val.replace(/bjoz/g,'뵸');
	val = val.replace(/bjol/g,'뵬');
	val = val.replace(/bjon/g,'뵨');
	val = val.replace(/bjot/g,'뵽');
	val = val.replace(/bjod/g,'뵫');
	val = val.replace(/bjom/g,'뵴');
	val = val.replace(/bjop/g,'뵾');
	val = val.replace(/bjob/g,'뵵');
	val = val.replace(/bjoc/g,'뵿');
	val = val.replace(/bjof/g,'뵲');
	val = val.replace(/bjov/g,'뵶');
	val = val.replace(/bjoch/g,'뵺');
	val = val.replace(/bjodj/g,'뵻');
	val = val.replace(/bjok/g,'뵼');
	val = val.replace(/bjog/g,'뵥');
	val = val.replace(/bjo/g,'뵤');
	val = val.replace(/bjoq/g,'뵹');
	...
	val = val.replace(/bwoch/g,'뵞');
	val = val.replace(/bwodj/g,'뵟');
	val = val.replace(/bwok/g,'뵠');
	val = val.replace(/bwog/g,'뵉');
	val = val.replace(/bwo/g,'뵈');
	val = val.replace(/bwoq/g,'뵝');
	val = val.replace(/bjès/g,'볏');
	val = val.replace(/bjèz/g,'볐');
	val = val.replace(/bjèl/g,'별');
	val = val.replace(/bjèn/g,'변');
	val = val.replace(/bjèt/g,'볕');
	val = val.replace(/bjèd/g,'볃');
	val = val.replace(/bjèm/g,'볌');
	val = val.replace(/bjèp/g,'볖');
	val = val.replace(/bjèb/g,'볍');
	val = val.replace(/bjèc/g,'볗');
	val = val.replace(/bjèf/g,'볊');
	val = val.replace(/bjèv/g,'볎');
	val = val.replace(/bjèch/g,'볒');
	val = val.replace(/bjèdj/g,'볓');
	val = val.replace(/bjèk/g,'볔');
	val = val.replace(/bjèg/g,'벽');
	val = val.replace(/bjè/g,'벼');
	val = val.replace(/bjèq/g,'병');
	...
	val = val.replace(/bwèch/g,'붲');
	val = val.replace(/bwèdj/g,'붳');
	val = val.replace(/bwèk/g,'붴');
	val = val.replace(/bwèg/g,'붝');
	val = val.replace(/bwè/g,'붜');
	val = val.replace(/bwèq/g,'붱');
	val = val.replace(/bjùs/g,'뱻');
	val = val.replace(/bjùz/g,'뱼');
	val = val.replace(/bjùl/g,'뱰');
	val = val.replace(/bjùn/g,'뱬');
	val = val.replace(/bjùt/g,'벁');
	val = val.replace(/bjùd/g,'뱯');
	val = val.replace(/bjùm/g,'뱸');
	val = val.replace(/bjùp/g,'벂');
	val = val.replace(/bjùb/g,'뱹');
	val = val.replace(/bjùc/g,'벃');
	val = val.replace(/bjùf/g,'뱶');
	val = val.replace(/bjùv/g,'뱺');
	val = val.replace(/bjùch/g,'뱾');
	val = val.replace(/bjùdj/g,'뱿');
	val = val.replace(/bjùk/g,'벀');
	val = val.replace(/bjùg/g,'뱩');
	val = val.replace(/bjù/g,'뱨');
	val = val.replace(/bjùq/g,'뱽');
	...
	val = val.replace(/bwùch/g,'뵂');
	val = val.replace(/bwùdj/g,'뵃');
	val = val.replace(/bwùk/g,'뵄');
	val = val.replace(/bwùg/g,'봭');
	val = val.replace(/bwù/g,'봬');
	val = val.replace(/bwùq/g,'뵁');
	val = val.replace(/bjas/g,'뱟');
	val = val.replace(/bjaz/g,'뱠');
	val = val.replace(/bjal/g,'뱔');
	val = val.replace(/bjan/g,'뱐');
	val = val.replace(/bjat/g,'뱥');
	val = val.replace(/bjad/g,'뱓');
	val = val.replace(/bjam/g,'뱜');
	val = val.replace(/bjap/g,'뱦');
	val = val.replace(/bjab/g,'뱝');
	val = val.replace(/bjac/g,'뱧');
	val = val.replace(/bjaf/g,'뱚');
	val = val.replace(/bjav/g,'뱞');
	val = val.replace(/bjach/g,'뱢');
	val = val.replace(/bjadj/g,'뱣');
	val = val.replace(/bjak/g,'뱤');
	val = val.replace(/bjag/g,'뱍');
	val = val.replace(/bja/g,'뱌');
	val = val.replace(/bjaq/g,'뱡');
	...
	val = val.replace(/bwach/g,'봦');
	val = val.replace(/bwadj/g,'봧');
	val = val.replace(/bwak/g,'봨');
	val = val.replace(/bwag/g,'봑');
	val = val.replace(/bwa/g,'봐');
	val = val.replace(/bwaq/g,'봥');
	val = val.replace(/jus/g,'웃');
	val = val.replace(/juz/g,'웄');
	val = val.replace(/jul/g,'울');
	val = val.replace(/jun/g,'운');
	val = val.replace(/jut/g,'웉');
	val = val.replace(/jud/g,'욷');
	val = val.replace(/jum/g,'움');
	val = val.replace(/jup/g,'웊');
	val = val.replace(/jub/g,'웁');
	val = val.replace(/juc/g,'웋');
	val = val.replace(/juf/g,'욾');
	val = val.replace(/juv/g,'웂');
	val = val.replace(/juch/g,'웆');
	val = val.replace(/judj/g,'웇');
	val = val.replace(/juk/g,'웈');
	val = val.replace(/jug/g,'욱');
	val = val.replace(/ju/g,'우');
	val = val.replace(/juq/g,'웅');
	val = val.replace(/jis/g,'읫');
	val = val.replace(/jiz/g,'읬');
	val = val.replace(/jil/g,'읠');
	val = val.replace(/jin/g,'읜');
	val = val.replace(/jit/g,'읱');
	val = val.replace(/jid/g,'읟');
	val = val.replace(/jim/g,'읨');
	val = val.replace(/jip/g,'읲');
	val = val.replace(/jib/g,'읩');
	val = val.replace(/jic/g,'읳');
	val = val.replace(/jif/g,'읦');
	val = val.replace(/jiv/g,'읪');
	val = val.replace(/jich/g,'읮');
	val = val.replace(/jidj/g,'읯');
	val = val.replace(/jik/g,'읰');
	val = val.replace(/jig/g,'읙');
	val = val.replace(/ji/g,'의');
	val = val.replace(/jiq/g,'읭');
	val = val.replace(/jùs/g,'얫');
	val = val.replace(/jùz/g,'얬');
	val = val.replace(/jùl/g,'얠');
	val = val.replace(/jùn/g,'얜');
	val = val.replace(/jùt/g,'얱');
	val = val.replace(/jùd/g,'얟');
	val = val.replace(/jùm/g,'얨');
	val = val.replace(/jùp/g,'얲');
	val = val.replace(/jùb/g,'얩');
	val = val.replace(/jùc/g,'얳');
	val = val.replace(/jùf/g,'얦');
	val = val.replace(/jùv/g,'얪');
	val = val.replace(/jùch/g,'얮');
	val = val.replace(/jùdj/g,'얯');
	val = val.replace(/jùk/g,'얰');
	val = val.replace(/jùg/g,'얙');
	val = val.replace(/jù/g,'얘');
	val = val.replace(/jùq/g,'얭');
	val = val.replace(/jès/g,'엿');
	val = val.replace(/jèz/g,'였');
	val = val.replace(/jèl/g,'열');
	val = val.replace(/jèn/g,'연');
	val = val.replace(/jèt/g,'옅');
	val = val.replace(/jèd/g,'엳');
	val = val.replace(/jèm/g,'염');
	val = val.replace(/jèp/g,'옆');
	val = val.replace(/jèb/g,'엽');
	val = val.replace(/jèc/g,'옇');
	val = val.replace(/jèf/g,'엺');
	val = val.replace(/jèv/g,'엾');
	val = val.replace(/jèch/g,'옂');
	val = val.replace(/jèdj/g,'옃');
	val = val.replace(/jèk/g,'옄');
	val = val.replace(/jèg/g,'역');
	val = val.replace(/jè/g,'여');
	val = val.replace(/jèq/g,'영');
	val = val.replace(/jos/g,'욧');
	val = val.replace(/joz/g,'욨');
	val = val.replace(/jol/g,'욜');
	val = val.replace(/jon/g,'욘');
	val = val.replace(/jot/g,'욭');
	val = val.replace(/jod/g,'욛');
	val = val.replace(/jom/g,'욤');
	val = val.replace(/jop/g,'욮');
	val = val.replace(/job/g,'욥');
	val = val.replace(/joc/g,'욯');
	val = val.replace(/jof/g,'욢');
	val = val.replace(/jov/g,'욦');
	val = val.replace(/joch/g,'욪');
	val = val.replace(/jodj/g,'욫');
	val = val.replace(/jok/g,'욬');
	val = val.replace(/jog/g,'욕');
	val = val.replace(/jo/g,'요');
	val = val.replace(/joq/g,'용');
	val = val.replace(/jes/g,'옛');
	val = val.replace(/jez/g,'옜');
	val = val.replace(/jel/g,'옐');
	val = val.replace(/jen/g,'옌');
	val = val.replace(/jet/g,'옡');
	val = val.replace(/jed/g,'옏');
	val = val.replace(/jem/g,'옘');
	val = val.replace(/jep/g,'옢');
	val = val.replace(/jeb/g,'옙');
	val = val.replace(/jec/g,'옣');
	val = val.replace(/jef/g,'옖');
	val = val.replace(/jev/g,'옚');
	val = val.replace(/jech/g,'옞');
	val = val.replace(/jedj/g,'옟');
	val = val.replace(/jek/g,'옠');
	val = val.replace(/jeg/g,'옉');
	val = val.replace(/je/g,'예');
	val = val.replace(/jeq/g,'옝');
	val = val.replace(/jas/g,'얏');
	val = val.replace(/jaz/g,'얐');
	val = val.replace(/jal/g,'얄');
	val = val.replace(/jan/g,'얀');
	val = val.replace(/jat/g,'얕');
	val = val.replace(/jad/g,'얃');
	val = val.replace(/jam/g,'얌');
	val = val.replace(/jap/g,'얖');
	val = val.replace(/jab/g,'얍');
	val = val.replace(/jac/g,'얗');
	val = val.replace(/jaf/g,'얊');
	val = val.replace(/jav/g,'얎');
	val = val.replace(/jach/g,'얒');
	val = val.replace(/jadj/g,'얓');
	val = val.replace(/jak/g,'얔');
	val = val.replace(/jag/g,'약');
	val = val.replace(/ja/g,'야');
	val = val.replace(/jaq/g,'양');
	val = val.replace(/jjis/g,'읫');
	val = val.replace(/jjiz/g,'읬');
	val = val.replace(/jjil/g,'읠');
	val = val.replace(/jjin/g,'읜');
	val = val.replace(/jjit/g,'읱');
	val = val.replace(/jjid/g,'읟');
	val = val.replace(/jjim/g,'읨');
	val = val.replace(/jjip/g,'읲');
	val = val.replace(/jjib/g,'읩');
	val = val.replace(/jjic/g,'읳');
	val = val.replace(/jjif/g,'읦');
	val = val.replace(/jjiv/g,'읪');
	val = val.replace(/jjich/g,'읮');
	val = val.replace(/jjidj/g,'읯');
	val = val.replace(/jjik/g,'읰');
	val = val.replace(/jjig/g,'읙');
	val = val.replace(/jji/g,'의');
	val = val.replace(/jjiq/g,'읭');
	val = val.replace(/jwis/g,'윗');
	val = val.replace(/jwiz/g,'윘');
	val = val.replace(/jwil/g,'윌');
	val = val.replace(/jwin/g,'윈');
	val = val.replace(/jwit/g,'윝');
	val = val.replace(/jwid/g,'윋');
	val = val.replace(/jwim/g,'윔');
	val = val.replace(/jwip/g,'윞');
	val = val.replace(/jwib/g,'윕');
	val = val.replace(/jwic/g,'윟');
	val = val.replace(/jwif/g,'윒');
	val = val.replace(/jwiv/g,'윖');
	val = val.replace(/jwich/g,'윚');
	val = val.replace(/jwidj/g,'윛');
	val = val.replace(/jwik/g,'윜');
	val = val.replace(/jwig/g,'윅');
	val = val.replace(/jwi/g,'위');
	val = val.replace(/jwiq/g,'윙');
	val = val.replace(/jjus/g,'웃');
	val = val.replace(/jjuz/g,'웄');
	val = val.replace(/jjul/g,'울');
	val = val.replace(/jjun/g,'운');
	val = val.replace(/jjut/g,'웉');
	val = val.replace(/jjud/g,'욷');
	val = val.replace(/jjum/g,'움');
	val = val.replace(/jjup/g,'웊');
	val = val.replace(/jjub/g,'웁');
	val = val.replace(/jjuc/g,'웋');
	val = val.replace(/jjuf/g,'욾');
	val = val.replace(/jjuv/g,'웂');
	val = val.replace(/jjuch/g,'웆');
	val = val.replace(/jjudj/g,'웇');
	val = val.replace(/jjuk/g,'웈');
	val = val.replace(/jjug/g,'욱');
	val = val.replace(/jju/g,'우');
	val = val.replace(/jjuq/g,'웅');
	val = val.replace(/jwus/g,'윳');
	val = val.replace(/jwuz/g,'윴');
	val = val.replace(/jwul/g,'율');
	val = val.replace(/jwun/g,'윤');
	val = val.replace(/jwut/g,'윹');
	val = val.replace(/jwud/g,'윧');
	val = val.replace(/jwum/g,'윰');
	val = val.replace(/jwup/g,'윺');
	val = val.replace(/jwub/g,'윱');
	val = val.replace(/jwuc/g,'윻');
	val = val.replace(/jwuf/g,'윮');
	val = val.replace(/jwuv/g,'윲');
	val = val.replace(/jwuch/g,'윶');
	val = val.replace(/jwudj/g,'윷');
	val = val.replace(/jwuk/g,'윸');
	val = val.replace(/jwug/g,'육');
	val = val.replace(/jwu/g,'유');
	val = val.replace(/jwuq/g,'융');
	val = val.replace(/jjes/g,'옛');
	val = val.replace(/jjez/g,'옜');
	val = val.replace(/jjel/g,'옐');
	val = val.replace(/jjen/g,'옌');
	val = val.replace(/jjet/g,'옡');
	val = val.replace(/jjed/g,'옏');
	val = val.replace(/jjem/g,'옘');
	val = val.replace(/jjep/g,'옢');
	val = val.replace(/jjeb/g,'옙');
	val = val.replace(/jjec/g,'옣');
	val = val.replace(/jjef/g,'옖');
	val = val.replace(/jjev/g,'옚');
	val = val.replace(/jjech/g,'옞');
	val = val.replace(/jjedj/g,'옟');
	val = val.replace(/jjek/g,'옠');
	val = val.replace(/jjeg/g,'옉');
	val = val.replace(/jje/g,'예');
	val = val.replace(/jjeq/g,'옝');
	val = val.replace(/jwes/g,'웻');
	val = val.replace(/jwez/g,'웼');
	val = val.replace(/jwel/g,'웰');
	val = val.replace(/jwen/g,'웬');
	val = val.replace(/jwet/g,'윁');
	val = val.replace(/jwed/g,'웯');
	val = val.replace(/jwem/g,'웸');
	val = val.replace(/jwep/g,'윂');
	val = val.replace(/jweb/g,'웹');
	val = val.replace(/jwec/g,'윃');
	val = val.replace(/jwef/g,'웶');
	val = val.replace(/jwev/g,'웺');
	val = val.replace(/jwech/g,'웾');
	val = val.replace(/jwedj/g,'웿');
	val = val.replace(/jwek/g,'윀');
	val = val.replace(/jweg/g,'웩');
	val = val.replace(/jwe/g,'웨');
	val = val.replace(/jweq/g,'웽');
	val = val.replace(/jjos/g,'욧');
	val = val.replace(/jjoz/g,'욨');
	val = val.replace(/jjol/g,'욜');
	val = val.replace(/jjon/g,'욘');
	val = val.replace(/jjot/g,'욭');
	val = val.replace(/jjod/g,'욛');
	val = val.replace(/jjom/g,'욤');
	val = val.replace(/jjop/g,'욮');
	val = val.replace(/jjob/g,'욥');
	val = val.replace(/jjoc/g,'욯');
	val = val.replace(/jjof/g,'욢');
	val = val.replace(/jjov/g,'욦');
	val = val.replace(/jjoch/g,'욪');
	val = val.replace(/jjodj/g,'욫');
	val = val.replace(/jjok/g,'욬');
	val = val.replace(/jjog/g,'욕');
	val = val.replace(/jjo/g,'요');
	val = val.replace(/jjoq/g,'용');
	val = val.replace(/jwos/g,'욋');
	val = val.replace(/jwoz/g,'욌');
	val = val.replace(/jwol/g,'욀');
	val = val.replace(/jwon/g,'왼');
	val = val.replace(/jwot/g,'욑');
	val = val.replace(/jwod/g,'왿');
	val = val.replace(/jwom/g,'욈');
	val = val.replace(/jwop/g,'욒');
	val = val.replace(/jwob/g,'욉');
	val = val.replace(/jwoc/g,'욓');
	val = val.replace(/jwof/g,'욆');
	val = val.replace(/jwov/g,'욊');
	val = val.replace(/jwoch/g,'욎');
	val = val.replace(/jwodj/g,'욏');
	val = val.replace(/jwok/g,'욐');
	val = val.replace(/jwog/g,'왹');
	val = val.replace(/jwo/g,'외');
	val = val.replace(/jwoq/g,'욍');
	val = val.replace(/jjès/g,'엿');
	val = val.replace(/jjèz/g,'였');
	val = val.replace(/jjèl/g,'열');
	val = val.replace(/jjèn/g,'연');
	val = val.replace(/jjèt/g,'옅');
	val = val.replace(/jjèd/g,'엳');
	val = val.replace(/jjèm/g,'염');
	val = val.replace(/jjèp/g,'옆');
	val = val.replace(/jjèb/g,'엽');
	val = val.replace(/jjèc/g,'옇');
	val = val.replace(/jjèf/g,'엺');
	val = val.replace(/jjèv/g,'엾');
	val = val.replace(/jjèch/g,'옂');
	val = val.replace(/jjèdj/g,'옃');
	val = val.replace(/jjèk/g,'옄');
	val = val.replace(/jjèg/g,'역');
	val = val.replace(/jjè/g,'여');
	val = val.replace(/jjèq/g,'영');
	val = val.replace(/jwès/g,'웟');
	val = val.replace(/jwèz/g,'웠');
	val = val.replace(/jwèl/g,'월');
	val = val.replace(/jwèn/g,'원');
	val = val.replace(/jwèt/g,'웥');
	val = val.replace(/jwèd/g,'웓');
	val = val.replace(/jwèm/g,'웜');
	val = val.replace(/jwèp/g,'웦');
	val = val.replace(/jwèb/g,'웝');
	val = val.replace(/jwèc/g,'웧');
	val = val.replace(/jwèf/g,'웚');
	val = val.replace(/jwèv/g,'웞');
	val = val.replace(/jwèch/g,'웢');
	val = val.replace(/jwèdj/g,'웣');
	val = val.replace(/jwèk/g,'웤');
	val = val.replace(/jwèg/g,'웍');
	val = val.replace(/jwè/g,'워');
	val = val.replace(/jwèq/g,'웡');
	val = val.replace(/jjùs/g,'얫');
	val = val.replace(/jjùz/g,'얬');
	val = val.replace(/jjùl/g,'얠');
	val = val.replace(/jjùn/g,'얜');
	val = val.replace(/jjùt/g,'얱');
	val = val.replace(/jjùd/g,'얟');
	val = val.replace(/jjùm/g,'얨');
	val = val.replace(/jjùp/g,'얲');
	val = val.replace(/jjùb/g,'얩');
	val = val.replace(/jjùc/g,'얳');
	val = val.replace(/jjùf/g,'얦');
	val = val.replace(/jjùv/g,'얪');
	val = val.replace(/jjùch/g,'얮');
	val = val.replace(/jjùdj/g,'얯');
	val = val.replace(/jjùk/g,'얰');
	val = val.replace(/jjùg/g,'얙');
	val = val.replace(/jjù/g,'얘');
	val = val.replace(/jjùq/g,'얭');
	val = val.replace(/jwùs/g,'왯');
	val = val.replace(/jwùz/g,'왰');
	val = val.replace(/jwùl/g,'왤');
	val = val.replace(/jwùn/g,'왠');
	val = val.replace(/jwùt/g,'왵');
	val = val.replace(/jwùd/g,'왣');
	val = val.replace(/jwùm/g,'왬');
	val = val.replace(/jwùp/g,'왶');
	val = val.replace(/jwùb/g,'왭');
	val = val.replace(/jwùc/g,'왷');
	val = val.replace(/jwùf/g,'왪');
	val = val.replace(/jwùv/g,'왮');
	val = val.replace(/jwùch/g,'왲');
	val = val.replace(/jwùdj/g,'왳');
	val = val.replace(/jwùk/g,'왴');
	val = val.replace(/jwùg/g,'왝');
	val = val.replace(/jwù/g,'왜');
	val = val.replace(/jwùq/g,'왱');
	val = val.replace(/jjas/g,'얏');
	val = val.replace(/jjaz/g,'얐');
	val = val.replace(/jjal/g,'얄');
	val = val.replace(/jjan/g,'얀');
	val = val.replace(/jjat/g,'얕');
	val = val.replace(/jjad/g,'얃');
	val = val.replace(/jjam/g,'얌');
	val = val.replace(/jjap/g,'얖');
	val = val.replace(/jjab/g,'얍');
	val = val.replace(/jjac/g,'얗');
	val = val.replace(/jjaf/g,'얊');
	val = val.replace(/jjav/g,'얎');
	val = val.replace(/jjach/g,'얒');
	val = val.replace(/jjadj/g,'얓');
	val = val.replace(/jjak/g,'얔');
	val = val.replace(/jjag/g,'약');
	val = val.replace(/jja/g,'야');
	val = val.replace(/jjaq/g,'양');
	val = val.replace(/jwas/g,'왓');
	val = val.replace(/jwaz/g,'왔');
	val = val.replace(/jwal/g,'왈');
	val = val.replace(/jwan/g,'완');
	val = val.replace(/jwat/g,'왙');
	val = val.replace(/jwad/g,'왇');
	val = val.replace(/jwam/g,'왐');
	val = val.replace(/jwap/g,'왚');
	val = val.replace(/jwab/g,'왑');
	val = val.replace(/jwac/g,'왛');
	val = val.replace(/jwaf/g,'왎');
	val = val.replace(/jwav/g,'왒');
	val = val.replace(/jwach/g,'왖');
	val = val.replace(/jwadj/g,'왗');
	val = val.replace(/jwak/g,'왘');
	val = val.replace(/jwag/g,'왁');
	val = val.replace(/jwa/g,'와');
	val = val.replace(/jwaq/g,'왕');
	...
	val = val.replace(/cjis/g,'흿');
	val = val.replace(/cjiz/g,'힀');
	val = val.replace(/cjil/g,'흴');
	val = val.replace(/cjin/g,'흰');
	val = val.replace(/cjit/g,'힅');
	val = val.replace(/cjid/g,'흳');
	val = val.replace(/cjim/g,'흼');
	val = val.replace(/cjip/g,'힆');
	val = val.replace(/cjib/g,'흽');
	val = val.replace(/cjic/g,'힇');
	val = val.replace(/cjif/g,'흺');
	val = val.replace(/cjiv/g,'흾');
	val = val.replace(/cjich/g,'힂');
	val = val.replace(/cjidj/g,'힃');
	val = val.replace(/cjik/g,'힄');
	val = val.replace(/cjig/g,'흭');
	val = val.replace(/cji/g,'희');
	val = val.replace(/cjiq/g,'힁');
	...
	val = val.replace(/cwich/g,'휮');
	val = val.replace(/cwidj/g,'휯');
	val = val.replace(/cwik/g,'휰');
	val = val.replace(/cwig/g,'휙');
	val = val.replace(/cwi/g,'휘');
	val = val.replace(/cwiq/g,'휭');
	val = val.replace(/cjus/g,'훗');
	val = val.replace(/cjuz/g,'훘');
	val = val.replace(/cjul/g,'훌');
	val = val.replace(/cjun/g,'훈');
	val = val.replace(/cjut/g,'훝');
	val = val.replace(/cjud/g,'훋');
	val = val.replace(/cjum/g,'훔');
	val = val.replace(/cjup/g,'훞');
	val = val.replace(/cjub/g,'훕');
	val = val.replace(/cjuc/g,'훟');
	val = val.replace(/cjuf/g,'훒');
	val = val.replace(/cjuv/g,'훖');
	val = val.replace(/cjuch/g,'훚');
	val = val.replace(/cjudj/g,'훛');
	val = val.replace(/cjuk/g,'훜');
	val = val.replace(/cjug/g,'훅');
	val = val.replace(/cju/g,'후');
	val = val.replace(/cjuq/g,'훙');
	...
	val = val.replace(/cwuch/g,'흊');
	val = val.replace(/cwudj/g,'흋');
	val = val.replace(/cwuk/g,'흌');
	val = val.replace(/cwug/g,'휵');
	val = val.replace(/cwu/g,'휴');
	val = val.replace(/cwuq/g,'흉');
	val = val.replace(/cjes/g,'혯');
	val = val.replace(/cjez/g,'혰');
	val = val.replace(/cjel/g,'혤');
	val = val.replace(/cjen/g,'혠');
	val = val.replace(/cjet/g,'혵');
	val = val.replace(/cjed/g,'혣');
	val = val.replace(/cjem/g,'혬');
	val = val.replace(/cjep/g,'혶');
	val = val.replace(/cjeb/g,'혭');
	val = val.replace(/cjec/g,'혷');
	val = val.replace(/cjef/g,'혪');
	val = val.replace(/cjev/g,'혮');
	val = val.replace(/cjech/g,'혲');
	val = val.replace(/cjedj/g,'혳');
	val = val.replace(/cjek/g,'혴');
	val = val.replace(/cjeg/g,'혝');
	val = val.replace(/cje/g,'혜');
	val = val.replace(/cjeq/g,'혱');
	...
	val = val.replace(/cwech/g,'휒');
	val = val.replace(/cwedj/g,'휓');
	val = val.replace(/cwek/g,'휔');
	val = val.replace(/cweg/g,'훽');
	val = val.replace(/cwe/g,'훼');
	val = val.replace(/cweq/g,'휑');
	val = val.replace(/cjos/g,'횻');
	val = val.replace(/cjoz/g,'횼');
	val = val.replace(/cjol/g,'횰');
	val = val.replace(/cjon/g,'횬');
	val = val.replace(/cjot/g,'훁');
	val = val.replace(/cjod/g,'횯');
	val = val.replace(/cjom/g,'횸');
	val = val.replace(/cjop/g,'훂');
	val = val.replace(/cjob/g,'횹');
	val = val.replace(/cjoc/g,'훃');
	val = val.replace(/cjof/g,'횶');
	val = val.replace(/cjov/g,'횺');
	val = val.replace(/cjoch/g,'횾');
	val = val.replace(/cjodj/g,'횿');
	val = val.replace(/cjok/g,'훀');
	val = val.replace(/cjog/g,'횩');
	val = val.replace(/cjo/g,'효');
	val = val.replace(/cjoq/g,'횽');
	...
	val = val.replace(/cwoch/g,'횢');
	val = val.replace(/cwodj/g,'횣');
	val = val.replace(/cwok/g,'횤');
	val = val.replace(/cwog/g,'획');
	val = val.replace(/cwo/g,'회');
	val = val.replace(/cwoq/g,'횡');
	val = val.replace(/cjès/g,'혓');
	val = val.replace(/cjèz/g,'혔');
	val = val.replace(/cjèl/g,'혈');
	val = val.replace(/cjèn/g,'현');
	val = val.replace(/cjèt/g,'혙');
	val = val.replace(/cjèd/g,'혇');
	val = val.replace(/cjèm/g,'혐');
	val = val.replace(/cjèp/g,'혚');
	val = val.replace(/cjèb/g,'협');
	val = val.replace(/cjèc/g,'혛');
	val = val.replace(/cjèf/g,'혎');
	val = val.replace(/cjèv/g,'혒');
	val = val.replace(/cjèch/g,'혖');
	val = val.replace(/cjèdj/g,'혗');
	val = val.replace(/cjèk/g,'혘');
	val = val.replace(/cjèg/g,'혁');
	val = val.replace(/cjè/g,'혀');
	val = val.replace(/cjèq/g,'형');
	...
	val = val.replace(/cwèch/g,'훶');
	val = val.replace(/cwèdj/g,'훷');
	val = val.replace(/cwèk/g,'훸');
	val = val.replace(/cwèg/g,'훡');
	val = val.replace(/cwè/g,'훠');
	val = val.replace(/cwèq/g,'훵');
	val = val.replace(/cjùs/g,'햿');
	val = val.replace(/cjùz/g,'헀');
	val = val.replace(/cjùl/g,'햴');
	val = val.replace(/cjùn/g,'햰');
	val = val.replace(/cjùt/g,'헅');
	val = val.replace(/cjùd/g,'햳');
	val = val.replace(/cjùm/g,'햼');
	val = val.replace(/cjùp/g,'헆');
	val = val.replace(/cjùb/g,'햽');
	val = val.replace(/cjùc/g,'헇');
	val = val.replace(/cjùf/g,'햺');
	val = val.replace(/cjùv/g,'햾');
	val = val.replace(/cjùch/g,'헂');
	val = val.replace(/cjùdj/g,'헃');
	val = val.replace(/cjùk/g,'헄');
	val = val.replace(/cjùg/g,'햭');
	val = val.replace(/cjù/g,'햬');
	val = val.replace(/cjùq/g,'헁');
	...
	val = val.replace(/cwùch/g,'횆');
	val = val.replace(/cwùdj/g,'횇');
	val = val.replace(/cwùk/g,'횈');
	val = val.replace(/cwùg/g,'홱');
	val = val.replace(/cwù/g,'홰');
	val = val.replace(/cwùq/g,'횅');
	val = val.replace(/cjas/g,'햣');
	val = val.replace(/cjaz/g,'햤');
	val = val.replace(/cjal/g,'햘');
	val = val.replace(/cjan/g,'햔');
	val = val.replace(/cjat/g,'햩');
	val = val.replace(/cjad/g,'햗');
	val = val.replace(/cjam/g,'햠');
	val = val.replace(/cjap/g,'햪');
	val = val.replace(/cjab/g,'햡');
	val = val.replace(/cjac/g,'햫');
	val = val.replace(/cjaf/g,'햞');
	val = val.replace(/cjav/g,'햢');
	val = val.replace(/cjach/g,'햦');
	val = val.replace(/cjadj/g,'햧');
	val = val.replace(/cjak/g,'햨');
	val = val.replace(/cjag/g,'햑');
	val = val.replace(/cja/g,'햐');
	val = val.replace(/cjaq/g,'향');
	...
	val = val.replace(/cwach/g,'홪');
	val = val.replace(/cwadj/g,'홫');
	...
	val = val.replace(/fjis/g,'픳');
	val = val.replace(/fjiz/g,'픴');
	val = val.replace(/fjil/g,'픨');
	val = val.replace(/fjin/g,'픤');
	val = val.replace(/fjit/g,'픹');
	val = val.replace(/fjid/g,'픧');
	val = val.replace(/fjim/g,'픰');
	val = val.replace(/fjip/g,'픺');
	val = val.replace(/fjib/g,'픱');
	val = val.replace(/fjic/g,'픻');
	val = val.replace(/fjif/g,'픮');
	val = val.replace(/fjiv/g,'픲');
	val = val.replace(/fjich/g,'픶');
	val = val.replace(/fjidj/g,'픷');
	val = val.replace(/fjik/g,'픸');
	val = val.replace(/fjig/g,'픡');
	val = val.replace(/fji/g,'픠');
	val = val.replace(/fjiq/g,'픵');
	...
	val = val.replace(/fjus/g,'풋');
	val = val.replace(/fjuz/g,'풌');
	val = val.replace(/fjul/g,'풀');
	val = val.replace(/fjun/g,'푼');
	val = val.replace(/fjut/g,'풑');
	val = val.replace(/fjud/g,'푿');
	val = val.replace(/fjum/g,'품');
	val = val.replace(/fjup/g,'풒');
	val = val.replace(/fjub/g,'풉');
	val = val.replace(/fjuc/g,'풓');
	val = val.replace(/fjuf/g,'풆');
	val = val.replace(/fjuv/g,'풊');
	val = val.replace(/fjuch/g,'풎');
	val = val.replace(/fjudj/g,'풏');
	val = val.replace(/fjuk/g,'풐');
	val = val.replace(/fjug/g,'푹');
	val = val.replace(/fju/g,'푸');
	val = val.replace(/fjuq/g,'풍');
	...
	val = val.replace(/fjes/g,'폣');
	val = val.replace(/fjez/g,'폤');
	val = val.replace(/fjel/g,'폘');
	val = val.replace(/fjen/g,'폔');
	val = val.replace(/fjet/g,'폩');
	val = val.replace(/fjed/g,'폗');
	val = val.replace(/fjem/g,'폠');
	val = val.replace(/fjep/g,'폪');
	val = val.replace(/fjeb/g,'폡');
	val = val.replace(/fjec/g,'폫');
	val = val.replace(/fjef/g,'폞');
	val = val.replace(/fjev/g,'폢');
	val = val.replace(/fjech/g,'폦');
	val = val.replace(/fjedj/g,'폧');
	val = val.replace(/fjek/g,'폨');
	val = val.replace(/fjeg/g,'폑');
	val = val.replace(/fje/g,'폐');
	val = val.replace(/fjeq/g,'폥');
	...
	val = val.replace(/fjos/g,'푯');
	val = val.replace(/fjoz/g,'푰');
	val = val.replace(/fjol/g,'푤');
	val = val.replace(/fjon/g,'푠');
	val = val.replace(/fjot/g,'푵');
	val = val.replace(/fjod/g,'푣');
	val = val.replace(/fjom/g,'푬');
	val = val.replace(/fjop/g,'푶');
	val = val.replace(/fjob/g,'푭');
	val = val.replace(/fjoc/g,'푷');
	val = val.replace(/fjof/g,'푪');
	val = val.replace(/fjov/g,'푮');
	val = val.replace(/fjoch/g,'푲');
	val = val.replace(/fjodj/g,'푳');
	val = val.replace(/fjok/g,'푴');
	val = val.replace(/fjog/g,'푝');
	val = val.replace(/fjo/g,'표');
	val = val.replace(/fjoq/g,'푱');
	...
	val = val.replace(/fjès/g,'폇');
	val = val.replace(/fjèz/g,'폈');
	val = val.replace(/fjèl/g,'펼');
	val = val.replace(/fjèn/g,'편');
	val = val.replace(/fjèt/g,'폍');
	val = val.replace(/fjèd/g,'펻');
	val = val.replace(/fjèm/g,'폄');
	val = val.replace(/fjèp/g,'폎');
	val = val.replace(/fjèb/g,'폅');
	val = val.replace(/fjèc/g,'폏');
	val = val.replace(/fjèf/g,'폂');
	val = val.replace(/fjèv/g,'폆');
	val = val.replace(/fjèch/g,'폊');
	val = val.replace(/fjèdj/g,'폋');
	val = val.replace(/fjèk/g,'폌');
	val = val.replace(/fjèg/g,'펵');
	val = val.replace(/fjè/g,'펴');
	val = val.replace(/fjèq/g,'평');
	...
	val = val.replace(/fjùs/g,'퍳');
	val = val.replace(/fjùz/g,'퍴');
	val = val.replace(/fjùl/g,'퍨');
	val = val.replace(/fjùn/g,'퍤');
	val = val.replace(/fjùt/g,'퍹');
	val = val.replace(/fjùd/g,'퍧');
	val = val.replace(/fjùm/g,'퍰');
	val = val.replace(/fjùp/g,'퍺');
	val = val.replace(/fjùb/g,'퍱');
	val = val.replace(/fjùc/g,'퍻');
	val = val.replace(/fjùf/g,'퍮');
	val = val.replace(/fjùv/g,'퍲');
	val = val.replace(/fjùch/g,'퍶');
	val = val.replace(/fjùdj/g,'퍷');
	val = val.replace(/fjùk/g,'퍸');
	val = val.replace(/fjùg/g,'퍡');
	val = val.replace(/fjù/g,'퍠');
	val = val.replace(/fjùq/g,'퍵');
	...
	val = val.replace(/fjas/g,'퍗');
	val = val.replace(/fjaz/g,'퍘');
	val = val.replace(/fjal/g,'퍌');
	val = val.replace(/fjan/g,'퍈');
	val = val.replace(/fjat/g,'퍝');
	val = val.replace(/fjad/g,'퍋');
	val = val.replace(/fjam/g,'퍔');
	val = val.replace(/fjap/g,'퍞');
	val = val.replace(/fjab/g,'퍕');
	val = val.replace(/fjac/g,'퍟');
	val = val.replace(/fjaf/g,'퍒');
	val = val.replace(/fjav/g,'퍖');
	val = val.replace(/fjach/g,'퍚');
	val = val.replace(/fjadj/g,'퍛');
	val = val.replace(/fjak/g,'퍜');
	val = val.replace(/fjag/g,'퍅');
	val = val.replace(/fja/g,'퍄');
	val = val.replace(/fjaq/g,'퍙');
	...
	val = val.replace(/vjis/g,'븻');
	val = val.replace(/vjiz/g,'븼');
	val = val.replace(/vjil/g,'븰');
	val = val.replace(/vjin/g,'븬');
	val = val.replace(/vjit/g,'빁');
	val = val.replace(/vjid/g,'븯');
	val = val.replace(/vjim/g,'븸');
	val = val.replace(/vjip/g,'빂');
	val = val.replace(/vjib/g,'븹');
	val = val.replace(/vjic/g,'빃');
	val = val.replace(/vjif/g,'븶');
	val = val.replace(/vjiv/g,'븺');
	val = val.replace(/vjich/g,'븾');
	val = val.replace(/vjidj/g,'븿');
	val = val.replace(/vjik/g,'빀');
	val = val.replace(/vjig/g,'븩');
	val = val.replace(/vji/g,'븨');
	val = val.replace(/vjiq/g,'븽');
	...
	val = val.replace(/vjus/g,'붓');
	val = val.replace(/vjuz/g,'붔');
	val = val.replace(/vjul/g,'불');
	val = val.replace(/vjun/g,'분');
	val = val.replace(/vjut/g,'붙');
	val = val.replace(/vjud/g,'붇');
	val = val.replace(/vjum/g,'붐');
	val = val.replace(/vjup/g,'붚');
	val = val.replace(/vjub/g,'붑');
	val = val.replace(/vjuc/g,'붛');
	val = val.replace(/vjuf/g,'붎');
	val = val.replace(/vjuv/g,'붒');
	val = val.replace(/vjuch/g,'붖');
	val = val.replace(/vjudj/g,'붗');
	val = val.replace(/vjuk/g,'붘');
	val = val.replace(/vjug/g,'북');
	val = val.replace(/vju/g,'부');
	val = val.replace(/vjuq/g,'붕');
	...
	val = val.replace(/vjes/g,'볫');
	val = val.replace(/vjez/g,'볬');
	val = val.replace(/vjel/g,'볠');
	val = val.replace(/vjen/g,'볜');
	val = val.replace(/vjet/g,'볱');
	val = val.replace(/vjed/g,'볟');
	val = val.replace(/vjem/g,'볨');
	val = val.replace(/vjep/g,'볲');
	val = val.replace(/vjeb/g,'볩');
	val = val.replace(/vjec/g,'볳');
	val = val.replace(/vjef/g,'볦');
	val = val.replace(/vjev/g,'볪');
	val = val.replace(/vjech/g,'볮');
	val = val.replace(/vjedj/g,'볯');
	val = val.replace(/vjek/g,'볰');
	val = val.replace(/vjeg/g,'볙');
	val = val.replace(/vje/g,'볘');
	val = val.replace(/vjeq/g,'볭');
	...
	val = val.replace(/vjos/g,'뵷');
	val = val.replace(/vjoz/g,'뵸');
	val = val.replace(/vjol/g,'뵬');
	val = val.replace(/vjon/g,'뵨');
	val = val.replace(/vjot/g,'뵽');
	val = val.replace(/vjod/g,'뵫');
	val = val.replace(/vjom/g,'뵴');
	val = val.replace(/vjop/g,'뵾');
	val = val.replace(/vjob/g,'뵵');
	val = val.replace(/vjoc/g,'뵿');
	val = val.replace(/vjof/g,'뵲');
	val = val.replace(/vjov/g,'뵶');
	val = val.replace(/vjoch/g,'뵺');
	val = val.replace(/vjodj/g,'뵻');
	val = val.replace(/vjok/g,'뵼');
	val = val.replace(/vjog/g,'뵥');
	val = val.replace(/vjo/g,'뵤');
	val = val.replace(/vjoq/g,'뵹');
	...
	val = val.replace(/vjès/g,'볏');
	val = val.replace(/vjèz/g,'볐');
	val = val.replace(/vjèl/g,'별');
	val = val.replace(/vjèn/g,'변');
	val = val.replace(/vjèt/g,'볕');
	val = val.replace(/vjèd/g,'볃');
	val = val.replace(/vjèm/g,'볌');
	val = val.replace(/vjèp/g,'볖');
	val = val.replace(/vjèb/g,'볍');
	val = val.replace(/vjèc/g,'볗');
	val = val.replace(/vjèf/g,'볊');
	val = val.replace(/vjèv/g,'볎');
	val = val.replace(/vjèch/g,'볒');
	val = val.replace(/vjèdj/g,'볓');
	val = val.replace(/vjèk/g,'볔');
	val = val.replace(/vjèg/g,'벽');
	val = val.replace(/vjè/g,'벼');
	val = val.replace(/vjèq/g,'병');
	...
	val = val.replace(/vjùs/g,'뱻');
	val = val.replace(/vjùz/g,'뱼');
	val = val.replace(/vjùl/g,'뱰');
	val = val.replace(/vjùn/g,'뱬');
	val = val.replace(/vjùt/g,'벁');
	val = val.replace(/vjùd/g,'뱯');
	val = val.replace(/vjùm/g,'뱸');
	val = val.replace(/vjùp/g,'벂');
	val = val.replace(/vjùb/g,'뱹');
	val = val.replace(/vjùc/g,'벃');
	val = val.replace(/vjùf/g,'뱶');
	val = val.replace(/vjùv/g,'뱺');
	val = val.replace(/vjùch/g,'뱾');
	val = val.replace(/vjùdj/g,'뱿');
	val = val.replace(/vjùk/g,'벀');
	val = val.replace(/vjùg/g,'뱩');
	val = val.replace(/vjù/g,'뱨');
	val = val.replace(/vjùq/g,'뱽');
	...
	val = val.replace(/vjas/g,'뱟');
	val = val.replace(/vjaz/g,'뱠');
	val = val.replace(/vjal/g,'뱔');
	val = val.replace(/vjan/g,'뱐');
	val = val.replace(/vjat/g,'뱥');
	val = val.replace(/vjad/g,'뱓');
	val = val.replace(/vjam/g,'뱜');
	val = val.replace(/vjap/g,'뱦');
	val = val.replace(/vjab/g,'뱝');
	val = val.replace(/vjac/g,'뱧');
	val = val.replace(/vjaf/g,'뱚');
	val = val.replace(/vjav/g,'뱞');
	val = val.replace(/vjach/g,'뱢');
	val = val.replace(/vjadj/g,'뱣');
	val = val.replace(/vjak/g,'뱤');
	val = val.replace(/vjag/g,'뱍');
	val = val.replace(/vja/g,'뱌');
	val = val.replace(/vjaq/g,'뱡');
	...
	val = val.replace(/shjis/g,'싓');
	val = val.replace(/shjiz/g,'싔');
	val = val.replace(/shjil/g,'싈');
	val = val.replace(/shjin/g,'싄');
	val = val.replace(/shjit/g,'싙');
	val = val.replace(/shjid/g,'싇');
	val = val.replace(/shjim/g,'싐');
	val = val.replace(/shjip/g,'싚');
	val = val.replace(/shjib/g,'싑');
	val = val.replace(/shjic/g,'싛');
	val = val.replace(/shjif/g,'싎');
	val = val.replace(/shjiv/g,'싒');
	val = val.replace(/shjich/g,'싖');
	val = val.replace(/shjidj/g,'싗');
	val = val.replace(/shjik/g,'싘');
	val = val.replace(/shjig/g,'싁');
	val = val.replace(/shji/g,'싀');
	val = val.replace(/shjiq/g,'싕');
	...
	val = val.replace(/shwich/g,'슂');
	val = val.replace(/shwidj/g,'슃');
	val = val.replace(/shwik/g,'슄');
	val = val.replace(/shwig/g,'쉭');
	val = val.replace(/shwi/g,'쉬');
	val = val.replace(/shwiq/g,'슁');
	val = val.replace(/shjus/g,'숫');
	val = val.replace(/shjuz/g,'숬');
	val = val.replace(/shjul/g,'술');
	val = val.replace(/shjun/g,'순');
	val = val.replace(/shjut/g,'숱');
	val = val.replace(/shjud/g,'숟');
	val = val.replace(/shjum/g,'숨');
	val = val.replace(/shjup/g,'숲');
	val = val.replace(/shjub/g,'숩');
	val = val.replace(/shjuc/g,'숳');
	val = val.replace(/shjuf/g,'숦');
	val = val.replace(/shjuv/g,'숪');
	val = val.replace(/shjuch/g,'숮');
	val = val.replace(/shjudj/g,'숯');
	val = val.replace(/shjuk/g,'숰');
	val = val.replace(/shjug/g,'숙');
	val = val.replace(/shju/g,'수');
	val = val.replace(/shjuq/g,'숭');
	...
	val = val.replace(/shwuch/g,'슞');
	val = val.replace(/shwudj/g,'슟');
	val = val.replace(/shwuk/g,'슠');
	val = val.replace(/shwug/g,'슉');
	val = val.replace(/shwu/g,'슈');
	val = val.replace(/shwuq/g,'슝');
	val = val.replace(/shjes/g,'솃');
	val = val.replace(/shjez/g,'솄');
	val = val.replace(/shjel/g,'셸');
	val = val.replace(/shjen/g,'셴');
	val = val.replace(/shjet/g,'솉');
	val = val.replace(/shjed/g,'셷');
	val = val.replace(/shjem/g,'솀');
	val = val.replace(/shjep/g,'솊');
	val = val.replace(/shjeb/g,'솁');
	val = val.replace(/shjec/g,'솋');
	val = val.replace(/shjef/g,'셾');
	val = val.replace(/shjev/g,'솂');
	val = val.replace(/shjech/g,'솆');
	val = val.replace(/shjedj/g,'솇');
	val = val.replace(/shjek/g,'솈');
	val = val.replace(/shjeg/g,'셱');
	val = val.replace(/shje/g,'셰');
	val = val.replace(/shjeq/g,'솅');
	...
	val = val.replace(/shwech/g,'쉦');
	val = val.replace(/shwedj/g,'쉧');
	val = val.replace(/shwek/g,'쉨');
	val = val.replace(/shweg/g,'쉑');
	val = val.replace(/shwe/g,'쉐');
	val = val.replace(/shweq/g,'쉥');
	val = val.replace(/shjos/g,'숏');
	val = val.replace(/shjoz/g,'숐');
	val = val.replace(/shjol/g,'숄');
	val = val.replace(/shjon/g,'숀');
	val = val.replace(/shjot/g,'숕');
	val = val.replace(/shjod/g,'숃');
	val = val.replace(/shjom/g,'숌');
	val = val.replace(/shjop/g,'숖');
	val = val.replace(/shjob/g,'숍');
	val = val.replace(/shjoc/g,'숗');
	val = val.replace(/shjof/g,'숊');
	val = val.replace(/shjov/g,'숎');
	val = val.replace(/shjoch/g,'숒');
	val = val.replace(/shjodj/g,'숓');
	val = val.replace(/shjok/g,'숔');
	val = val.replace(/shjog/g,'쇽');
	val = val.replace(/shjo/g,'쇼');
	val = val.replace(/shjoq/g,'숑');
	...
	val = val.replace(/shwoch/g,'쇶');
	val = val.replace(/shwodj/g,'쇷');
	val = val.replace(/shwok/g,'쇸');
	val = val.replace(/shwog/g,'쇡');
	val = val.replace(/shwo/g,'쇠');
	val = val.replace(/shwoq/g,'쇵');
	val = val.replace(/shjès/g,'셧');
	val = val.replace(/shjèz/g,'셨');
	val = val.replace(/shjèl/g,'셜');
	val = val.replace(/shjèn/g,'션');
	val = val.replace(/shjèt/g,'셭');
	val = val.replace(/shjèd/g,'셛');
	val = val.replace(/shjèm/g,'셤');
	val = val.replace(/shjèp/g,'셮');
	val = val.replace(/shjèb/g,'셥');
	val = val.replace(/shjèc/g,'셯');
	val = val.replace(/shjèf/g,'셢');
	val = val.replace(/shjèv/g,'셦');
	val = val.replace(/shjèch/g,'셪');
	val = val.replace(/shjèdj/g,'셫');
	val = val.replace(/shjèk/g,'셬');
	val = val.replace(/shjèg/g,'셕');
	val = val.replace(/shjè/g,'셔');
	val = val.replace(/shjèq/g,'셩');
	...
	val = val.replace(/shwèch/g,'쉊');
	val = val.replace(/shwèdj/g,'쉋');
	val = val.replace(/shwèk/g,'쉌');
	val = val.replace(/shwèg/g,'숵');
	val = val.replace(/shwè/g,'숴');
	val = val.replace(/shwèq/g,'쉉');
	val = val.replace(/shjùs/g,'섓');
	val = val.replace(/shjùz/g,'섔');
	val = val.replace(/shjùl/g,'섈');
	val = val.replace(/shjùn/g,'섄');
	val = val.replace(/shjùt/g,'섙');
	val = val.replace(/shjùd/g,'섇');
	val = val.replace(/shjùm/g,'섐');
	val = val.replace(/shjùp/g,'섚');
	val = val.replace(/shjùb/g,'섑');
	val = val.replace(/shjùc/g,'섛');
	val = val.replace(/shjùf/g,'섎');
	val = val.replace(/shjùv/g,'섒');
	val = val.replace(/shjùch/g,'섖');
	val = val.replace(/shjùdj/g,'섗');
	val = val.replace(/shjùk/g,'섘');
	val = val.replace(/shjùg/g,'섁');
	val = val.replace(/shjù/g,'섀');
	val = val.replace(/shjùq/g,'섕');
	...
	val = val.replace(/shwùch/g,'쇚');
	val = val.replace(/shwùdj/g,'쇛');
	val = val.replace(/shwùk/g,'쇜');
	val = val.replace(/shwùg/g,'쇅');
	val = val.replace(/shwù/g,'쇄');
	val = val.replace(/shwùq/g,'쇙');
	val = val.replace(/shjas/g,'샷');
	val = val.replace(/shjaz/g,'샸');
	val = val.replace(/shjal/g,'샬');
	val = val.replace(/shjan/g,'샨');
	val = val.replace(/shjat/g,'샽');
	val = val.replace(/shjad/g,'샫');
	val = val.replace(/shjam/g,'샴');
	val = val.replace(/shjap/g,'샾');
	val = val.replace(/shjab/g,'샵');
	val = val.replace(/shjac/g,'샿');
	val = val.replace(/shjaf/g,'샲');
	val = val.replace(/shjav/g,'샶');
	val = val.replace(/shjach/g,'샺');
	val = val.replace(/shjadj/g,'샻');
	val = val.replace(/shjak/g,'샼');
	val = val.replace(/shjag/g,'샥');
	val = val.replace(/shja/g,'샤');
	val = val.replace(/shjaq/g,'샹');
	...
	val = val.replace(/shwach/g,'솾');
	val = val.replace(/shwadj/g,'솿');
	...
	val = val.replace(/zhjis/g,'싓');
	val = val.replace(/zhjiz/g,'싔');
	val = val.replace(/zhjil/g,'싈');
	val = val.replace(/zhjin/g,'싄');
	val = val.replace(/zhjit/g,'싙');
	val = val.replace(/zhjid/g,'싇');
	val = val.replace(/zhjim/g,'싐');
	val = val.replace(/zhjip/g,'싚');
	val = val.replace(/zhjib/g,'싑');
	val = val.replace(/zhjic/g,'싛');
	val = val.replace(/zhjif/g,'싎');
	val = val.replace(/zhjiv/g,'싒');
	val = val.replace(/zhjich/g,'싖');
	val = val.replace(/zhjidj/g,'싗');
	val = val.replace(/zhjik/g,'싘');
	val = val.replace(/zhjig/g,'싁');
	val = val.replace(/zhji/g,'싀');
	val = val.replace(/zhjiq/g,'싕');
	...
	val = val.replace(/zhwich/g,'슂');
	val = val.replace(/zhwidj/g,'슃');
	val = val.replace(/zhwik/g,'슄');
	val = val.replace(/zhwig/g,'쉭');
	val = val.replace(/zhwi/g,'쉬');
	val = val.replace(/zhwiq/g,'슁');
	val = val.replace(/zhjus/g,'숫');
	val = val.replace(/zhjuz/g,'숬');
	val = val.replace(/zhjul/g,'술');
	val = val.replace(/zhjun/g,'순');
	val = val.replace(/zhjut/g,'숱');
	val = val.replace(/zhjud/g,'숟');
	val = val.replace(/zhjum/g,'숨');
	val = val.replace(/zhjup/g,'숲');
	val = val.replace(/zhjub/g,'숩');
	val = val.replace(/zhjuc/g,'숳');
	val = val.replace(/zhjuf/g,'숦');
	val = val.replace(/zhjuv/g,'숪');
	val = val.replace(/zhjuch/g,'숮');
	val = val.replace(/zhjudj/g,'숯');
	val = val.replace(/zhjuk/g,'숰');
	val = val.replace(/zhjug/g,'숙');
	val = val.replace(/zhju/g,'수');
	val = val.replace(/zhjuq/g,'숭');
	...
	val = val.replace(/zhwuch/g,'슞');
	val = val.replace(/zhwudj/g,'슟');
	val = val.replace(/zhwuk/g,'슠');
	val = val.replace(/zhwug/g,'슉');
	val = val.replace(/zhwu/g,'슈');
	val = val.replace(/zhwuq/g,'슝');
	val = val.replace(/zhjes/g,'솃');
	val = val.replace(/zhjez/g,'솄');
	val = val.replace(/zhjel/g,'셸');
	val = val.replace(/zhjen/g,'셴');
	val = val.replace(/zhjet/g,'솉');
	val = val.replace(/zhjed/g,'셷');
	val = val.replace(/zhjem/g,'솀');
	val = val.replace(/zhjep/g,'솊');
	val = val.replace(/zhjeb/g,'솁');
	val = val.replace(/zhjec/g,'솋');
	val = val.replace(/zhjef/g,'셾');
	val = val.replace(/zhjev/g,'솂');
	val = val.replace(/zhjech/g,'솆');
	val = val.replace(/zhjedj/g,'솇');
	val = val.replace(/zhjek/g,'솈');
	val = val.replace(/zhjeg/g,'셱');
	val = val.replace(/zhje/g,'셰');
	val = val.replace(/zhjeq/g,'솅');
	...
	val = val.replace(/zhwech/g,'쉦');
	val = val.replace(/zhwedj/g,'쉧');
	val = val.replace(/zhwek/g,'쉨');
	val = val.replace(/zhweg/g,'쉑');
	val = val.replace(/zhwe/g,'쉐');
	val = val.replace(/zhweq/g,'쉥');
	val = val.replace(/zhjos/g,'숏');
	val = val.replace(/zhjoz/g,'숐');
	val = val.replace(/zhjol/g,'숄');
	val = val.replace(/zhjon/g,'숀');
	val = val.replace(/zhjot/g,'숕');
	val = val.replace(/zhjod/g,'숃');
	val = val.replace(/zhjom/g,'숌');
	val = val.replace(/zhjop/g,'숖');
	val = val.replace(/zhjob/g,'숍');
	val = val.replace(/zhjoc/g,'숗');
	val = val.replace(/zhjof/g,'숊');
	val = val.replace(/zhjov/g,'숎');
	val = val.replace(/zhjoch/g,'숒');
	val = val.replace(/zhjodj/g,'숓');
	val = val.replace(/zhjok/g,'숔');
	val = val.replace(/zhjog/g,'쇽');
	val = val.replace(/zhjo/g,'쇼');
	val = val.replace(/zhjoq/g,'숑');
	...
	val = val.replace(/zhwoch/g,'쇶');
	val = val.replace(/zhwodj/g,'쇷');
	val = val.replace(/zhwok/g,'쇸');
	val = val.replace(/zhwog/g,'쇡');
	val = val.replace(/zhwo/g,'쇠');
	val = val.replace(/zhwoq/g,'쇵');
	val = val.replace(/zhjès/g,'셧');
	val = val.replace(/zhjèz/g,'셨');
	val = val.replace(/zhjèl/g,'셜');
	val = val.replace(/zhjèn/g,'션');
	val = val.replace(/zhjèt/g,'셭');
	val = val.replace(/zhjèd/g,'셛');
	val = val.replace(/zhjèm/g,'셤');
	val = val.replace(/zhjèp/g,'셮');
	val = val.replace(/zhjèb/g,'셥');
	val = val.replace(/zhjèc/g,'셯');
	val = val.replace(/zhjèf/g,'셢');
	val = val.replace(/zhjèv/g,'셦');
	val = val.replace(/zhjèch/g,'셪');
	val = val.replace(/zhjèdj/g,'셫');
	val = val.replace(/zhjèk/g,'셬');
	val = val.replace(/zhjèg/g,'셕');
	val = val.replace(/zhjè/g,'셔');
	val = val.replace(/zhjèq/g,'셩');
	...
	val = val.replace(/zhwèch/g,'쉊');
	val = val.replace(/zhwèdj/g,'쉋');
	val = val.replace(/zhwèk/g,'쉌');
	val = val.replace(/zhwèg/g,'숵');
	val = val.replace(/zhwè/g,'숴');
	val = val.replace(/zhwèq/g,'쉉');
	val = val.replace(/zhjùs/g,'섓');
	val = val.replace(/zhjùz/g,'섔');
	val = val.replace(/zhjùl/g,'섈');
	val = val.replace(/zhjùn/g,'섄');
	val = val.replace(/zhjùt/g,'섙');
	val = val.replace(/zhjùd/g,'섇');
	val = val.replace(/zhjùm/g,'섐');
	val = val.replace(/zhjùp/g,'섚');
	val = val.replace(/zhjùb/g,'섑');
	val = val.replace(/zhjùc/g,'섛');
	val = val.replace(/zhjùf/g,'섎');
	val = val.replace(/zhjùv/g,'섒');
	val = val.replace(/zhjùch/g,'섖');
	val = val.replace(/zhjùdj/g,'섗');
	val = val.replace(/zhjùk/g,'섘');
	val = val.replace(/zhjùg/g,'섁');
	val = val.replace(/zhjù/g,'섀');
	val = val.replace(/zhjùq/g,'섕');
	...
	val = val.replace(/zhwùch/g,'쇚');
	val = val.replace(/zhwùdj/g,'쇛');
	val = val.replace(/zhwùk/g,'쇜');
	val = val.replace(/zhwùg/g,'쇅');
	val = val.replace(/zhwù/g,'쇄');
	val = val.replace(/zhwùq/g,'쇙');
	val = val.replace(/zhjas/g,'샷');
	val = val.replace(/zhjaz/g,'샸');
	val = val.replace(/zhjal/g,'샬');
	val = val.replace(/zhjan/g,'샨');
	val = val.replace(/zhjat/g,'샽');
	val = val.replace(/zhjad/g,'샫');
	val = val.replace(/zhjam/g,'샴');
	val = val.replace(/zhjap/g,'샾');
	val = val.replace(/zhjab/g,'샵');
	val = val.replace(/zhjac/g,'샿');
	val = val.replace(/zhjaf/g,'샲');
	val = val.replace(/zhjav/g,'샶');
	val = val.replace(/zhjach/g,'샺');
	val = val.replace(/zhjadj/g,'샻');
	val = val.replace(/zhjak/g,'샼');
	val = val.replace(/zhjag/g,'샥');
	val = val.replace(/zhja/g,'샤');
	val = val.replace(/zhjaq/g,'샹');
	...
	val = val.replace(/zhwach/g,'솾');
	val = val.replace(/zhwadj/g,'솿');
	...
	val = val.replace(/chjis/g,'즷');
	val = val.replace(/chjiz/g,'즸');
	val = val.replace(/chjil/g,'즬');
	val = val.replace(/chjin/g,'즨');
	val = val.replace(/chjit/g,'즽');
	val = val.replace(/chjid/g,'즫');
	val = val.replace(/chjim/g,'즴');
	val = val.replace(/chjip/g,'즾');
	val = val.replace(/chjib/g,'즵');
	val = val.replace(/chjic/g,'즿');
	val = val.replace(/chjif/g,'즲');
	val = val.replace(/chjiv/g,'즶');
	val = val.replace(/chjich/g,'즺');
	val = val.replace(/chjidj/g,'즻');
	val = val.replace(/chjik/g,'즼');
	val = val.replace(/chjig/g,'즥');
	val = val.replace(/chji/g,'즤');
	val = val.replace(/chjiq/g,'즹');
	...
	val = val.replace(/chwich/g,'쥦');
	val = val.replace(/chwidj/g,'쥧');
	val = val.replace(/chwik/g,'쥨');
	val = val.replace(/chwig/g,'쥑');
	val = val.replace(/chwi/g,'쥐');
	val = val.replace(/chwiq/g,'쥥');
	val = val.replace(/chjus/g,'줏');
	val = val.replace(/chjuz/g,'줐');
	val = val.replace(/chjul/g,'줄');
	val = val.replace(/chjun/g,'준');
	val = val.replace(/chjut/g,'줕');
	val = val.replace(/chjud/g,'줃');
	val = val.replace(/chjum/g,'줌');
	val = val.replace(/chjup/g,'줖');
	val = val.replace(/chjub/g,'줍');
	val = val.replace(/chjuc/g,'줗');
	val = val.replace(/chjuf/g,'줊');
	val = val.replace(/chjuv/g,'줎');
	val = val.replace(/chjuch/g,'줒');
	val = val.replace(/chjudj/g,'줓');
	val = val.replace(/chjuk/g,'줔');
	val = val.replace(/chjug/g,'죽');
	val = val.replace(/chju/g,'주');
	val = val.replace(/chjuq/g,'중');
	...
	val = val.replace(/chwuch/g,'즂');
	val = val.replace(/chwudj/g,'즃');
	val = val.replace(/chwuk/g,'즄');
	val = val.replace(/chwug/g,'쥭');
	val = val.replace(/chwu/g,'쥬');
	val = val.replace(/chwuq/g,'즁');
	val = val.replace(/chjes/g,'졧');
	val = val.replace(/chjez/g,'졨');
	val = val.replace(/chjel/g,'졜');
	val = val.replace(/chjen/g,'졘');
	val = val.replace(/chjet/g,'졭');
	val = val.replace(/chjed/g,'졛');
	val = val.replace(/chjem/g,'졤');
	val = val.replace(/chjep/g,'졮');
	val = val.replace(/chjeb/g,'졥');
	val = val.replace(/chjec/g,'졯');
	val = val.replace(/chjef/g,'졢');
	val = val.replace(/chjev/g,'졦');
	val = val.replace(/chjech/g,'졪');
	val = val.replace(/chjedj/g,'졫');
	val = val.replace(/chjek/g,'졬');
	val = val.replace(/chjeg/g,'졕');
	val = val.replace(/chje/g,'졔');
	val = val.replace(/chjeq/g,'졩');
	...
	val = val.replace(/chwech/g,'쥊');
	val = val.replace(/chwedj/g,'쥋');
	val = val.replace(/chwek/g,'쥌');
	val = val.replace(/chweg/g,'줵');
	val = val.replace(/chwe/g,'줴');
	val = val.replace(/chweq/g,'쥉');
	val = val.replace(/chjos/g,'죳');
	val = val.replace(/chjoz/g,'죴');
	val = val.replace(/chjol/g,'죨');
	val = val.replace(/chjon/g,'죤');
	val = val.replace(/chjot/g,'죹');
	val = val.replace(/chjod/g,'죧');
	val = val.replace(/chjom/g,'죰');
	val = val.replace(/chjop/g,'죺');
	val = val.replace(/chjob/g,'죱');
	val = val.replace(/chjoc/g,'죻');
	val = val.replace(/chjof/g,'죮');
	val = val.replace(/chjov/g,'죲');
	val = val.replace(/chjoch/g,'죶');
	val = val.replace(/chjodj/g,'죷');
	val = val.replace(/chjok/g,'죸');
	val = val.replace(/chjog/g,'죡');
	val = val.replace(/chjo/g,'죠');
	val = val.replace(/chjoq/g,'죵');
	...
	val = val.replace(/chwoch/g,'죚');
	val = val.replace(/chwodj/g,'죛');
	val = val.replace(/chwok/g,'죜');
	val = val.replace(/chwog/g,'죅');
	val = val.replace(/chwo/g,'죄');
	val = val.replace(/chwoq/g,'죙');
	val = val.replace(/chjès/g,'졋');
	val = val.replace(/chjèz/g,'졌');
	val = val.replace(/chjèl/g,'졀');
	val = val.replace(/chjèn/g,'젼');
	val = val.replace(/chjèt/g,'졑');
	val = val.replace(/chjèd/g,'젿');
	val = val.replace(/chjèm/g,'졈');
	val = val.replace(/chjèp/g,'졒');
	val = val.replace(/chjèb/g,'졉');
	val = val.replace(/chjèc/g,'졓');
	val = val.replace(/chjèf/g,'졆');
	val = val.replace(/chjèv/g,'졊');
	val = val.replace(/chjèch/g,'졎');
	val = val.replace(/chjèdj/g,'졏');
	val = val.replace(/chjèk/g,'졐');
	val = val.replace(/chjèg/g,'젹');
	val = val.replace(/chjè/g,'져');
	val = val.replace(/chjèq/g,'졍');
	...
	val = val.replace(/chwèch/g,'줮');
	val = val.replace(/chwèdj/g,'줯');
	val = val.replace(/chwèk/g,'줰');
	val = val.replace(/chwèg/g,'줙');
	val = val.replace(/chwè/g,'줘');
	val = val.replace(/chwèq/g,'줭');
	val = val.replace(/chjùs/g,'쟷');
	val = val.replace(/chjùz/g,'쟸');
	val = val.replace(/chjùl/g,'쟬');
	val = val.replace(/chjùn/g,'쟨');
	val = val.replace(/chjùt/g,'쟽');
	val = val.replace(/chjùd/g,'쟫');
	val = val.replace(/chjùm/g,'쟴');
	val = val.replace(/chjùp/g,'쟾');
	val = val.replace(/chjùb/g,'쟵');
	val = val.replace(/chjùc/g,'쟿');
	val = val.replace(/chjùf/g,'쟲');
	val = val.replace(/chjùv/g,'쟶');
	val = val.replace(/chjùch/g,'쟺');
	val = val.replace(/chjùdj/g,'쟻');
	val = val.replace(/chjùk/g,'쟼');
	val = val.replace(/chjùg/g,'쟥');
	val = val.replace(/chjù/g,'쟤');
	val = val.replace(/chjùq/g,'쟹');
	...
	val = val.replace(/chwùch/g,'좾');
	val = val.replace(/chwùdj/g,'좿');
	val = val.replace(/chwùk/g,'죀');
	val = val.replace(/chwùg/g,'좩');
	val = val.replace(/chwù/g,'좨');
	val = val.replace(/chwùq/g,'좽');
	val = val.replace(/chjas/g,'쟛');
	val = val.replace(/chjaz/g,'쟜');
	val = val.replace(/chjal/g,'쟐');
	val = val.replace(/chjan/g,'쟌');
	val = val.replace(/chjat/g,'쟡');
	val = val.replace(/chjad/g,'쟏');
	val = val.replace(/chjam/g,'쟘');
	val = val.replace(/chjap/g,'쟢');
	val = val.replace(/chjab/g,'쟙');
	val = val.replace(/chjac/g,'쟣');
	val = val.replace(/chjaf/g,'쟖');
	val = val.replace(/chjav/g,'쟚');
	val = val.replace(/chjach/g,'쟞');
	val = val.replace(/chjadj/g,'쟟');
	val = val.replace(/chjak/g,'쟠');
	val = val.replace(/chjag/g,'쟉');
	val = val.replace(/chja/g,'쟈');
	val = val.replace(/chjaq/g,'쟝');
	...
	val = val.replace(/chwach/g,'좢');
	val = val.replace(/chwadj/g,'좣');
	val = val.replace(/chwak/g,'좤');
	val = val.replace(/chwag/g,'좍');
	val = val.replace(/chwa/g,'좌');
	val = val.replace(/chwaq/g,'좡');
	val = val.replace(/djjis/g,'칏');
	val = val.replace(/djjiz/g,'칐');
	val = val.replace(/djjil/g,'칄');
	val = val.replace(/djjin/g,'칀');
	val = val.replace(/djjit/g,'칕');
	val = val.replace(/djjid/g,'칃');
	val = val.replace(/djjim/g,'칌');
	val = val.replace(/djjip/g,'칖');
	val = val.replace(/djjib/g,'칍');
	val = val.replace(/djjic/g,'칗');
	val = val.replace(/djjif/g,'칊');
	val = val.replace(/djjiv/g,'칎');
	val = val.replace(/djjich/g,'칒');
	val = val.replace(/djjidj/g,'칓');
	val = val.replace(/djjik/g,'칔');
	val = val.replace(/djjig/g,'츽');
	val = val.replace(/djji/g,'츼');
	val = val.replace(/djjiq/g,'칑');
	...
	val = val.replace(/djwich/g,'췾');
	val = val.replace(/djwidj/g,'췿');
	val = val.replace(/djwik/g,'츀');
	val = val.replace(/djwig/g,'췩');
	val = val.replace(/djwi/g,'취');
	val = val.replace(/djwiq/g,'췽');
	val = val.replace(/djjus/g,'춧');
	val = val.replace(/djjuz/g,'춨');
	val = val.replace(/djjul/g,'출');
	val = val.replace(/djjun/g,'춘');
	val = val.replace(/djjut/g,'춭');
	val = val.replace(/djjud/g,'춛');
	val = val.replace(/djjum/g,'춤');
	val = val.replace(/djjup/g,'춮');
	val = val.replace(/djjub/g,'춥');
	val = val.replace(/djjuc/g,'춯');
	val = val.replace(/djjuf/g,'춢');
	val = val.replace(/djjuv/g,'춦');
	val = val.replace(/djjuch/g,'춪');
	val = val.replace(/djjudj/g,'춫');
	val = val.replace(/djjuk/g,'춬');
	val = val.replace(/djjug/g,'축');
	val = val.replace(/djju/g,'추');
	val = val.replace(/djjuq/g,'충');
	...
	val = val.replace(/djwuch/g,'츚');
	val = val.replace(/djwudj/g,'츛');
	val = val.replace(/djwuk/g,'츜');
	val = val.replace(/djwug/g,'츅');
	val = val.replace(/djwu/g,'츄');
	val = val.replace(/djwuq/g,'츙');
	val = val.replace(/djjes/g,'쳿');
	val = val.replace(/djjez/g,'촀');
	val = val.replace(/djjel/g,'쳴');
	val = val.replace(/djjen/g,'쳰');
	val = val.replace(/djjet/g,'촅');
	val = val.replace(/djjed/g,'쳳');
	val = val.replace(/djjem/g,'쳼');
	val = val.replace(/djjep/g,'촆');
	val = val.replace(/djjeb/g,'쳽');
	val = val.replace(/djjec/g,'촇');
	val = val.replace(/djjef/g,'쳺');
	val = val.replace(/djjev/g,'쳾');
	val = val.replace(/djjech/g,'촂');
	val = val.replace(/djjedj/g,'촃');
	val = val.replace(/djjek/g,'촄');
	val = val.replace(/djjeg/g,'쳭');
	val = val.replace(/djje/g,'쳬');
	val = val.replace(/djjeq/g,'촁');
	...
	val = val.replace(/djwech/g,'췢');
	val = val.replace(/djwedj/g,'췣');
	val = val.replace(/djwek/g,'췤');
	val = val.replace(/djweg/g,'췍');
	val = val.replace(/djwe/g,'췌');
	val = val.replace(/djweq/g,'췡');
	val = val.replace(/djjos/g,'춋');
	val = val.replace(/djjoz/g,'춌');
	val = val.replace(/djjol/g,'춀');
	val = val.replace(/djjon/g,'쵼');
	val = val.replace(/djjot/g,'춑');
	val = val.replace(/djjod/g,'쵿');
	val = val.replace(/djjom/g,'춈');
	val = val.replace(/djjop/g,'춒');
	val = val.replace(/djjob/g,'춉');
	val = val.replace(/djjoc/g,'춓');
	val = val.replace(/djjof/g,'춆');
	val = val.replace(/djjov/g,'춊');
	val = val.replace(/djjoch/g,'춎');
	val = val.replace(/djjodj/g,'춏');
	val = val.replace(/djjok/g,'춐');
	val = val.replace(/djjog/g,'쵹');
	val = val.replace(/djjo/g,'쵸');
	val = val.replace(/djjoq/g,'춍');
	...
	val = val.replace(/djwoch/g,'쵲');
	val = val.replace(/djwodj/g,'쵳');
	val = val.replace(/djwok/g,'쵴');
	val = val.replace(/djwog/g,'쵝');
	val = val.replace(/djwo/g,'최');
	val = val.replace(/djwoq/g,'쵱');
	val = val.replace(/djjès/g,'쳣');
	val = val.replace(/djjèz/g,'쳤');
	val = val.replace(/djjèl/g,'쳘');
	val = val.replace(/djjèn/g,'쳔');
	val = val.replace(/djjèt/g,'쳩');
	val = val.replace(/djjèd/g,'쳗');
	val = val.replace(/djjèm/g,'쳠');
	val = val.replace(/djjèp/g,'쳪');
	val = val.replace(/djjèb/g,'쳡');
	val = val.replace(/djjèc/g,'쳫');
	val = val.replace(/djjèf/g,'쳞');
	val = val.replace(/djjèv/g,'쳢');
	val = val.replace(/djjèch/g,'쳦');
	val = val.replace(/djjèdj/g,'쳧');
	val = val.replace(/djjèk/g,'쳨');
	val = val.replace(/djjèg/g,'쳑');
	val = val.replace(/djjè/g,'쳐');
	val = val.replace(/djjèq/g,'쳥');
	...
	val = val.replace(/djwèch/g,'췆');
	val = val.replace(/djwèdj/g,'췇');
	val = val.replace(/djwèk/g,'췈');
	val = val.replace(/djwèg/g,'춱');
	val = val.replace(/djwè/g,'춰');
	val = val.replace(/djwèq/g,'췅');
	val = val.replace(/djjùs/g,'첏');
	val = val.replace(/djjùz/g,'첐');
	val = val.replace(/djjùl/g,'첄');
	val = val.replace(/djjùn/g,'첀');
	val = val.replace(/djjùt/g,'첕');
	val = val.replace(/djjùd/g,'첃');
	val = val.replace(/djjùm/g,'첌');
	val = val.replace(/djjùp/g,'첖');
	val = val.replace(/djjùb/g,'첍');
	val = val.replace(/djjùc/g,'첗');
	val = val.replace(/djjùf/g,'첊');
	val = val.replace(/djjùv/g,'첎');
	val = val.replace(/djjùch/g,'첒');
	val = val.replace(/djjùdj/g,'첓');
	val = val.replace(/djjùk/g,'첔');
	val = val.replace(/djjùg/g,'챽');
	val = val.replace(/djjù/g,'챼');
	val = val.replace(/djjùq/g,'첑');
	...
	val = val.replace(/djjas/g,'챳');
	val = val.replace(/djjaz/g,'챴');
	val = val.replace(/djjal/g,'챨');
	val = val.replace(/djjan/g,'챤');
	val = val.replace(/djjat/g,'챹');
	val = val.replace(/djjad/g,'챧');
	val = val.replace(/djjam/g,'챰');
	val = val.replace(/djjap/g,'챺');
	val = val.replace(/djjab/g,'챱');
	val = val.replace(/djjac/g,'챻');
	val = val.replace(/djjaf/g,'챮');
	val = val.replace(/djjav/g,'챲');
	val = val.replace(/djjach/g,'챶');
	val = val.replace(/djjadj/g,'챷');
	val = val.replace(/djjak/g,'챸');
	val = val.replace(/djjag/g,'챡');
	val = val.replace(/djja/g,'챠');
	val = val.replace(/djjaq/g,'챵');
	...
	val = val.replace(/djwach/g,'촺');
	val = val.replace(/djwadj/g,'촻');
	...
	val = val.replace(/kjis/g,'킛');
	val = val.replace(/kjiz/g,'킜');
	val = val.replace(/kjil/g,'킐');
	val = val.replace(/kjin/g,'킌');
	val = val.replace(/kjit/g,'킡');
	val = val.replace(/kjid/g,'킏');
	val = val.replace(/kjim/g,'킘');
	val = val.replace(/kjip/g,'킢');
	val = val.replace(/kjib/g,'킙');
	val = val.replace(/kjic/g,'킣');
	val = val.replace(/kjif/g,'킖');
	val = val.replace(/kjiv/g,'킚');
	val = val.replace(/kjich/g,'킞');
	val = val.replace(/kjidj/g,'킟');
	val = val.replace(/kjik/g,'킠');
	val = val.replace(/kjig/g,'킉');
	val = val.replace(/kji/g,'킈');
	val = val.replace(/kjiq/g,'킝');
	...
	val = val.replace(/kjus/g,'쿳');
	val = val.replace(/kjuz/g,'쿴');
	val = val.replace(/kjul/g,'쿨');
	val = val.replace(/kjun/g,'쿤');
	val = val.replace(/kjut/g,'쿹');
	val = val.replace(/kjud/g,'쿧');
	val = val.replace(/kjum/g,'쿰');
	val = val.replace(/kjup/g,'쿺');
	val = val.replace(/kjub/g,'쿱');
	val = val.replace(/kjuc/g,'쿻');
	val = val.replace(/kjuf/g,'쿮');
	val = val.replace(/kjuv/g,'쿲');
	val = val.replace(/kjuch/g,'쿶');
	val = val.replace(/kjudj/g,'쿷');
	val = val.replace(/kjuk/g,'쿸');
	val = val.replace(/kjug/g,'쿡');
	val = val.replace(/kju/g,'쿠');
	val = val.replace(/kjuq/g,'쿵');
	...
	val = val.replace(/kjes/g,'콋');
	val = val.replace(/kjez/g,'콌');
	val = val.replace(/kjel/g,'콀');
	val = val.replace(/kjen/g,'켼');
	val = val.replace(/kjet/g,'콑');
	val = val.replace(/kjed/g,'켿');
	val = val.replace(/kjem/g,'콈');
	val = val.replace(/kjep/g,'콒');
	val = val.replace(/kjeb/g,'콉');
	val = val.replace(/kjec/g,'콓');
	val = val.replace(/kjef/g,'콆');
	val = val.replace(/kjev/g,'콊');
	val = val.replace(/kjech/g,'콎');
	val = val.replace(/kjedj/g,'콏');
	val = val.replace(/kjek/g,'콐');
	val = val.replace(/kjeg/g,'켹');
	val = val.replace(/kje/g,'켸');
	val = val.replace(/kjeq/g,'콍');
	...
	val = val.replace(/kjos/g,'쿗');
	val = val.replace(/kjoz/g,'쿘');
	val = val.replace(/kjol/g,'쿌');
	val = val.replace(/kjon/g,'쿈');
	val = val.replace(/kjot/g,'쿝');
	val = val.replace(/kjod/g,'쿋');
	val = val.replace(/kjom/g,'쿔');
	val = val.replace(/kjop/g,'쿞');
	val = val.replace(/kjob/g,'쿕');
	val = val.replace(/kjoc/g,'쿟');
	val = val.replace(/kjof/g,'쿒');
	val = val.replace(/kjov/g,'쿖');
	val = val.replace(/kjoch/g,'쿚');
	val = val.replace(/kjodj/g,'쿛');
	val = val.replace(/kjok/g,'쿜');
	val = val.replace(/kjog/g,'쿅');
	val = val.replace(/kjo/g,'쿄');
	val = val.replace(/kjoq/g,'쿙');
	...
	val = val.replace(/kjès/g,'켯');
	val = val.replace(/kjèz/g,'켰');
	val = val.replace(/kjèl/g,'켤');
	val = val.replace(/kjèn/g,'켠');
	val = val.replace(/kjèt/g,'켵');
	val = val.replace(/kjèd/g,'켣');
	val = val.replace(/kjèm/g,'켬');
	val = val.replace(/kjèp/g,'켶');
	val = val.replace(/kjèb/g,'켭');
	val = val.replace(/kjèc/g,'켷');
	val = val.replace(/kjèf/g,'켪');
	val = val.replace(/kjèv/g,'켮');
	val = val.replace(/kjèch/g,'켲');
	val = val.replace(/kjèdj/g,'켳');
	val = val.replace(/kjèk/g,'켴');
	val = val.replace(/kjèg/g,'켝');
	val = val.replace(/kjè/g,'켜');
	val = val.replace(/kjèq/g,'켱');
	...
	val = val.replace(/kjùs/g,'컛');
	val = val.replace(/kjùz/g,'컜');
	val = val.replace(/kjùl/g,'컐');
	val = val.replace(/kjùn/g,'컌');
	val = val.replace(/kjùt/g,'컡');
	val = val.replace(/kjùd/g,'컏');
	val = val.replace(/kjùm/g,'컘');
	val = val.replace(/kjùp/g,'컢');
	val = val.replace(/kjùb/g,'컙');
	val = val.replace(/kjùc/g,'컣');
	val = val.replace(/kjùf/g,'컖');
	val = val.replace(/kjùv/g,'컚');
	val = val.replace(/kjùch/g,'컞');
	val = val.replace(/kjùdj/g,'컟');
	val = val.replace(/kjùk/g,'컠');
	val = val.replace(/kjùg/g,'컉');
	val = val.replace(/kjù/g,'컈');
	val = val.replace(/kjùq/g,'컝');
	...
	val = val.replace(/kjas/g,'캿');
	val = val.replace(/kjaz/g,'컀');
	val = val.replace(/kjal/g,'캴');
	val = val.replace(/kjan/g,'캰');
	val = val.replace(/kjat/g,'컅');
	val = val.replace(/kjad/g,'캳');
	val = val.replace(/kjam/g,'캼');
	val = val.replace(/kjap/g,'컆');
	val = val.replace(/kjab/g,'캽');
	val = val.replace(/kjac/g,'컇');
	val = val.replace(/kjaf/g,'캺');
	val = val.replace(/kjav/g,'캾');
	val = val.replace(/kjach/g,'컂');
	val = val.replace(/kjadj/g,'컃');
	val = val.replace(/kjak/g,'컄');
	val = val.replace(/kjag/g,'캭');
	val = val.replace(/kja/g,'캬');
	val = val.replace(/kjaq/g,'컁');
	...
	val = val.replace(/gjis/g,'긧');
	val = val.replace(/gjiz/g,'긨');
	val = val.replace(/gjil/g,'긜');
	val = val.replace(/gjin/g,'긘');
	val = val.replace(/gjit/g,'긭');
	val = val.replace(/gjid/g,'긛');
	val = val.replace(/gjim/g,'긤');
	val = val.replace(/gjip/g,'긮');
	val = val.replace(/gjib/g,'긥');
	val = val.replace(/gjic/g,'긯');
	val = val.replace(/gjif/g,'긢');
	val = val.replace(/gjiv/g,'긦');
	val = val.replace(/gjich/g,'긪');
	val = val.replace(/gjidj/g,'긫');
	val = val.replace(/gjik/g,'긬');
	val = val.replace(/gjig/g,'긕');
	val = val.replace(/gji/g,'긔');
	val = val.replace(/gjiq/g,'긩');
	...
	val = val.replace(/gjus/g,'굿');
	val = val.replace(/gjuz/g,'궀');
	val = val.replace(/gjul/g,'굴');
	val = val.replace(/gjun/g,'군');
	val = val.replace(/gjut/g,'궅');
	val = val.replace(/gjud/g,'굳');
	val = val.replace(/gjum/g,'굼');
	val = val.replace(/gjup/g,'궆');
	val = val.replace(/gjub/g,'굽');
	val = val.replace(/gjuc/g,'궇');
	val = val.replace(/gjuf/g,'굺');
	val = val.replace(/gjuv/g,'굾');
	val = val.replace(/gjuch/g,'궂');
	val = val.replace(/gjudj/g,'궃');
	val = val.replace(/gjuk/g,'궄');
	val = val.replace(/gjug/g,'국');
	val = val.replace(/gju/g,'구');
	val = val.replace(/gjuq/g,'궁');
	...
	val = val.replace(/gjes/g,'곗');
	val = val.replace(/gjez/g,'곘');
	val = val.replace(/gjel/g,'곌');
	val = val.replace(/gjen/g,'곈');
	val = val.replace(/gjet/g,'곝');
	val = val.replace(/gjed/g,'곋');
	val = val.replace(/gjem/g,'곔');
	val = val.replace(/gjep/g,'곞');
	val = val.replace(/gjeb/g,'곕');
	val = val.replace(/gjec/g,'곟');
	val = val.replace(/gjef/g,'곒');
	val = val.replace(/gjev/g,'곖');
	val = val.replace(/gjech/g,'곚');
	val = val.replace(/gjedj/g,'곛');
	val = val.replace(/gjek/g,'곜');
	val = val.replace(/gjeg/g,'곅');
	val = val.replace(/gje/g,'계');
	val = val.replace(/gjeq/g,'곙');
	...
	val = val.replace(/gwech/g,'궺');
	val = val.replace(/gwedj/g,'궻');
	val = val.replace(/gwek/g,'궼');
	val = val.replace(/gweg/g,'궥');
	val = val.replace(/gwe/g,'궤');
	val = val.replace(/gweq/g,'궹');
	val = val.replace(/gjos/g,'굣');
	val = val.replace(/gjoz/g,'굤');
	val = val.replace(/gjol/g,'굘');
	val = val.replace(/gjon/g,'굔');
	val = val.replace(/gjot/g,'굩');
	val = val.replace(/gjod/g,'굗');
	val = val.replace(/gjom/g,'굠');
	val = val.replace(/gjop/g,'굪');
	val = val.replace(/gjob/g,'굡');
	val = val.replace(/gjoc/g,'굫');
	val = val.replace(/gjof/g,'굞');
	val = val.replace(/gjov/g,'굢');
	val = val.replace(/gjoch/g,'굦');
	val = val.replace(/gjodj/g,'굧');
	val = val.replace(/gjok/g,'굨');
	val = val.replace(/gjog/g,'굑');
	val = val.replace(/gjo/g,'교');
	val = val.replace(/gjoq/g,'굥');
	...
	val = val.replace(/gwoch/g,'굊');
	val = val.replace(/gwodj/g,'굋');
	val = val.replace(/gwok/g,'굌');
	val = val.replace(/gwog/g,'괵');
	val = val.replace(/gwo/g,'괴');
	val = val.replace(/gwoq/g,'굉');
	val = val.replace(/gjès/g,'겻');
	val = val.replace(/gjèz/g,'겼');
	val = val.replace(/gjèl/g,'결');
	val = val.replace(/gjèn/g,'견');
	val = val.replace(/gjèt/g,'곁');
	val = val.replace(/gjèd/g,'겯');
	val = val.replace(/gjèm/g,'겸');
	val = val.replace(/gjèp/g,'곂');
	val = val.replace(/gjèb/g,'겹');
	val = val.replace(/gjèc/g,'곃');
	val = val.replace(/gjèf/g,'겶');
	val = val.replace(/gjèv/g,'겺');
	val = val.replace(/gjèch/g,'겾');
	val = val.replace(/gjèdj/g,'겿');
	val = val.replace(/gjèk/g,'곀');
	val = val.replace(/gjèg/g,'격');
	val = val.replace(/gjè/g,'겨');
	val = val.replace(/gjèq/g,'경');
	...
	val = val.replace(/gwèch/g,'궞');
	val = val.replace(/gwèdj/g,'궟');
	val = val.replace(/gwèk/g,'궠');
	val = val.replace(/gwèg/g,'궉');
	val = val.replace(/gwè/g,'궈');
	val = val.replace(/gwèq/g,'궝');
	val = val.replace(/gjùs/g,'걧');
	val = val.replace(/gjùz/g,'걨');
	val = val.replace(/gjùl/g,'걜');
	val = val.replace(/gjùn/g,'걘');
	val = val.replace(/gjùt/g,'걭');
	val = val.replace(/gjùd/g,'걛');
	val = val.replace(/gjùm/g,'걤');
	val = val.replace(/gjùp/g,'걮');
	val = val.replace(/gjùb/g,'걥');
	val = val.replace(/gjùc/g,'걯');
	val = val.replace(/gjùf/g,'걢');
	val = val.replace(/gjùv/g,'걦');
	val = val.replace(/gjùch/g,'걪');
	val = val.replace(/gjùdj/g,'걫');
	val = val.replace(/gjùk/g,'걬');
	val = val.replace(/gjùg/g,'걕');
	val = val.replace(/gjù/g,'걔');
	val = val.replace(/gjùq/g,'걩');
	...
	val = val.replace(/gwùch/g,'괮');
	val = val.replace(/gwùdj/g,'괯');
	val = val.replace(/gwùk/g,'괰');
	val = val.replace(/gwùg/g,'괙');
	val = val.replace(/gwù/g,'괘');
	val = val.replace(/gwùq/g,'괭');
	val = val.replace(/gjas/g,'걋');
	val = val.replace(/gjaz/g,'걌');
	val = val.replace(/gjal/g,'걀');
	val = val.replace(/gjan/g,'갼');
	val = val.replace(/gjat/g,'걑');
	val = val.replace(/gjad/g,'갿');
	val = val.replace(/gjam/g,'걈');
	val = val.replace(/gjap/g,'걒');
	val = val.replace(/gjab/g,'걉');
	val = val.replace(/gjac/g,'걓');
	val = val.replace(/gjaf/g,'걆');
	val = val.replace(/gjav/g,'걊');
	val = val.replace(/gjach/g,'걎');
	val = val.replace(/gjadj/g,'걏');
	val = val.replace(/gjak/g,'걐');
	val = val.replace(/gjag/g,'갹');
	val = val.replace(/gja/g,'갸');
	val = val.replace(/gjaq/g,'걍');
	...
	val = val.replace(/gwach/g,'괒');
	val = val.replace(/gwadj/g,'괓');
	...
	val = val.replace(/wjis/g,'읫');
	val = val.replace(/wjiz/g,'읬');
	val = val.replace(/wjil/g,'읠');
	val = val.replace(/wjin/g,'읜');
	val = val.replace(/wjit/g,'읱');
	val = val.replace(/wjid/g,'읟');
	val = val.replace(/wjim/g,'읨');
	val = val.replace(/wjip/g,'읲');
	val = val.replace(/wjib/g,'읩');
	val = val.replace(/wjic/g,'읳');
	val = val.replace(/wjif/g,'읦');
	val = val.replace(/wjiv/g,'읪');
	val = val.replace(/wjich/g,'읮');
	val = val.replace(/wjidj/g,'읯');
	val = val.replace(/wjik/g,'읰');
	val = val.replace(/wjig/g,'읙');
	val = val.replace(/wji/g,'의');
	val = val.replace(/wjiq/g,'읭');
	val = val.replace(/wwis/g,'윗');
	val = val.replace(/wwiz/g,'윘');
	val = val.replace(/wwil/g,'윌');
	val = val.replace(/wwin/g,'윈');
	val = val.replace(/wwit/g,'윝');
	val = val.replace(/wwid/g,'윋');
	val = val.replace(/wwim/g,'윔');
	val = val.replace(/wwip/g,'윞');
	val = val.replace(/wwib/g,'윕');
	val = val.replace(/wwic/g,'윟');
	val = val.replace(/wwif/g,'윒');
	val = val.replace(/wwiv/g,'윖');
	val = val.replace(/wwich/g,'윚');
	val = val.replace(/wwidj/g,'윛');
	val = val.replace(/wwik/g,'윜');
	val = val.replace(/wwig/g,'윅');
	val = val.replace(/wwi/g,'위');
	val = val.replace(/wwiq/g,'윙');
	val = val.replace(/wjus/g,'웃');
	val = val.replace(/wjuz/g,'웄');
	val = val.replace(/wjul/g,'울');
	val = val.replace(/wjun/g,'운');
	val = val.replace(/wjut/g,'웉');
	val = val.replace(/wjud/g,'욷');
	val = val.replace(/wjum/g,'움');
	val = val.replace(/wjup/g,'웊');
	val = val.replace(/wjub/g,'웁');
	val = val.replace(/wjuc/g,'웋');
	val = val.replace(/wjuf/g,'욾');
	val = val.replace(/wjuv/g,'웂');
	val = val.replace(/wjuch/g,'웆');
	val = val.replace(/wjudj/g,'웇');
	val = val.replace(/wjuk/g,'웈');
	val = val.replace(/wjug/g,'욱');
	val = val.replace(/wju/g,'우');
	val = val.replace(/wjuq/g,'웅');
	val = val.replace(/wwus/g,'윳');
	val = val.replace(/wwuz/g,'윴');
	val = val.replace(/wwul/g,'율');
	val = val.replace(/wwun/g,'윤');
	val = val.replace(/wwut/g,'윹');
	val = val.replace(/wwud/g,'윧');
	val = val.replace(/wwum/g,'윰');
	val = val.replace(/wwup/g,'윺');
	val = val.replace(/wwub/g,'윱');
	val = val.replace(/wwuc/g,'윻');
	val = val.replace(/wwuf/g,'윮');
	val = val.replace(/wwuv/g,'윲');
	val = val.replace(/wwuch/g,'윶');
	val = val.replace(/wwudj/g,'윷');
	val = val.replace(/wwuk/g,'윸');
	val = val.replace(/wwug/g,'육');
	val = val.replace(/wwu/g,'유');
	val = val.replace(/wwuq/g,'융');
	val = val.replace(/wjes/g,'옛');
	val = val.replace(/wjez/g,'옜');
	val = val.replace(/wjel/g,'옐');
	val = val.replace(/wjen/g,'옌');
	val = val.replace(/wjet/g,'옡');
	val = val.replace(/wjed/g,'옏');
	val = val.replace(/wjem/g,'옘');
	val = val.replace(/wjep/g,'옢');
	val = val.replace(/wjeb/g,'옙');
	val = val.replace(/wjec/g,'옣');
	val = val.replace(/wjef/g,'옖');
	val = val.replace(/wjev/g,'옚');
	val = val.replace(/wjech/g,'옞');
	val = val.replace(/wjedj/g,'옟');
	val = val.replace(/wjek/g,'옠');
	val = val.replace(/wjeg/g,'옉');
	val = val.replace(/wje/g,'예');
	val = val.replace(/wjeq/g,'옝');
	val = val.replace(/wwes/g,'웻');
	val = val.replace(/wwez/g,'웼');
	val = val.replace(/wwel/g,'웰');
	val = val.replace(/wwen/g,'웬');
	val = val.replace(/wwet/g,'윁');
	val = val.replace(/wwed/g,'웯');
	val = val.replace(/wwem/g,'웸');
	val = val.replace(/wwep/g,'윂');
	val = val.replace(/wweb/g,'웹');
	val = val.replace(/wwec/g,'윃');
	val = val.replace(/wwef/g,'웶');
	val = val.replace(/wwev/g,'웺');
	val = val.replace(/wwech/g,'웾');
	val = val.replace(/wwedj/g,'웿');
	val = val.replace(/wwek/g,'윀');
	val = val.replace(/wweg/g,'웩');
	val = val.replace(/wwe/g,'웨');
	val = val.replace(/wweq/g,'웽');
	val = val.replace(/wjos/g,'욧');
	val = val.replace(/wjoz/g,'욨');
	val = val.replace(/wjol/g,'욜');
	val = val.replace(/wjon/g,'욘');
	val = val.replace(/wjot/g,'욭');
	val = val.replace(/wjod/g,'욛');
	val = val.replace(/wjom/g,'욤');
	val = val.replace(/wjop/g,'욮');
	val = val.replace(/wjob/g,'욥');
	val = val.replace(/wjoc/g,'욯');
	val = val.replace(/wjof/g,'욢');
	val = val.replace(/wjov/g,'욦');
	val = val.replace(/wjoch/g,'욪');
	val = val.replace(/wjodj/g,'욫');
	val = val.replace(/wjok/g,'욬');
	val = val.replace(/wjog/g,'욕');
	val = val.replace(/wjo/g,'요');
	val = val.replace(/wjoq/g,'용');
	val = val.replace(/wwos/g,'욋');
	val = val.replace(/wwoz/g,'욌');
	val = val.replace(/wwol/g,'욀');
	val = val.replace(/wwon/g,'왼');
	val = val.replace(/wwot/g,'욑');
	val = val.replace(/wwod/g,'왿');
	val = val.replace(/wwom/g,'욈');
	val = val.replace(/wwop/g,'욒');
	val = val.replace(/wwob/g,'욉');
	val = val.replace(/wwoc/g,'욓');
	val = val.replace(/wwof/g,'욆');
	val = val.replace(/wwov/g,'욊');
	val = val.replace(/wwoch/g,'욎');
	val = val.replace(/wwodj/g,'욏');
	val = val.replace(/wwok/g,'욐');
	val = val.replace(/wwog/g,'왹');
	val = val.replace(/wwo/g,'외');
	val = val.replace(/wwoq/g,'욍');
	val = val.replace(/wjès/g,'엿');
	val = val.replace(/wjèz/g,'였');
	val = val.replace(/wjèl/g,'열');
	val = val.replace(/wjèn/g,'연');
	val = val.replace(/wjèt/g,'옅');
	val = val.replace(/wjèd/g,'엳');
	val = val.replace(/wjèm/g,'염');
	val = val.replace(/wjèp/g,'옆');
	val = val.replace(/wjèb/g,'엽');
	val = val.replace(/wjèc/g,'옇');
	val = val.replace(/wjèf/g,'엺');
	val = val.replace(/wjèv/g,'엾');
	val = val.replace(/wjèch/g,'옂');
	val = val.replace(/wjèdj/g,'옃');
	val = val.replace(/wjèk/g,'옄');
	val = val.replace(/wjèg/g,'역');
	val = val.replace(/wjè/g,'여');
	val = val.replace(/wjèq/g,'영');
	val = val.replace(/wwès/g,'웟');
	val = val.replace(/wwèz/g,'웠');
	val = val.replace(/wwèl/g,'월');
	val = val.replace(/wwèn/g,'원');
	val = val.replace(/wwèt/g,'웥');
	val = val.replace(/wwèd/g,'웓');
	val = val.replace(/wwèm/g,'웜');
	val = val.replace(/wwèp/g,'웦');
	val = val.replace(/wwèb/g,'웝');
	val = val.replace(/wwèc/g,'웧');
	val = val.replace(/wwèf/g,'웚');
	val = val.replace(/wwèv/g,'웞');
	val = val.replace(/wwèch/g,'웢');
	val = val.replace(/wwèdj/g,'웣');
	val = val.replace(/wwèk/g,'웤');
	val = val.replace(/wwèg/g,'웍');
	val = val.replace(/wwè/g,'워');
	val = val.replace(/wwèq/g,'웡');
	val = val.replace(/wjùs/g,'얫');
	val = val.replace(/wjùz/g,'얬');
	val = val.replace(/wjùl/g,'얠');
	val = val.replace(/wjùn/g,'얜');
	val = val.replace(/wjùt/g,'얱');
	val = val.replace(/wjùd/g,'얟');
	val = val.replace(/wjùm/g,'얨');
	val = val.replace(/wjùp/g,'얲');
	val = val.replace(/wjùb/g,'얩');
	val = val.replace(/wjùc/g,'얳');
	val = val.replace(/wjùf/g,'얦');
	val = val.replace(/wjùv/g,'얪');
	val = val.replace(/wjùch/g,'얮');
	val = val.replace(/wjùdj/g,'얯');
	val = val.replace(/wjùk/g,'얰');
	val = val.replace(/wjùg/g,'얙');
	val = val.replace(/wjù/g,'얘');
	val = val.replace(/wjùq/g,'얭');
	val = val.replace(/wwùs/g,'왯');
	val = val.replace(/wwùz/g,'왰');
	val = val.replace(/wwùl/g,'왤');
	val = val.replace(/wwùn/g,'왠');
	val = val.replace(/wwùt/g,'왵');
	val = val.replace(/wwùd/g,'왣');
	val = val.replace(/wwùm/g,'왬');
	val = val.replace(/wwùp/g,'왶');
	val = val.replace(/wwùb/g,'왭');
	val = val.replace(/wwùc/g,'왷');
	val = val.replace(/wwùf/g,'왪');
	val = val.replace(/wwùv/g,'왮');
	val = val.replace(/wwùch/g,'왲');
	val = val.replace(/wwùdj/g,'왳');
	val = val.replace(/wwùk/g,'왴');
	val = val.replace(/wwùg/g,'왝');
	val = val.replace(/wwù/g,'왜');
	val = val.replace(/wwùq/g,'왱');
	val = val.replace(/wjas/g,'얏');
	val = val.replace(/wjaz/g,'얐');
	val = val.replace(/wjal/g,'얄');
	val = val.replace(/wjan/g,'얀');
	val = val.replace(/wjat/g,'얕');
	val = val.replace(/wjad/g,'얃');
	val = val.replace(/wjam/g,'얌');
	val = val.replace(/wjap/g,'얖');
	val = val.replace(/wjab/g,'얍');
	val = val.replace(/wjac/g,'얗');
	val = val.replace(/wjaf/g,'얊');
	val = val.replace(/wjav/g,'얎');
	val = val.replace(/wjach/g,'얒');
	val = val.replace(/wjadj/g,'얓');
	val = val.replace(/wjak/g,'얔');
	val = val.replace(/wjag/g,'약');
	val = val.replace(/wja/g,'야');
	val = val.replace(/wjaq/g,'양');
	val = val.replace(/wwas/g,'왓');
	val = val.replace(/wwaz/g,'왔');
	val = val.replace(/wwal/g,'왈');
	val = val.replace(/wwan/g,'완');
	val = val.replace(/wwat/g,'왙');
	val = val.replace(/wwad/g,'왇');
	val = val.replace(/wwam/g,'왐');
	val = val.replace(/wwap/g,'왚');
	val = val.replace(/wwab/g,'왑');
	val = val.replace(/wwac/g,'왛');
	val = val.replace(/wwaf/g,'왎');
	val = val.replace(/wwav/g,'왒');
	val = val.replace(/wwach/g,'왖');
	val = val.replace(/wwadj/g,'왗');
	val = val.replace(/wwak/g,'왘');
	val = val.replace(/wwag/g,'왁');
	val = val.replace(/wwa/g,'와');
	val = val.replace(/wwaq/g,'왕');
