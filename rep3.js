function roCon(strIn) {
	...
	val = val.replace(/pyich/g,'픵ㅈ');
	val = val.replace(/pyidj/g,'픵ㅊ');
	val = val.replace(/dzwèp/g,'쀂');
	val = val.replace(/swach/g,'쫮');
	val = val.replace(/swadj/g,'쫯');
	val = val.replace(/pwich/g,'퓡ㅈ');
	val = val.replace(/pwidj/g,'퓡ㅊ');
	val = val.replace(/dzwèm/g,'뿸');
	val = val.replace(/pyuch/g,'풍ㅈ');
	val = val.replace(/pyudj/g,'풍ㅊ');
	val = val.replace(/dzwèd/g,'뿯');
	val = val.replace(/pwuch/g,'퓽ㅈ');
	val = val.replace(/pwudj/g,'퓽ㅊ');
	val = val.replace(/dzwèt/g,'쀁');
	val = val.replace(/pyech/g,'폥ㅈ');
	val = val.replace(/pyedj/g,'폥ㅊ');
	val = val.replace(/dzwèn/g,'뿬');
	val = val.replace(/pwech/g,'퓅ㅈ');
	val = val.replace(/pwedj/g,'퓅ㅊ');
	val = val.replace(/dzwèl/g,'뿰');
	val = val.replace(/pyoch/g,'푱ㅈ');
	val = val.replace(/pyodj/g,'푱ㅊ');
	val = val.replace(/dzwèz/g,'뿼');
	val = val.replace(/pwoch/g,'푕ㅈ');
	val = val.replace(/pwodj/g,'푕ㅊ');
	val = val.replace(/dzwès/g,'뿻');
	val = val.replace(/pyèch/g,'평ㅈ');
	val = val.replace(/pyèdj/g,'평ㅊ');
	val = val.replace(/dzyèq/g,'뼝');
	val = val.replace(/pwèch/g,'풩ㅈ');
	val = val.replace(/pwèdj/g,'풩ㅊ');
	val = val.replace(/pyùch/g,'퍵ㅈ');
	val = val.replace(/pyùdj/g,'퍵ㅊ');
	val = val.replace(/dzyèg/g,'뼉');
	val = val.replace(/zyich/g,'씢');
	val = val.replace(/zyidj/g,'씣');
	val = val.replace(/pwùch/g,'퐹ㅈ');
	val = val.replace(/pwùdj/g,'퐹ㅊ');
	val = val.replace(/dzyèk/g,'뼠');
	val = val.replace(/pyach/g,'퍙ㅈ');
	val = val.replace(/pyadj/g,'퍙ㅊ');
	val = val.replace(/myudj/g,'뭋');
	val = val.replace(/pwach/g,'퐝ㅈ');
	val = val.replace(/pwadj/g,'퐝ㅊ');
	...
	val = val.replace(/pwag/g,'퐝ㄱ');
	val = val.replace(/pwak/g,'퐝ㅋ');
	val = val.replace(/zwit/g,'쓑');
	val = val.replace(/zwin/g,'쒼');
	val = val.replace(/pwav/g,'퐝ㅄ');
	val = val.replace(/pwaf/g,'퐝ㄿ');
	val = val.replace(/pwac/g,'퐝ㅎ');
	val = val.replace(/pwab/g,'퐝ㅂ');
	val = val.replace(/pwap/g,'퐝ㅍ');
	val = val.replace(/pwam/g,'퐝ㅁ');
	val = val.replace(/pwad/g,'퐝ㄷ');
	val = val.replace(/pwat/g,'퐝ㅌ');
	val = val.replace(/pwan/g,'퐝ㄴ');
	val = val.replace(/pwal/g,'퐝ㅉ');
	val = val.replace(/pwaz/g,'퐝ㅆ');
	val = val.replace(/pwas/g,'퐝ㅅ');
	val = val.replace(/pyaq/g,'퍙');
	val = val.replace(/zwil/g,'쓀');
	val = val.replace(/pyag/g,'퍙ㄱ');
	val = val.replace(/pyak/g,'퍙ㅋ');
	val = val.replace(/zwiz/g,'쓌');
	val = val.replace(/zwis/g,'쓋');
	val = val.replace(/pyav/g,'퍙ㅄ');
	val = val.replace(/pyaf/g,'퍙ㄿ');
	val = val.replace(/pyac/g,'퍙ㅎ');
	val = val.replace(/pyab/g,'퍙ㅂ');
	val = val.replace(/pyap/g,'퍙ㅍ');
	val = val.replace(/pyam/g,'퍙ㅁ');
	val = val.replace(/pyad/g,'퍙ㄷ');
	val = val.replace(/pyat/g,'퍙ㅌ');
	val = val.replace(/pyan/g,'퍙ㄴ');
	val = val.replace(/pyal/g,'퍙ㅉ');
	val = val.replace(/pyaz/g,'퍙ㅆ');
	val = val.replace(/pyas/g,'퍙ㅅ');
	val = val.replace(/pwùq/g,'퐹');
	val = val.replace(/zyiq/g,'씡');
	val = val.replace(/pwùg/g,'퐹ㄱ');
	val = val.replace(/pwùk/g,'퐹ㅋ');
	val = val.replace(/zyig/g,'씍');
	val = val.replace(/zyik/g,'씤');
	val = val.replace(/pwùv/g,'퐹ㅄ');
	val = val.replace(/pwùf/g,'퐹ㄿ');
	val = val.replace(/pwùc/g,'퐹ㅎ');
	val = val.replace(/pwùb/g,'퐹ㅂ');
	val = val.replace(/pwùp/g,'퐹ㅍ');
	val = val.replace(/pwùm/g,'퐹ㅁ');
	val = val.replace(/pwùd/g,'퐹ㄷ');
	val = val.replace(/pwùt/g,'퐹ㅌ');
	val = val.replace(/pwùn/g,'퐹ㄴ');
	val = val.replace(/pwùl/g,'퐹ㅉ');
	val = val.replace(/pwùz/g,'퐹ㅆ');
	val = val.replace(/pwùs/g,'퐹ㅅ');
	val = val.replace(/pyùq/g,'퍵');
	val = val.replace(/zyiv/g,'씞');
	val = val.replace(/pyùg/g,'퍵ㄱ');
	val = val.replace(/pyùk/g,'퍵ㅋ');
	val = val.replace(/zyif/g,'씚');
	val = val.replace(/zyic/g,'씧');
	val = val.replace(/pyùv/g,'퍵ㅄ');
	val = val.replace(/pyùf/g,'퍵ㄿ');
	val = val.replace(/pyùc/g,'퍵ㅎ');
	val = val.replace(/pyùb/g,'퍵ㅂ');
	val = val.replace(/pyùp/g,'퍵ㅍ');
	val = val.replace(/pyùm/g,'퍵ㅁ');
	val = val.replace(/pyùd/g,'퍵ㄷ');
	val = val.replace(/pyùt/g,'퍵ㅌ');
	val = val.replace(/pyùn/g,'퍵ㄴ');
	val = val.replace(/pyùl/g,'퍵ㅉ');
	val = val.replace(/pyùz/g,'퍵ㅆ');
	val = val.replace(/pyùs/g,'퍵ㅅ');
	val = val.replace(/pwèq/g,'풩');
	val = val.replace(/dzyè/g,'뼈');
	val = val.replace(/pwèg/g,'풩ㄱ');
	val = val.replace(/pwèk/g,'풩ㅋ');
	val = val.replace(/zyib/g,'씝');
	val = val.replace(/zyip/g,'씦');
	val = val.replace(/pwèv/g,'풩ㅄ');
	val = val.replace(/pwèf/g,'풩ㄿ');
	val = val.replace(/pwèc/g,'풩ㅎ');
	val = val.replace(/pwèb/g,'풩ㅂ');
	val = val.replace(/pwèp/g,'풩ㅍ');
	val = val.replace(/pwèm/g,'풩ㅁ');
	val = val.replace(/pwèd/g,'풩ㄷ');
	val = val.replace(/pwèt/g,'풩ㅌ');
	val = val.replace(/pwèn/g,'풩ㄴ');
	val = val.replace(/pwèl/g,'풩ㅉ');
	val = val.replace(/pwèz/g,'풩ㅆ');
	val = val.replace(/pwès/g,'풩ㅅ');
	val = val.replace(/pyèq/g,'평');
	val = val.replace(/zyim/g,'씜');
	val = val.replace(/pyèg/g,'평ㄱ');
	val = val.replace(/pyèk/g,'평ㅋ');
	val = val.replace(/zyid/g,'씓');
	val = val.replace(/zyit/g,'씥');
	val = val.replace(/pyèv/g,'평ㅄ');
	val = val.replace(/pyèf/g,'평ㄿ');
	val = val.replace(/pyèc/g,'평ㅎ');
	val = val.replace(/pyèb/g,'평ㅂ');
	val = val.replace(/pyèp/g,'평ㅍ');
	val = val.replace(/pyèm/g,'평ㅁ');
	val = val.replace(/pyèd/g,'평ㄷ');
	val = val.replace(/pyèt/g,'평ㅌ');
	val = val.replace(/pyèn/g,'평ㄴ');
	val = val.replace(/pyèl/g,'평ㅉ');
	val = val.replace(/pyèz/g,'평ㅆ');
	val = val.replace(/pyès/g,'평ㅅ');
	val = val.replace(/pwoq/g,'푕');
	val = val.replace(/zyin/g,'씐');
	val = val.replace(/pwog/g,'푕ㄱ');
	val = val.replace(/pwok/g,'푕ㅋ');
	val = val.replace(/zyil/g,'씔');
	val = val.replace(/zyiz/g,'씠');
	val = val.replace(/pwov/g,'푕ㅄ');
	val = val.replace(/pwof/g,'푕ㄿ');
	val = val.replace(/pwoc/g,'푕ㅎ');
	val = val.replace(/pwob/g,'푕ㅂ');
	val = val.replace(/pwop/g,'푕ㅍ');
	val = val.replace(/pwom/g,'푕ㅁ');
	val = val.replace(/pwod/g,'푕ㄷ');
	val = val.replace(/pwot/g,'푕ㅌ');
	val = val.replace(/pwon/g,'푕ㄴ');
	val = val.replace(/pwol/g,'푕ㅉ');
	val = val.replace(/pwoz/g,'푕ㅆ');
	val = val.replace(/pwos/g,'푕ㅅ');
	val = val.replace(/pyoq/g,'푱');
	val = val.replace(/zyis/g,'씟');
	val = val.replace(/pyog/g,'푱ㄱ');
	val = val.replace(/pyok/g,'푱ㅋ');
	val = val.replace(/zadj/g,'쌏');
	val = val.replace(/zach/g,'쌎');
	val = val.replace(/pyov/g,'푱ㅄ');
	val = val.replace(/pyof/g,'푱ㄿ');
	val = val.replace(/pyoc/g,'푱ㅎ');
	val = val.replace(/pyob/g,'푱ㅂ');
	val = val.replace(/pyop/g,'푱ㅍ');
	val = val.replace(/pyom/g,'푱ㅁ');
	val = val.replace(/pyod/g,'푱ㄷ');
	val = val.replace(/pyot/g,'푱ㅌ');
	val = val.replace(/pyon/g,'푱ㄴ');
	val = val.replace(/pyol/g,'푱ㅉ');
	val = val.replace(/pyoz/g,'푱ㅆ');
	val = val.replace(/pyos/g,'푱ㅅ');
	val = val.replace(/pweq/g,'퓅');
	val = val.replace(/zedj/g,'쎛');
	val = val.replace(/pweg/g,'퓅ㄱ');
	val = val.replace(/pwek/g,'퓅ㅋ');
	val = val.replace(/zech/g,'쎚');
	val = val.replace(/zodj/g,'쏯');
	val = val.replace(/pwev/g,'퓅ㅄ');
	val = val.replace(/pwef/g,'퓅ㄿ');
	val = val.replace(/pwec/g,'퓅ㅎ');
	val = val.replace(/pweb/g,'퓅ㅂ');
	val = val.replace(/pwep/g,'퓅ㅍ');
	val = val.replace(/pwem/g,'퓅ㅁ');
	val = val.replace(/pwed/g,'퓅ㄷ');
	val = val.replace(/pwet/g,'퓅ㅌ');
	val = val.replace(/pwen/g,'퓅ㄴ');
	val = val.replace(/pwel/g,'퓅ㅉ');
	val = val.replace(/pwez/g,'퓅ㅆ');
	val = val.replace(/pwes/g,'퓅ㅅ');
	val = val.replace(/pyeq/g,'폥');
	val = val.replace(/zoch/g,'쏮');
	val = val.replace(/pyeg/g,'폥ㄱ');
	val = val.replace(/pyek/g,'폥ㅋ');
	val = val.replace(/zèdj/g,'썿');
	val = val.replace(/zèch/g,'썾');
	val = val.replace(/pyev/g,'폥ㅄ');
	val = val.replace(/pyef/g,'폥ㄿ');
	val = val.replace(/pyec/g,'폥ㅎ');
	val = val.replace(/pyeb/g,'폥ㅂ');
	val = val.replace(/pyep/g,'폥ㅍ');
	val = val.replace(/pyem/g,'폥ㅁ');
	val = val.replace(/pyed/g,'폥ㄷ');
	val = val.replace(/pyet/g,'폥ㅌ');
	val = val.replace(/pyen/g,'폥ㄴ');
	val = val.replace(/pyel/g,'폥ㅉ');
	val = val.replace(/pyez/g,'폥ㅆ');
	val = val.replace(/pyes/g,'폥ㅅ');
	val = val.replace(/pwuq/g,'퓽');
	val = val.replace(/zùdj/g,'쌫');
	val = val.replace(/pwug/g,'퓽ㄱ');
	val = val.replace(/pwuk/g,'퓽ㅋ');
	val = val.replace(/zùch/g,'쌪');
	val = val.replace(/zidj/g,'씿');
	val = val.replace(/pwuv/g,'퓽ㅄ');
	val = val.replace(/pwuf/g,'퓽ㄿ');
	val = val.replace(/pwuc/g,'퓽ㅎ');
	val = val.replace(/pwub/g,'퓽ㅂ');
	val = val.replace(/pwup/g,'퓽ㅍ');
	val = val.replace(/pwum/g,'퓽ㅁ');
	val = val.replace(/pwud/g,'퓽ㄷ');
	val = val.replace(/pwut/g,'퓽ㅌ');
	val = val.replace(/pwun/g,'퓽ㄴ');
	val = val.replace(/pwul/g,'퓽ㅉ');
	val = val.replace(/pwuz/g,'퓽ㅆ');
	val = val.replace(/pwus/g,'퓽ㅅ');
	val = val.replace(/pyuq/g,'풍');
	val = val.replace(/zich/g,'씾');
	val = val.replace(/pyug/g,'풍ㄱ');
	val = val.replace(/pyuk/g,'풍ㅋ');
	val = val.replace(/zudj/g,'씇');
	val = val.replace(/zuch/g,'씆');
	val = val.replace(/pyuv/g,'풍ㅄ');
	val = val.replace(/pyuf/g,'풍ㄿ');
	val = val.replace(/pyuc/g,'풍ㅎ');
	val = val.replace(/pyub/g,'풍ㅂ');
	val = val.replace(/pyup/g,'풍ㅍ');
	val = val.replace(/pyum/g,'풍ㅁ');
	val = val.replace(/pyud/g,'풍ㄷ');
	val = val.replace(/pyut/g,'풍ㅌ');
	val = val.replace(/pyun/g,'풍ㄴ');
	val = val.replace(/pyul/g,'풍ㅉ');
	val = val.replace(/pyuz/g,'풍ㅆ');
	val = val.replace(/pyus/g,'풍ㅅ');
	val = val.replace(/pwiq/g,'퓡');
	val = val.replace(/swaq/g,'쫭');
	val = val.replace(/pwig/g,'퓡ㄱ');
	val = val.replace(/pwik/g,'퓡ㅋ');
	val = val.replace(/swag/g,'쫙');
	val = val.replace(/swak/g,'쫰');
	val = val.replace(/pwiv/g,'퓡ㅄ');
	val = val.replace(/pwif/g,'퓡ㄿ');
	val = val.replace(/pwic/g,'퓡ㅎ');
	val = val.replace(/pwib/g,'퓡ㅂ');
	val = val.replace(/pwip/g,'퓡ㅍ');
	val = val.replace(/pwim/g,'퓡ㅁ');
	val = val.replace(/pwid/g,'퓡ㄷ');
	val = val.replace(/pwit/g,'퓡ㅌ');
	val = val.replace(/pwin/g,'퓡ㄴ');
	val = val.replace(/pwil/g,'퓡ㅉ');
	val = val.replace(/pwiz/g,'퓡ㅆ');
	val = val.replace(/pwis/g,'퓡ㅅ');
	val = val.replace(/pyiq/g,'픵');
	val = val.replace(/swav/g,'쫪');
	val = val.replace(/pyig/g,'픵ㄱ');
	val = val.replace(/pyik/g,'픵ㅋ');
	val = val.replace(/swaf/g,'쫦');
	val = val.replace(/swac/g,'쫳');
	val = val.replace(/pyiv/g,'픵ㅄ');
	val = val.replace(/pyif/g,'픵ㄿ');
	val = val.replace(/pyic/g,'픵ㅎ');
	val = val.replace(/pyib/g,'픵ㅂ');
	val = val.replace(/pyip/g,'픵ㅍ');
	val = val.replace(/pyim/g,'픵ㅁ');
	val = val.replace(/pyid/g,'픵ㄷ');
	val = val.replace(/pyit/g,'픵ㅌ');
	val = val.replace(/pyin/g,'픵ㄴ');
	val = val.replace(/pyil/g,'픵ㅉ');
	val = val.replace(/pyiz/g,'픵ㅆ');
	val = val.replace(/pyis/g,'픵ㅅ');
	val = val.replace(/swab/g,'쫩');
	val = val.replace(/swap/g,'쫲');
	val = val.replace(/swam/g,'쫨');
	val = val.replace(/swad/g,'쫟');
	val = val.replace(/padj/g,'팡ㅊ');
	val = val.replace(/pach/g,'팡ㅈ');
	...
	val = val.replace(/pedj/g,'펭ㅊ');
	val = val.replace(/pech/g,'펭ㅈ');
	...
	val = val.replace(/podj/g,'퐁ㅊ');
	val = val.replace(/poch/g,'퐁ㅈ');
	...
	val = val.replace(/pèdj/g,'펑ㅊ');
	val = val.replace(/pèch/g,'펑ㅈ');
	...
	val = val.replace(/pùdj/g,'팽ㅊ');
	val = val.replace(/pùch/g,'팽ㅈ');
	...
	val = val.replace(/pidj/g,'핑ㅊ');
	val = val.replace(/pich/g,'핑ㅈ');
	...
	val = val.replace(/pudj/g,'픙ㅊ');
	val = val.replace(/puch/g,'픙ㅈ');
	...
	val = val.replace(/pus/g,'픙ㅅ');
	val = val.replace(/puz/g,'픙ㅆ');
	val = val.replace(/pul/g,'픙ㅉ');
	val = val.replace(/pun/g,'픙ㄴ');
	val = val.replace(/put/g,'픙ㅌ');
	val = val.replace(/pud/g,'픙ㄷ');
	val = val.replace(/pum/g,'픙ㅁ');
	val = val.replace(/pup/g,'픙ㅍ');
	val = val.replace(/pub/g,'픙ㅂ');
	val = val.replace(/puc/g,'픙ㅎ');
	val = val.replace(/puf/g,'픙ㄿ');
	val = val.replace(/puv/g,'픙ㅄ');
	val = val.replace(/puk/g,'픙ㅋ');
	val = val.replace(/pug/g,'픙ㄱ');
	...
	val = val.replace(/pis/g,'핑ㅅ');
	val = val.replace(/piz/g,'핑ㅆ');
	...
	val = val.replace(/pil/g,'핑ㅉ');
	val = val.replace(/pin/g,'핑ㄴ');
	...
	val = val.replace(/pit/g,'핑ㅌ');
	val = val.replace(/pid/g,'핑ㄷ');
	...
	val = val.replace(/pim/g,'핑ㅁ');
	val = val.replace(/pip/g,'핑ㅍ');
	...
	val = val.replace(/pib/g,'핑ㅂ');
	val = val.replace(/pic/g,'핑ㅎ');
	...
	val = val.replace(/pif/g,'핑ㄿ');
	val = val.replace(/piv/g,'핑ㅄ');
	...
	val = val.replace(/pik/g,'핑ㅋ');
	val = val.replace(/pig/g,'핑ㄱ');
	...
	val = val.replace(/pùs/g,'팽ㅅ');
	val = val.replace(/pùz/g,'팽ㅆ');
	val = val.replace(/pùl/g,'팽ㅉ');
	val = val.replace(/pùn/g,'팽ㄴ');
	val = val.replace(/pùt/g,'팽ㅌ');
	val = val.replace(/pùd/g,'팽ㄷ');
	val = val.replace(/pùm/g,'팽ㅁ');
	val = val.replace(/pùp/g,'팽ㅍ');
	val = val.replace(/pùb/g,'팽ㅂ');
	val = val.replace(/pùc/g,'팽ㅎ');
	val = val.replace(/pùf/g,'팽ㄿ');
	val = val.replace(/pùv/g,'팽ㅄ');
	val = val.replace(/pùk/g,'팽ㅋ');
	val = val.replace(/pùg/g,'팽ㄱ');
	val = val.replace(/wèb/g,'웝');
	val = val.replace(/pùq/g,'팽');
	val = val.replace(/pès/g,'펑ㅅ');
	val = val.replace(/pèz/g,'펑ㅆ');
	val = val.replace(/pèl/g,'펑ㅉ');
	val = val.replace(/pèn/g,'펑ㄴ');
	val = val.replace(/pèt/g,'펑ㅌ');
	val = val.replace(/pèd/g,'펑ㄷ');
	val = val.replace(/pèm/g,'펑ㅁ');
	val = val.replace(/pèp/g,'펑ㅍ');
	val = val.replace(/pèb/g,'펑ㅂ');
	val = val.replace(/pèc/g,'펑ㅎ');
	val = val.replace(/pèf/g,'펑ㄿ');
	val = val.replace(/pèv/g,'펑ㅄ');
	val = val.replace(/pèk/g,'펑ㅋ');
	val = val.replace(/pèg/g,'펑ㄱ');
	val = val.replace(/wèc/g,'웧');
	val = val.replace(/pèq/g,'펑');
	val = val.replace(/pos/g,'퐁ㅅ');
	val = val.replace(/poz/g,'퐁ㅆ');
	val = val.replace(/pol/g,'퐁ㅉ');
	val = val.replace(/pon/g,'퐁ㄴ');
	val = val.replace(/pot/g,'퐁ㅌ');
	val = val.replace(/pod/g,'퐁ㄷ');
	val = val.replace(/pom/g,'퐁ㅁ');
	val = val.replace(/pop/g,'퐁ㅍ');
	val = val.replace(/pob/g,'퐁ㅂ');
	val = val.replace(/poc/g,'퐁ㅎ');
	val = val.replace(/pof/g,'퐁ㄿ');
	val = val.replace(/pov/g,'퐁ㅄ');
	val = val.replace(/pok/g,'퐁ㅋ');
	val = val.replace(/pog/g,'퐁ㄱ');
	val = val.replace(/wèf/g,'웚');
	val = val.replace(/poq/g,'퐁');
	val = val.replace(/pes/g,'펭ㅅ');
	val = val.replace(/pez/g,'펭ㅆ');
	val = val.replace(/pel/g,'펭ㅉ');
	val = val.replace(/pen/g,'펭ㄴ');
	val = val.replace(/pet/g,'펭ㅌ');
	val = val.replace(/ped/g,'펭ㄷ');
	val = val.replace(/pem/g,'펭ㅁ');
	val = val.replace(/pep/g,'펭ㅍ');
	val = val.replace(/peb/g,'펭ㅂ');
	val = val.replace(/pec/g,'펭ㅎ');
	val = val.replace(/pef/g,'펭ㄿ');
	val = val.replace(/pev/g,'펭ㅄ');
	val = val.replace(/pek/g,'펭ㅋ');
	val = val.replace(/peg/g,'펭ㄱ');
	val = val.replace(/wèv/g,'웞');
	val = val.replace(/peq/g,'펭');
	val = val.replace(/pas/g,'팡ㅅ');
	val = val.replace(/paz/g,'팡ㅆ');
	val = val.replace(/pal/g,'팡ㅉ');
	val = val.replace(/pan/g,'팡ㄴ');
	val = val.replace(/pat/g,'팡ㅌ');
	val = val.replace(/pad/g,'팡ㄷ');
	val = val.replace(/pam/g,'팡ㅁ');
	val = val.replace(/pap/g,'팡ㅍ');
	val = val.replace(/pab/g,'팡ㅂ');
	val = val.replace(/pac/g,'팡ㅎ');
	val = val.replace(/paf/g,'팡ㄿ');
	val = val.replace(/pav/g,'팡ㅄ');
	val = val.replace(/pak/g,'팡ㅋ');
	val = val.replace(/pag/g,'팡ㄱ');
	val = val.replace(/wèk/g,'웤');
	val = val.replace(/paq/g,'팡');
	val = val.replace(/pyi/g,'픵');
	val = val.replace(/pwi/g,'퓡');
	val = val.replace(/pyu/g,'풍');
	val = val.replace(/pwu/g,'퓽');
	val = val.replace(/pye/g,'폥');
	val = val.replace(/pwe/g,'퓅');
	val = val.replace(/pyo/g,'푱');
	val = val.replace(/pwo/g,'푕');
	val = val.replace(/pyè/g,'평');
	val = val.replace(/pwè/g,'풩');
	val = val.replace(/pyù/g,'퍵');
	val = val.replace(/pwù/g,'퐹');
	val = val.replace(/pya/g,'퍙');
	val = val.replace(/pwa/g,'퐝');
	...
	val = val.replace(/pi/g,'핑');
	val = val.replace(/pù/g,'팽');
	val = val.replace(/pè/g,'펑');
	val = val.replace(/po/g,'퐁');
	val = val.replace(/pe/g,'펭');
	val = val.replace(/pa/g,'팡');
