function roCon(strIn) {
	...
	val = val.replace(/zhyach/g,'샺');
	val = val.replace(/zhyadj/g,'샻');
	val = val.replace(/zhwach/g,'솾');
	val = val.replace(/zhwadj/g,'솿');
	val = val.replace(/zhwùdj/g,'쇛');
	val = val.replace(/zhwùch/g,'쇚');
	val = val.replace(/zhyùdj/g,'섗');
	val = val.replace(/zhyùch/g,'섖');
	val = val.replace(/zhwèdj/g,'쉋');
	val = val.replace(/zhwèch/g,'쉊');
	val = val.replace(/zhyèdj/g,'셫');
	val = val.replace(/zhyèch/g,'셪');
	val = val.replace(/zhwodj/g,'쇷');
	val = val.replace(/zhwoch/g,'쇶');
	val = val.replace(/zhyodj/g,'숓');
	val = val.replace(/zhyoch/g,'숒');
	val = val.replace(/chyich/g,'즺');
	val = val.replace(/chyidj/g,'즻');
	val = val.replace(/chwich/g,'쥦');
	val = val.replace(/chwidj/g,'쥧');
	val = val.replace(/chyuch/g,'줒');
	val = val.replace(/chyudj/g,'줓');
	val = val.replace(/chwuch/g,'즂');
	val = val.replace(/chwudj/g,'즃');
	val = val.replace(/chyech/g,'졪');
	val = val.replace(/chyedj/g,'졫');
	val = val.replace(/chwech/g,'쥊');
	val = val.replace(/chwedj/g,'쥋');
	val = val.replace(/chyoch/g,'죶');
	val = val.replace(/chyodj/g,'죷');
	val = val.replace(/chwoch/g,'죚');
	val = val.replace(/chwodj/g,'죛');
	val = val.replace(/zhwedj/g,'쉧');
	val = val.replace(/chyèch/g,'졎');
	val = val.replace(/chyèdj/g,'졏');
	val = val.replace(/zhwech/g,'쉦');
	val = val.replace(/chwèch/g,'줮');
	val = val.replace(/chwèdj/g,'줯');
	val = val.replace(/chyùch/g,'쟺');
	val = val.replace(/chyùdj/g,'쟻');
	val = val.replace(/chwùch/g,'좾');
	val = val.replace(/chwùdj/g,'좿');
	val = val.replace(/chyach/g,'쟞');
	val = val.replace(/chyadj/g,'쟟');
	val = val.replace(/chwach/g,'좢');
	val = val.replace(/chwadj/g,'좣');
	val = val.replace(/zhyedj/g,'솇');
	val = val.replace(/zhyech/g,'솆');
	val = val.replace(/zhwudj/g,'슟');
	val = val.replace(/zhwuch/g,'슞');
	val = val.replace(/zhyudj/g,'숯');
	val = val.replace(/zhyuch/g,'숮');
	val = val.replace(/zhwidj/g,'슃');
	val = val.replace(/zhwich/g,'슂');
	val = val.replace(/zhyidj/g,'싗');
	val = val.replace(/zhyich/g,'싖');
	val = val.replace(/tsyich/g,'띚');
	val = val.replace(/tsyidj/g,'띛');
	val = val.replace(/djyich/g,'칒');
	val = val.replace(/djyidj/g,'칓');
	val = val.replace(/djwich/g,'췾');
	val = val.replace(/djwidj/g,'췿');
	val = val.replace(/djyuch/g,'춪');
	val = val.replace(/djyudj/g,'춫');
	val = val.replace(/djwuch/g,'츚');
	val = val.replace(/djwudj/g,'츛');
	val = val.replace(/djyech/g,'촂');
	val = val.replace(/djyedj/g,'촃');
	val = val.replace(/djwech/g,'췢');
	val = val.replace(/djwedj/g,'췣');
	val = val.replace(/djyoch/g,'춎');
	val = val.replace(/djyodj/g,'춏');
	val = val.replace(/djwoch/g,'쵲');
	val = val.replace(/djwodj/g,'쵳');
	val = val.replace(/djyèch/g,'쳦');
	val = val.replace(/djyèdj/g,'쳧');
	val = val.replace(/shwadj/g,'솿');
	val = val.replace(/djwèch/g,'췆');
	val = val.replace(/djwèdj/g,'췇');
	val = val.replace(/shwach/g,'솾');
	val = val.replace(/djyùch/g,'첒');
	val = val.replace(/djyùdj/g,'첓');
	val = val.replace(/djwùch/g,'쵖');
	val = val.replace(/dzwach/g,'뽲');
	val = val.replace(/djyach/g,'챶');
	val = val.replace(/djyadj/g,'챷');
	val = val.replace(/djwach/g,'촺');
	val = val.replace(/djwadj/g,'촻');
	val = val.replace(/shyadj/g,'샻');
	val = val.replace(/shyach/g,'샺');
	val = val.replace(/shwùdj/g,'쇛');
	val = val.replace(/shwùch/g,'쇚');
	val = val.replace(/shyùdj/g,'섗');
	val = val.replace(/shyùch/g,'섖');
	val = val.replace(/shwèdj/g,'쉋');
	val = val.replace(/shwèch/g,'쉊');
	val = val.replace(/shyèdj/g,'셫');
	val = val.replace(/shyèch/g,'셪');
	val = val.replace(/shwodj/g,'쇷');
	val = val.replace(/shwoch/g,'쇶');
	val = val.replace(/shyodj/g,'숓');
	val = val.replace(/shyoch/g,'숒');
	val = val.replace(/shwedj/g,'쉧');
	val = val.replace(/shwech/g,'쉦');
	val = val.replace(/shyedj/g,'솇');
	val = val.replace(/shyech/g,'솆');
	val = val.replace(/shwudj/g,'슟');
	val = val.replace(/shwuch/g,'슞');
	val = val.replace(/shyudj/g,'숯');
	val = val.replace(/shyuch/g,'숮');
	val = val.replace(/shwidj/g,'슃');
	val = val.replace(/shwich/g,'슂');
	val = val.replace(/shyidj/g,'싗');
	val = val.replace(/shyich/g,'싖');
	val = val.replace(/tswich/g,'뜆');
	val = val.replace(/tswidj/g,'뜇');
	val = val.replace(/tsyuch/g,'뚲');
	val = val.replace(/tsyudj/g,'뚳');
	val = val.replace(/tswuch/g,'뜢');
	val = val.replace(/tswudj/g,'뜣');
	val = val.replace(/tsyech/g,'똊');
	val = val.replace(/tsyedj/g,'똋');
	val = val.replace(/tswech/g,'뛪');
	val = val.replace(/tswedj/g,'뛫');
	val = val.replace(/tsyoch/g,'뚖');
	val = val.replace(/tsyodj/g,'뚗');
	val = val.replace(/tswoch/g,'뙺');
	val = val.replace(/tswodj/g,'뙻');
	val = val.replace(/tsyèch/g,'뗮');
	val = val.replace(/tsyèdj/g,'뗯');
	val = val.replace(/tswèch/g,'뛎');
	val = val.replace(/tswèdj/g,'뛏');
	val = val.replace(/tsyùch/g,'떚');
	val = val.replace(/tsyùdj/g,'떛');
	val = val.replace(/tswùch/g,'뙞');
	val = val.replace(/tswùdj/g,'뙟');
	val = val.replace(/tsyach/g,'땾');
	val = val.replace(/tsyadj/g,'땿');
	val = val.replace(/tswach/g,'뙂');
	val = val.replace(/tswadj/g,'뙃');
	val = val.replace(/dzyich/g,'삊');
	val = val.replace(/dzyidj/g,'삋');
	val = val.replace(/dzwich/g,'쀶');
	val = val.replace(/dzwidj/g,'쀷');
	val = val.replace(/dzyuch/g,'뿢');
	val = val.replace(/dzyudj/g,'뿣');
	val = val.replace(/dzwuch/g,'쁒');
	val = val.replace(/dzwudj/g,'쁓');
	val = val.replace(/dzyech/g,'뼺');
	val = val.replace(/dzyedj/g,'뼻');
	val = val.replace(/dzwech/g,'쀚');
	val = val.replace(/dzwedj/g,'쀛');
	val = val.replace(/dzyoch/g,'뿆');
	val = val.replace(/dzyodj/g,'뿇');
	val = val.replace(/dzwoch/g,'뾪');
	val = val.replace(/dzwodj/g,'뾫');
	val = val.replace(/dzyèch/g,'뼞');
	val = val.replace(/dzyèdj/g,'뼟');
	val = val.replace(/dzwèch/g,'뿾');
	val = val.replace(/dzwèdj/g,'뿿');
	val = val.replace(/dzyùch/g,'뻊');
	val = val.replace(/dzyùdj/g,'뻋');
	val = val.replace(/dzwùch/g,'뾎');
	val = val.replace(/dzwùdj/g,'뾏');
	val = val.replace(/dzyach/g,'뺮');
	val = val.replace(/dzyadj/g,'뺯');
	val = val.replace(/dzwadj/g,'뽳');
	val = val.replace(/kyèdj/g,'켳');
	val = val.replace(/mwoch/g,'묒');
	val = val.replace(/mwodj/g,'묓');
	val = val.replace(/myèch/g,'몆');
	val = val.replace(/myèdj/g,'몇');
	val = val.replace(/mwèch/g,'뭦');
	val = val.replace(/mwèdj/g,'뭧');
	val = val.replace(/myùch/g,'먲');
	val = val.replace(/myùdj/g,'먳');
	val = val.replace(/mwùch/g,'뫶');
	val = val.replace(/mwùdj/g,'뫷');
	val = val.replace(/myach/g,'먖');
	val = val.replace(/syèch/g,'쪚');
	val = val.replace(/syèdj/g,'쪛');
	val = val.replace(/myadj/g,'먗');
	val = val.replace(/mwach/g,'뫚');
	val = val.replace(/mwadj/g,'뫛');
	val = val.replace(/lyidj/g,'릥ㅊ');
	val = val.replace(/lyich/g,'릥ㅈ');
	val = val.replace(/dzwaq/g,'뽱');
	val = val.replace(/dzwag/g,'뽝');
	val = val.replace(/dzwak/g,'뽴');
	val = val.replace(/myodj/g,'묯');
	val = val.replace(/myoch/g,'묮');
	...
	val = val.replace(/dzyaq/g,'뺭');
	val = val.replace(/dzyag/g,'뺙');
	val = val.replace(/dzyak/g,'뺰');
	val = val.replace(/mwedj/g,'뮃');
	val = val.replace(/mwech/g,'뮂');
	val = val.replace(/dzyav/g,'뺪');
	val = val.replace(/dzyaf/g,'뺦');
	val = val.replace(/dzyac/g,'뺳');
	val = val.replace(/dzyab/g,'뺩');
	val = val.replace(/dzyap/g,'뺲');
	val = val.replace(/dzyam/g,'뺨');
	val = val.replace(/dzyad/g,'뺟');
	val = val.replace(/dzyat/g,'뺱');
	val = val.replace(/dzyan/g,'뺜');
	val = val.replace(/syùch/g,'쩆');
	val = val.replace(/syùdj/g,'쩇');
	val = val.replace(/dzyal/g,'뺠');
	val = val.replace(/dzyaz/g,'뺬');
	val = val.replace(/dzyas/g,'뺫');
	val = val.replace(/dzwùq/g,'뾍');
	val = val.replace(/dzwùg/g,'뽹');
	val = val.replace(/dzwùk/g,'뾐');
	val = val.replace(/myedj/g,'몣');
	val = val.replace(/myech/g,'몢');
	...
	val = val.replace(/dzyùq/g,'뻉');
	val = val.replace(/dzyùg/g,'뺵');
	val = val.replace(/dzyùk/g,'뻌');
	val = val.replace(/swodj/g,'쬧');
	val = val.replace(/swoch/g,'쬦');
	val = val.replace(/dzyùv/g,'뻆');
	val = val.replace(/dzyùf/g,'뻂');
	val = val.replace(/dzyùc/g,'뻏');
	val = val.replace(/dzyùb/g,'뻅');
	val = val.replace(/dzyùp/g,'뻎');
	val = val.replace(/dzyùm/g,'뻄');
	val = val.replace(/dzyùd/g,'뺻');
	val = val.replace(/dzyùt/g,'뻍');
	val = val.replace(/dzyùn/g,'뺸');
	val = val.replace(/syach/g,'쨪');
	val = val.replace(/syadj/g,'쨫');
	val = val.replace(/dzyùl/g,'뺼');
	val = val.replace(/dzyùz/g,'뻈');
	val = val.replace(/dzyùs/g,'뻇');
	...
	val = val.replace(/pyich/g,'픶');
	val = val.replace(/pyidj/g,'픷');
	...
	val = val.replace(/pyuch/g,'풎');
	val = val.replace(/pyudj/g,'풏');
	val = val.replace(/dzwèd/g,'뿯');
	val = val.replace(/pwuch/g,'퓾');
	val = val.replace(/pwudj/g,'퓿');
	val = val.replace(/dzwèt/g,'쀁');
	val = val.replace(/pyech/g,'폦');
	val = val.replace(/pyedj/g,'폧');
	val = val.replace(/dzwèn/g,'뿬');
	val = val.replace(/pwech/g,'퓆');
	val = val.replace(/pwedj/g,'퓇');
	val = val.replace(/dzwèl/g,'뿰');
	val = val.replace(/pyoch/g,'푲');
	val = val.replace(/pyodj/g,'푳');
	val = val.replace(/dzwèz/g,'뿼');
	val = val.replace(/pwoch/g,'푖');
	val = val.replace(/pwodj/g,'푗');
	val = val.replace(/dzwès/g,'뿻');
	val = val.replace(/pyèch/g,'폊');
	val = val.replace(/pyèdj/g,'폋');
	val = val.replace(/dzyèq/g,'뼝');
	val = val.replace(/pwèch/g,'풪');
	val = val.replace(/pwèdj/g,'풫');
	val = val.replace(/pyùch/g,'퍶');
	val = val.replace(/pyùdj/g,'퍷');
	val = val.replace(/dzyèg/g,'뼉');
	val = val.replace(/zyich/g,'씢');
	val = val.replace(/zyidj/g,'씣');
	val = val.replace(/pwùch/g,'퐺');
	val = val.replace(/pwùdj/g,'퐻');
	val = val.replace(/dzyèk/g,'뼠');
	val = val.replace(/pyach/g,'퍚');
	val = val.replace(/pyadj/g,'퍛');
	val = val.replace(/myudj/g,'뭋');
	val = val.replace(/pwach/g,'퐞');
	val = val.replace(/pwadj/g,'퐟');
	val = val.replace(/myuch/g,'뭊');
	val = val.replace(/dzyèv/g,'뼚');
	val = val.replace(/dzyèf/g,'뼖');
	val = val.replace(/dzyèc/g,'뼣');
	val = val.replace(/dzyèb/g,'뼙');
	val = val.replace(/dzyèp/g,'뼢');
	val = val.replace(/dzyèm/g,'뼘');
	val = val.replace(/zwich/g,'쓎');
	val = val.replace(/zwidj/g,'쓏');
	val = val.replace(/dzyèd/g,'뼏');
	val = val.replace(/dzyèt/g,'뼡');
	val = val.replace(/dzyèn/g,'뼌');
	val = val.replace(/dzyèl/g,'뼐');
	val = val.replace(/dzyèz/g,'뼜');
	val = val.replace(/dzyès/g,'뼛');
	...
	val = val.replace(/zyuch/g,'쑺');
	val = val.replace(/zyudj/g,'쑻');
	...
	val = val.replace(/dzyoq/g,'뿅');
	val = val.replace(/dzyog/g,'뾱');
	val = val.replace(/dzyok/g,'뿈');
	val = val.replace(/lwich/g,'륑ㅈ');
	val = val.replace(/myidj/g,'믳');
	val = val.replace(/dzyov/g,'뿂');
	val = val.replace(/dzyof/g,'뾾');
	val = val.replace(/zwuch/g,'쓪');
	val = val.replace(/zwudj/g,'쓫');
	val = val.replace(/dzyoc/g,'뿋');
	val = val.replace(/dzyob/g,'뿁');
	val = val.replace(/dzyop/g,'뿊');
	val = val.replace(/dzyom/g,'뿀');
	val = val.replace(/dzyod/g,'뾷');
	val = val.replace(/dzyot/g,'뿉');
	val = val.replace(/dzyon/g,'뾴');
	val = val.replace(/dzyol/g,'뾸');
	val = val.replace(/dzyoz/g,'뿄');
	val = val.replace(/dzyos/g,'뿃');
	val = val.replace(/dzweq/g,'쀙');
	val = val.replace(/dzweg/g,'쀅');
	val = val.replace(/dzwek/g,'쀜');
	val = val.replace(/myich/g,'믲');
	val = val.replace(/lwidj/g,'륑ㅊ');
	val = val.replace(/zyech/g,'쏒');
	val = val.replace(/zyedj/g,'쏓');
	...
	val = val.replace(/dzyeq/g,'뼹');
	val = val.replace(/dzyeg/g,'뼥');
	val = val.replace(/dzyek/g,'뼼');
	val = val.replace(/zwech/g,'쒲');
	val = val.replace(/zwedj/g,'쒳');
	val = val.replace(/lyuch/g,'룽ㅈ');
	val = val.replace(/lyudj/g,'룽ㅊ');
	val = val.replace(/dzyev/g,'뼶');
	val = val.replace(/dzyef/g,'뼲');
	val = val.replace(/dzyec/g,'뼿');
	val = val.replace(/gwadj/g,'괓');
	val = val.replace(/gwach/g,'괒');
	val = val.replace(/dzyeb/g,'뼵');
	val = val.replace(/dzyep/g,'뼾');
	val = val.replace(/dzyem/g,'뼴');
	val = val.replace(/dzyed/g,'뼫');
	val = val.replace(/dzyet/g,'뼽');
	val = val.replace(/dzyen/g,'뼨');
	val = val.replace(/dzyel/g,'뼬');
	val = val.replace(/dzyez/g,'뼸');
	val = val.replace(/dzyes/g,'뼷');
	val = val.replace(/dzwuq/g,'쁑');
	val = val.replace(/dzwug/g,'쀽');
	val = val.replace(/dzwuk/g,'쁔');
	val = val.replace(/lwuch/g,'륭ㅈ');
	val = val.replace(/lwudj/g,'륭ㅊ');
	val = val.replace(/dzwuv/g,'쁎');
	val = val.replace(/dzwuf/g,'쁊');
	val = val.replace(/gyadj/g,'걏');
	val = val.replace(/gyach/g,'걎');
	...
	val = val.replace(/dzyuq/g,'뿡');
	val = val.replace(/dzyug/g,'뿍');
	val = val.replace(/dzyuk/g,'뿤');
	val = val.replace(/lyech/g,'롕ㅈ');
	val = val.replace(/lyedj/g,'롕ㅊ');
	val = val.replace(/dzyuv/g,'뿞');
	val = val.replace(/gwùdj/g,'괯');
	val = val.replace(/gwùch/g,'괮');
	val = val.replace(/dzyuf/g,'뿚');
	val = val.replace(/dzyuc/g,'뿧');
	val = val.replace(/dzyub/g,'뿝');
	val = val.replace(/byich/g,'븾');
	val = val.replace(/byidj/g,'븿');
	val = val.replace(/dzyup/g,'뿦');
	val = val.replace(/bwich/g,'뷪');
	val = val.replace(/bwidj/g,'뷫');
	val = val.replace(/dzyum/g,'뿜');
	val = val.replace(/byuch/g,'붖');
	val = val.replace(/byudj/g,'붗');
	val = val.replace(/dzyud/g,'뿓');
	val = val.replace(/bwuch/g,'븆');
	val = val.replace(/bwudj/g,'븇');
	val = val.replace(/dzyut/g,'뿥');
	val = val.replace(/byech/g,'볮');
	val = val.replace(/gyùdj/g,'걫');
	val = val.replace(/gyùch/g,'걪');
	val = val.replace(/byedj/g,'볯');
	val = val.replace(/dzyun/g,'뿐');
	val = val.replace(/bwech/g,'뷎');
	val = val.replace(/bwedj/g,'뷏');
	val = val.replace(/dzyul/g,'뿔');
	val = val.replace(/byoch/g,'뵺');
	val = val.replace(/byodj/g,'뵻');
	val = val.replace(/dzyuz/g,'뿠');
	val = val.replace(/bwoch/g,'뵞');
	val = val.replace(/bwodj/g,'뵟');
	val = val.replace(/dzyus/g,'뿟');
	val = val.replace(/byèch/g,'볒');
	val = val.replace(/byèdj/g,'볓');
	...
	val = val.replace(/dzyiq/g,'삉');
	val = val.replace(/dzyig/g,'쁵');
	val = val.replace(/dzyik/g,'삌');
	val = val.replace(/syoch/g,'쭂');
	val = val.replace(/lwedj/g,'뤵ㅊ');
	val = val.replace(/dzyiv/g,'삆');
	val = val.replace(/dzyif/g,'삂');
	val = val.replace(/dzyic/g,'삏');
	val = val.replace(/gwodj/g,'굋');
	val = val.replace(/gwoch/g,'굊');
	val = val.replace(/dzyib/g,'삅');
	val = val.replace(/dzyip/g,'삎');
	val = val.replace(/dzyim/g,'삄');
	val = val.replace(/dzyid/g,'쁻');
	val = val.replace(/dzyit/g,'삍');
	val = val.replace(/dzyin/g,'쁸');
	val = val.replace(/dzyil/g,'쁼');
	val = val.replace(/dzyiz/g,'삈');
	val = val.replace(/dzyis/g,'삇');
	...
	val = val.replace(/lyoch/g,'룡ㅈ');
	val = val.replace(/lyodj/g,'룡ㅊ');
	...
	val = val.replace(/lwoch/g,'룅ㅈ');
	val = val.replace(/lwodj/g,'룅ㅊ');
	...
	val = val.replace(/fyich/g,'픵ㅈ');
	val = val.replace(/fyidj/g,'픵ㅊ');
	val = val.replace(/tswès/g,'뛋');
	val = val.replace(/fwich/g,'퓡ㅈ');
	val = val.replace(/fwidj/g,'퓡ㅊ');
	val = val.replace(/tsyèq/g,'뗭');
	val = val.replace(/zwoch/g,'쑂');
	val = val.replace(/zwodj/g,'쑃');
	val = val.replace(/fyuch/g,'풍ㅈ');
	val = val.replace(/fyudj/g,'풍ㅊ');
	val = val.replace(/fwuch/g,'퓽ㅈ');
	val = val.replace(/fwudj/g,'퓽ㅊ');
	val = val.replace(/tsyèg/g,'뗙');
	val = val.replace(/fyech/g,'폥ㅈ');
	val = val.replace(/fyedj/g,'폥ㅊ');
	val = val.replace(/tsyèk/g,'뗰');
	val = val.replace(/fwech/g,'퓅ㅈ');
	val = val.replace(/fwedj/g,'퓅ㅊ');
	val = val.replace(/ryùdj/g,'럧');
	val = val.replace(/fyoch/g,'푱ㅈ');
	val = val.replace(/fyodj/g,'푱ㅊ');
	val = val.replace(/ryùch/g,'럦');
	val = val.replace(/fwoch/g,'푕ㅈ');
	val = val.replace(/fwodj/g,'푕ㅊ');
	val = val.replace(/tsyèv/g,'뗪');
	val = val.replace(/zyèch/g,'쎶');
	val = val.replace(/zyèdj/g,'쎷');
	val = val.replace(/fyèch/g,'평ㅈ');
	val = val.replace(/fyèdj/g,'평ㅊ');
	val = val.replace(/tsyèf/g,'뗦');
	val = val.replace(/fwèch/g,'풩ㅈ');
	val = val.replace(/fwèdj/g,'풩ㅊ');
	val = val.replace(/tsyèc/g,'뗳');
	val = val.replace(/fyùch/g,'퍵ㅈ');
	val = val.replace(/fyùdj/g,'퍵ㅊ');
	val = val.replace(/tsyèb/g,'뗩');
	val = val.replace(/fwùch/g,'퐹ㅈ');
	val = val.replace(/fwùdj/g,'퐹ㅊ');
	val = val.replace(/tsyèp/g,'뗲');
	val = val.replace(/fyach/g,'퍙ㅈ');
	val = val.replace(/fyadj/g,'퍙ㅊ');
	val = val.replace(/tsyèm/g,'뗨');
	val = val.replace(/fwach/g,'퐝ㅈ');
	val = val.replace(/fwadj/g,'퐝ㅊ');
	...
	val = val.replace(/vyich/g,'븽ㅈ');
	val = val.replace(/vyidj/g,'븽ㅊ');
	val = val.replace(/tsyus/g,'뚯');
	val = val.replace(/vwich/g,'뷩ㅈ');
	val = val.replace(/vwidj/g,'뷩ㅊ');
	val = val.replace(/tswiq/g,'뜅');
	val = val.replace(/kyùdj/g,'컟');
	val = val.replace(/kyùch/g,'컞');
	val = val.replace(/vyuch/g,'붕ㅈ');
	val = val.replace(/vyudj/g,'붕ㅊ');
	val = val.replace(/vwuch/g,'븅ㅈ');
	val = val.replace(/vwudj/g,'븅ㅊ');
	val = val.replace(/tswig/g,'뛱');
	val = val.replace(/vyech/g,'볭ㅈ');
	val = val.replace(/vyedj/g,'볭ㅊ');
	val = val.replace(/tswik/g,'뜈');
	val = val.replace(/vwech/g,'뷍ㅈ');
	val = val.replace(/vwedj/g,'뷍ㅊ');
	val = val.replace(/rwedj/g,'뤷');
	val = val.replace(/vyoch/g,'뵹ㅈ');
	val = val.replace(/vyodj/g,'뵹ㅊ');
	val = val.replace(/rwech/g,'뤶');
	val = val.replace(/vwoch/g,'뵝ㅈ');
	val = val.replace(/vwodj/g,'뵝ㅊ');
	val = val.replace(/kwèdj/g,'퀓');
	val = val.replace(/kwèch/g,'퀒');
	val = val.replace(/tswiv/g,'뜂');
	val = val.replace(/vyèch/g,'병ㅈ');
	val = val.replace(/vyèdj/g,'병ㅊ');
	val = val.replace(/tswif/g,'뛾');
	val = val.replace(/vwèch/g,'붱ㅈ');
	val = val.replace(/vwèdj/g,'붱ㅊ');
	val = val.replace(/tswic/g,'뜋');
	val = val.replace(/vyùch/g,'뱽ㅈ');
	val = val.replace(/vyùdj/g,'뱽ㅊ');
	val = val.replace(/tswib/g,'뜁');
	val = val.replace(/vwùch/g,'뵁ㅈ');
	val = val.replace(/vwùdj/g,'뵁ㅊ');
	val = val.replace(/tswip/g,'뜊');
	val = val.replace(/vyach/g,'뱡ㅈ');
	val = val.replace(/vyadj/g,'뱡ㅊ');
	val = val.replace(/tswim/g,'뜀');
	val = val.replace(/zhyaf/g,'샲');
	val = val.replace(/kyèch/g,'켲');
	val = val.replace(/vwach/g,'봥ㅈ');
	val = val.replace(/vwadj/g,'봥ㅊ');
	...
	val = val.replace(/lwèch/g,'뤙ㅈ');
	val = val.replace(/lwèdj/g,'뤙ㅊ');
	...
	val = val.replace(/lyùch/g,'럥ㅈ');
	val = val.replace(/lyùdj/g,'럥ㅊ');
	...
	val = val.replace(/lwùch/g,'뢩ㅈ');
	val = val.replace(/lwùdj/g,'뢩ㅊ');
	...
	val = val.replace(/lyach/g,'량ㅈ');
	val = val.replace(/lyadj/g,'량ㅊ');
	...
	val = val.replace(/lwach/g,'뢍ㅈ');
	val = val.replace(/lwadj/g,'뢍ㅊ');
	...
	val = val.replace(/vwag/g,'봥ㄱ');
	val = val.replace(/vwak/g,'봥ㅋ');
	val = val.replace(/kyèf/g,'켪');
	val = val.replace(/kyèv/g,'켮');
	val = val.replace(/vwav/g,'봥ㅄ');
	val = val.replace(/vwaf/g,'봥ㄿ');
	val = val.replace(/vwac/g,'봥ㅎ');
	val = val.replace(/vwab/g,'봥ㅂ');
	val = val.replace(/vwap/g,'봥ㅍ');
	val = val.replace(/vwam/g,'봥ㅁ');
	val = val.replace(/vwad/g,'봥ㄷ');
	val = val.replace(/vwat/g,'봥ㅌ');
	val = val.replace(/vwan/g,'봥ㄴ');
	val = val.replace(/vwal/g,'봥ㅉ');
	val = val.replace(/vwaz/g,'봥ㅆ');
	val = val.replace(/vwas/g,'봥ㅅ');
	val = val.replace(/vyaq/g,'뱡');
	val = val.replace(/kyèk/g,'켴');
	val = val.replace(/vyag/g,'뱡ㄱ');
	val = val.replace(/vyak/g,'뱡ㅋ');
	val = val.replace(/kyèg/g,'켝');
	val = val.replace(/zwaf/g,'쐂');
	val = val.replace(/vyav/g,'뱡ㅄ');
	val = val.replace(/vyaf/g,'뱡ㄿ');
	val = val.replace(/vyac/g,'뱡ㅎ');
	val = val.replace(/vyab/g,'뱡ㅂ');
	val = val.replace(/vyap/g,'뱡ㅍ');
	val = val.replace(/vyam/g,'뱡ㅁ');
	val = val.replace(/vyad/g,'뱡ㄷ');
	val = val.replace(/vyat/g,'뱡ㅌ');
	val = val.replace(/vyan/g,'뱡ㄴ');
	val = val.replace(/vyal/g,'뱡ㅉ');
	val = val.replace(/vyaz/g,'뱡ㅆ');
	val = val.replace(/vyas/g,'뱡ㅅ');
	val = val.replace(/vwùq/g,'뵁');
	val = val.replace(/kyèq/g,'켱');
	val = val.replace(/vwùg/g,'뵁ㄱ');
	val = val.replace(/vwùk/g,'뵁ㅋ');
	val = val.replace(/kwès/g,'퀏');
	val = val.replace(/kwèz/g,'퀐');
	val = val.replace(/vwùv/g,'뵁ㅄ');
	val = val.replace(/vwùf/g,'뵁ㄿ');
	val = val.replace(/vwùc/g,'뵁ㅎ');
	val = val.replace(/vwùb/g,'뵁ㅂ');
	val = val.replace(/vwùp/g,'뵁ㅍ');
	val = val.replace(/vwùm/g,'뵁ㅁ');
	val = val.replace(/vwùd/g,'뵁ㄷ');
	val = val.replace(/vwùt/g,'뵁ㅌ');
	val = val.replace(/vwùn/g,'뵁ㄴ');
	val = val.replace(/vwùl/g,'뵁ㅉ');
	val = val.replace(/vwùz/g,'뵁ㅆ');
	val = val.replace(/vwùs/g,'뵁ㅅ');
	val = val.replace(/vyùq/g,'뱽');
	val = val.replace(/kwèl/g,'퀄');
	val = val.replace(/vyùg/g,'뱽ㄱ');
	val = val.replace(/vyùk/g,'뱽ㅋ');
	val = val.replace(/kwèn/g,'퀀');
	val = val.replace(/kwèt/g,'퀕');
	val = val.replace(/vyùv/g,'뱽ㅄ');
	val = val.replace(/vyùf/g,'뱽ㄿ');
	val = val.replace(/vyùc/g,'뱽ㅎ');
	val = val.replace(/vyùb/g,'뱽ㅂ');
	val = val.replace(/vyùp/g,'뱽ㅍ');
	val = val.replace(/vyùm/g,'뱽ㅁ');
	val = val.replace(/vyùd/g,'뱽ㄷ');
	val = val.replace(/vyùt/g,'뱽ㅌ');
	val = val.replace(/vyùn/g,'뱽ㄴ');
	val = val.replace(/vyùl/g,'뱽ㅉ');
	val = val.replace(/vyùz/g,'뱽ㅆ');
	val = val.replace(/vyùs/g,'뱽ㅅ');
	val = val.replace(/vwèq/g,'붱');
	val = val.replace(/kwèd/g,'퀃');
	val = val.replace(/vwèg/g,'붱ㄱ');
	val = val.replace(/vwèk/g,'붱ㅋ');
	val = val.replace(/kwèm/g,'퀌');
	val = val.replace(/kwèp/g,'퀖');
	val = val.replace(/vwèv/g,'붱ㅄ');
	val = val.replace(/vwèf/g,'붱ㄿ');
	val = val.replace(/vwèc/g,'붱ㅎ');
	val = val.replace(/vwèb/g,'붱ㅂ');
	val = val.replace(/vwèp/g,'붱ㅍ');
	val = val.replace(/vwèm/g,'붱ㅁ');
	val = val.replace(/vwèd/g,'붱ㄷ');
	val = val.replace(/vwèt/g,'붱ㅌ');
	val = val.replace(/vwèn/g,'붱ㄴ');
	val = val.replace(/vwèl/g,'붱ㅉ');
	val = val.replace(/vwèz/g,'붱ㅆ');
	val = val.replace(/vwès/g,'붱ㅅ');
	val = val.replace(/vyèq/g,'병');
	val = val.replace(/kwèb/g,'퀍');
	val = val.replace(/vyèg/g,'병ㄱ');
	val = val.replace(/vyèk/g,'병ㅋ');
	val = val.replace(/kwèc/g,'퀗');
	val = val.replace(/kwèf/g,'퀊');
	val = val.replace(/vyèv/g,'병ㅄ');
	val = val.replace(/vyèf/g,'병ㄿ');
	val = val.replace(/vyèc/g,'병ㅎ');
	val = val.replace(/vyèb/g,'병ㅂ');
	val = val.replace(/vyèp/g,'병ㅍ');
	val = val.replace(/vyèm/g,'병ㅁ');
	val = val.replace(/vyèd/g,'병ㄷ');
	val = val.replace(/vyèt/g,'병ㅌ');
	val = val.replace(/vyèn/g,'병ㄴ');
	val = val.replace(/vyèl/g,'병ㅉ');
	val = val.replace(/vyèz/g,'병ㅆ');
	val = val.replace(/vyès/g,'병ㅅ');
	val = val.replace(/vwoq/g,'뵝');
	val = val.replace(/kwèv/g,'퀎');
	val = val.replace(/vwog/g,'뵝ㄱ');
	val = val.replace(/vwok/g,'뵝ㅋ');
	val = val.replace(/kwèk/g,'퀔');
	val = val.replace(/kwèg/g,'쿽');
	val = val.replace(/vwov/g,'뵝ㅄ');
	val = val.replace(/vwof/g,'뵝ㄿ');
	val = val.replace(/vwoc/g,'뵝ㅎ');
	val = val.replace(/vwob/g,'뵝ㅂ');
	val = val.replace(/vwop/g,'뵝ㅍ');
	val = val.replace(/vwom/g,'뵝ㅁ');
	val = val.replace(/vwod/g,'뵝ㄷ');
	val = val.replace(/vwot/g,'뵝ㅌ');
	val = val.replace(/vwon/g,'뵝ㄴ');
	val = val.replace(/vwol/g,'뵝ㅉ');
	val = val.replace(/vwoz/g,'뵝ㅆ');
	val = val.replace(/vwos/g,'뵝ㅅ');
	val = val.replace(/vyoq/g,'뵹');
	val = val.replace(/zwac/g,'쐏');
	val = val.replace(/vyog/g,'뵹ㄱ');
	val = val.replace(/vyok/g,'뵹ㅋ');
	val = val.replace(/kwèq/g,'퀑');
	val = val.replace(/kyùs/g,'컛');
	val = val.replace(/vyov/g,'뵹ㅄ');
	val = val.replace(/vyof/g,'뵹ㄿ');
	val = val.replace(/vyoc/g,'뵹ㅎ');
	val = val.replace(/vyob/g,'뵹ㅂ');
	val = val.replace(/vyop/g,'뵹ㅍ');
	val = val.replace(/vyom/g,'뵹ㅁ');
	val = val.replace(/vyod/g,'뵹ㄷ');
	val = val.replace(/vyot/g,'뵹ㅌ');
	val = val.replace(/vyon/g,'뵹ㄴ');
	val = val.replace(/vyol/g,'뵹ㅉ');
	val = val.replace(/vyoz/g,'뵹ㅆ');
	val = val.replace(/vyos/g,'뵹ㅅ');
	val = val.replace(/vweq/g,'뷍');
	val = val.replace(/kyùz/g,'컜');
	val = val.replace(/vweg/g,'뷍ㄱ');
	val = val.replace(/vwek/g,'뷍ㅋ');
	val = val.replace(/kyùl/g,'컐');
	val = val.replace(/kyùn/g,'컌');
	val = val.replace(/vwev/g,'뷍ㅄ');
	val = val.replace(/vwef/g,'뷍ㄿ');
	val = val.replace(/vwec/g,'뷍ㅎ');
	val = val.replace(/vweb/g,'뷍ㅂ');
	val = val.replace(/vwep/g,'뷍ㅍ');
	val = val.replace(/vwem/g,'뷍ㅁ');
	val = val.replace(/vwed/g,'뷍ㄷ');
	val = val.replace(/vwet/g,'뷍ㅌ');
	val = val.replace(/vwen/g,'뷍ㄴ');
	val = val.replace(/vwel/g,'뷍ㅉ');
	val = val.replace(/vwez/g,'뷍ㅆ');
	val = val.replace(/vwes/g,'뷍ㅅ');
	val = val.replace(/vyeq/g,'볭');
	val = val.replace(/kyùt/g,'컡');
	val = val.replace(/vyeg/g,'볭ㄱ');
	val = val.replace(/vyek/g,'볭ㅋ');
	val = val.replace(/kyùd/g,'컏');
	val = val.replace(/kyùm/g,'컘');
	val = val.replace(/vyev/g,'볭ㅄ');
	val = val.replace(/vyef/g,'볭ㄿ');
	val = val.replace(/vyec/g,'볭ㅎ');
	val = val.replace(/vyeb/g,'볭ㅂ');
	val = val.replace(/vyep/g,'볭ㅍ');
	val = val.replace(/vyem/g,'볭ㅁ');
	val = val.replace(/vyed/g,'볭ㄷ');
	val = val.replace(/vyet/g,'볭ㅌ');
	val = val.replace(/vyen/g,'볭ㄴ');
	val = val.replace(/vyel/g,'볭ㅉ');
	val = val.replace(/vyez/g,'볭ㅆ');
	val = val.replace(/vyes/g,'볭ㅅ');
	val = val.replace(/vwuq/g,'븅');
	val = val.replace(/kyùp/g,'컢');
	val = val.replace(/vwug/g,'븅ㄱ');
	val = val.replace(/vwuk/g,'븅ㅋ');
	val = val.replace(/kyùb/g,'컙');
	val = val.replace(/kyùc/g,'컣');
	val = val.replace(/vwuv/g,'븅ㅄ');
	val = val.replace(/vwuf/g,'븅ㄿ');
	val = val.replace(/vwuc/g,'븅ㅎ');
	val = val.replace(/vwub/g,'븅ㅂ');
	val = val.replace(/vwup/g,'븅ㅍ');
	val = val.replace(/vwum/g,'븅ㅁ');
	val = val.replace(/vwud/g,'븅ㄷ');
	val = val.replace(/vwut/g,'븅ㅌ');
	val = val.replace(/vwun/g,'븅ㄴ');
	val = val.replace(/vwul/g,'븅ㅉ');
	val = val.replace(/vwuz/g,'븅ㅆ');
	val = val.replace(/vwus/g,'븅ㅅ');
	val = val.replace(/vyuq/g,'붕');
	val = val.replace(/tswi/g,'뛰');
	val = val.replace(/vyug/g,'붕ㄱ');
	val = val.replace(/vyuk/g,'붕ㅋ');
	val = val.replace(/kyùf/g,'컖');
	val = val.replace(/kyùv/g,'컚');
	val = val.replace(/vyuv/g,'붕ㅄ');
	val = val.replace(/vyuf/g,'붕ㄿ');
	val = val.replace(/vyuc/g,'붕ㅎ');
	val = val.replace(/vyub/g,'붕ㅂ');
	val = val.replace(/vyup/g,'붕ㅍ');
	val = val.replace(/vyum/g,'붕ㅁ');
	val = val.replace(/vyud/g,'붕ㄷ');
	val = val.replace(/vyut/g,'붕ㅌ');
	val = val.replace(/vyun/g,'붕ㄴ');
	val = val.replace(/vyul/g,'붕ㅉ');
	val = val.replace(/vyuz/g,'붕ㅆ');
	val = val.replace(/vyus/g,'붕ㅅ');
	val = val.replace(/vwiq/g,'뷩');
	val = val.replace(/kyùk/g,'컠');
	val = val.replace(/vwig/g,'뷩ㄱ');
	val = val.replace(/vwik/g,'뷩ㅋ');
	val = val.replace(/kyùg/g,'컉');
	val = val.replace(/zwab/g,'쐅');
	val = val.replace(/vwiv/g,'뷩ㅄ');
	val = val.replace(/vwif/g,'뷩ㄿ');
	val = val.replace(/vwic/g,'뷩ㅎ');
	val = val.replace(/vwib/g,'뷩ㅂ');
	val = val.replace(/vwip/g,'뷩ㅍ');
	val = val.replace(/vwim/g,'뷩ㅁ');
	val = val.replace(/vwid/g,'뷩ㄷ');
	val = val.replace(/vwit/g,'뷩ㅌ');
	val = val.replace(/vwin/g,'뷩ㄴ');
	val = val.replace(/vwil/g,'뷩ㅉ');
	val = val.replace(/vwiz/g,'뷩ㅆ');
	val = val.replace(/vwis/g,'뷩ㅅ');
	val = val.replace(/vyiq/g,'븽');
	val = val.replace(/kyùq/g,'컝');
	val = val.replace(/vyig/g,'븽ㄱ');
	val = val.replace(/vyik/g,'븽ㅋ');
	val = val.replace(/kwùs/g,'쾟');
	val = val.replace(/kwùz/g,'쾠');
	val = val.replace(/vyiv/g,'븽ㅄ');
	val = val.replace(/vyif/g,'븽ㄿ');
	val = val.replace(/vyic/g,'븽ㅎ');
	val = val.replace(/vyib/g,'븽ㅂ');
	val = val.replace(/vyip/g,'븽ㅍ');
	val = val.replace(/vyim/g,'븽ㅁ');
	val = val.replace(/vyid/g,'븽ㄷ');
	val = val.replace(/vyit/g,'븽ㅌ');
	val = val.replace(/vyin/g,'븽ㄴ');
	val = val.replace(/vyil/g,'븽ㅉ');
	val = val.replace(/vyiz/g,'븽ㅆ');
	val = val.replace(/vyis/g,'븽ㅅ');
	val = val.replace(/kwùl/g,'쾔');
	val = val.replace(/kwùn/g,'쾐');
	val = val.replace(/kwùt/g,'쾥');
	val = val.replace(/kwùd/g,'쾓');
	val = val.replace(/vadj/g,'방ㅊ');
	val = val.replace(/vach/g,'방ㅈ');
	...
	val = val.replace(/vedj/g,'벵ㅊ');
	val = val.replace(/vech/g,'벵ㅈ');
	...
	val = val.replace(/vodj/g,'봉ㅊ');
	val = val.replace(/voch/g,'봉ㅈ');
	...
	val = val.replace(/vèdj/g,'벙ㅊ');
	val = val.replace(/vèch/g,'벙ㅈ');
	...
	val = val.replace(/vùdj/g,'뱅ㅊ');
	val = val.replace(/vùch/g,'뱅ㅈ');
	...
	val = val.replace(/vidj/g,'빙ㅊ');
	val = val.replace(/vich/g,'빙ㅈ');
	...
	val = val.replace(/vudj/g,'븡ㅊ');
	val = val.replace(/vuch/g,'븡ㅈ');
	...
	val = val.replace(/fwag/g,'퐝ㄱ');
	val = val.replace(/fwak/g,'퐝ㅋ');
	val = val.replace(/zwèv/g,'쒒');
	val = val.replace(/zwèf/g,'쒎');
	val = val.replace(/fwav/g,'퐝ㅄ');
	val = val.replace(/fwaf/g,'퐝ㄿ');
	val = val.replace(/fwac/g,'퐝ㅎ');
	val = val.replace(/fwab/g,'퐝ㅂ');
	val = val.replace(/fwap/g,'퐝ㅍ');
	val = val.replace(/fwam/g,'퐝ㅁ');
	val = val.replace(/fwad/g,'퐝ㄷ');
	val = val.replace(/fwat/g,'퐝ㅌ');
	val = val.replace(/fwan/g,'퐝ㄴ');
	val = val.replace(/fwal/g,'퐝ㅉ');
	val = val.replace(/fwaz/g,'퐝ㅆ');
	val = val.replace(/fwas/g,'퐝ㅅ');
	val = val.replace(/fyaq/g,'퍙');
	val = val.replace(/zwèc/g,'쒛');
	val = val.replace(/fyag/g,'퍙ㄱ');
	val = val.replace(/fyak/g,'퍙ㅋ');
	val = val.replace(/zwèb/g,'쒑');
	val = val.replace(/zwèp/g,'쒚');
	val = val.replace(/fyav/g,'퍙ㅄ');
	val = val.replace(/fyaf/g,'퍙ㄿ');
	val = val.replace(/fyac/g,'퍙ㅎ');
	val = val.replace(/fyab/g,'퍙ㅂ');
	val = val.replace(/fyap/g,'퍙ㅍ');
	val = val.replace(/fyam/g,'퍙ㅁ');
	val = val.replace(/fyad/g,'퍙ㄷ');
	val = val.replace(/fyat/g,'퍙ㅌ');
	val = val.replace(/fyan/g,'퍙ㄴ');
	val = val.replace(/fyal/g,'퍙ㅉ');
	val = val.replace(/fyaz/g,'퍙ㅆ');
	val = val.replace(/fyas/g,'퍙ㅅ');
	val = val.replace(/fwùq/g,'퐹');
	val = val.replace(/zwèm/g,'쒐');
	val = val.replace(/fwùg/g,'퐹ㄱ');
	val = val.replace(/fwùk/g,'퐹ㅋ');
	val = val.replace(/zwèd/g,'쒇');
	val = val.replace(/zwèt/g,'쒙');
	val = val.replace(/fwùv/g,'퐹ㅄ');
	val = val.replace(/fwùf/g,'퐹ㄿ');
	val = val.replace(/fwùc/g,'퐹ㅎ');
	val = val.replace(/fwùb/g,'퐹ㅂ');
	val = val.replace(/fwùp/g,'퐹ㅍ');
	val = val.replace(/fwùm/g,'퐹ㅁ');
	val = val.replace(/fwùd/g,'퐹ㄷ');
	val = val.replace(/fwùt/g,'퐹ㅌ');
	val = val.replace(/fwùn/g,'퐹ㄴ');
	val = val.replace(/fwùl/g,'퐹ㅉ');
	val = val.replace(/fwùz/g,'퐹ㅆ');
	val = val.replace(/fwùs/g,'퐹ㅅ');
	val = val.replace(/fyùq/g,'퍵');
	val = val.replace(/zwèn/g,'쒄');
	val = val.replace(/fyùg/g,'퍵ㄱ');
	val = val.replace(/fyùk/g,'퍵ㅋ');
	val = val.replace(/zwèl/g,'쒈');
	val = val.replace(/zwèz/g,'쒔');
	val = val.replace(/fyùv/g,'퍵ㅄ');
	val = val.replace(/fyùf/g,'퍵ㄿ');
	val = val.replace(/fyùc/g,'퍵ㅎ');
	val = val.replace(/fyùb/g,'퍵ㅂ');
	val = val.replace(/fyùp/g,'퍵ㅍ');
	val = val.replace(/fyùm/g,'퍵ㅁ');
	val = val.replace(/fyùd/g,'퍵ㄷ');
	val = val.replace(/fyùt/g,'퍵ㅌ');
	val = val.replace(/fyùn/g,'퍵ㄴ');
	val = val.replace(/fyùl/g,'퍵ㅉ');
	val = val.replace(/fyùz/g,'퍵ㅆ');
	val = val.replace(/fyùs/g,'퍵ㅅ');
	val = val.replace(/fwèq/g,'풩');
	val = val.replace(/zwès/g,'쒓');
	val = val.replace(/fwèg/g,'풩ㄱ');
	val = val.replace(/fwèk/g,'풩ㅋ');
	val = val.replace(/zyèq/g,'쎵');
	val = val.replace(/zyèg/g,'쎡');
	val = val.replace(/fwèv/g,'풩ㅄ');
	val = val.replace(/fwèf/g,'풩ㄿ');
	val = val.replace(/fwèc/g,'풩ㅎ');
	val = val.replace(/fwèb/g,'풩ㅂ');
	val = val.replace(/fwèp/g,'풩ㅍ');
	val = val.replace(/fwèm/g,'풩ㅁ');
	val = val.replace(/fwèd/g,'풩ㄷ');
	val = val.replace(/fwèt/g,'풩ㅌ');
	val = val.replace(/fwèn/g,'풩ㄴ');
	val = val.replace(/fwèl/g,'풩ㅉ');
	val = val.replace(/fwèz/g,'풩ㅆ');
	val = val.replace(/fwès/g,'풩ㅅ');
	val = val.replace(/fyèq/g,'평');
	val = val.replace(/zyèk/g,'쎸');
	val = val.replace(/fyèg/g,'평ㄱ');
	val = val.replace(/fyèk/g,'평ㅋ');
	val = val.replace(/goch/g,'곶');
	val = val.replace(/godj/g,'곷');
	val = val.replace(/fyèv/g,'평ㅄ');
	val = val.replace(/fyèf/g,'평ㄿ');
	val = val.replace(/fyèc/g,'평ㅎ');
	val = val.replace(/fyèb/g,'평ㅂ');
	val = val.replace(/fyèp/g,'평ㅍ');
	val = val.replace(/fyèm/g,'평ㅁ');
	val = val.replace(/fyèd/g,'평ㄷ');
	val = val.replace(/fyèt/g,'평ㅌ');
	val = val.replace(/fyèn/g,'평ㄴ');
	val = val.replace(/fyèl/g,'평ㅉ');
	val = val.replace(/fyèz/g,'평ㅆ');
	val = val.replace(/fyès/g,'평ㅅ');
	val = val.replace(/fwoq/g,'푕');
	val = val.replace(/zyèv/g,'쎲');
	val = val.replace(/fwog/g,'푕ㄱ');
	val = val.replace(/fwok/g,'푕ㅋ');
	val = val.replace(/zyèf/g,'쎮');
	val = val.replace(/zyèc/g,'쎻');
	val = val.replace(/fwov/g,'푕ㅄ');
	val = val.replace(/fwof/g,'푕ㄿ');
	val = val.replace(/fwoc/g,'푕ㅎ');
	val = val.replace(/fwob/g,'푕ㅂ');
	val = val.replace(/fwop/g,'푕ㅍ');
	val = val.replace(/fwom/g,'푕ㅁ');
	val = val.replace(/fwod/g,'푕ㄷ');
	val = val.replace(/fwot/g,'푕ㅌ');
	val = val.replace(/fwon/g,'푕ㄴ');
	val = val.replace(/fwol/g,'푕ㅉ');
	val = val.replace(/fwoz/g,'푕ㅆ');
	val = val.replace(/fwos/g,'푕ㅅ');
	val = val.replace(/fyoq/g,'푱');
	val = val.replace(/zyèb/g,'쎱');
	val = val.replace(/fyog/g,'푱ㄱ');
	val = val.replace(/fyok/g,'푱ㅋ');
	val = val.replace(/zyèp/g,'쎺');
	val = val.replace(/zyèm/g,'쎰');
	val = val.replace(/fyov/g,'푱ㅄ');
	val = val.replace(/fyof/g,'푱ㄿ');
	val = val.replace(/fyoc/g,'푱ㅎ');
	val = val.replace(/fyob/g,'푱ㅂ');
	val = val.replace(/fyop/g,'푱ㅍ');
	val = val.replace(/fyom/g,'푱ㅁ');
	val = val.replace(/fyod/g,'푱ㄷ');
	val = val.replace(/fyot/g,'푱ㅌ');
	val = val.replace(/fyon/g,'푱ㄴ');
	val = val.replace(/fyol/g,'푱ㅉ');
	val = val.replace(/fyoz/g,'푱ㅆ');
	val = val.replace(/fyos/g,'푱ㅅ');
	val = val.replace(/fweq/g,'퓅');
	val = val.replace(/zyèd/g,'쎧');
	val = val.replace(/fweg/g,'퓅ㄱ');
	val = val.replace(/fwek/g,'퓅ㅋ');
	val = val.replace(/zyèt/g,'쎹');
	val = val.replace(/zyèn/g,'쎤');
	val = val.replace(/fwev/g,'퓅ㅄ');
	val = val.replace(/fwef/g,'퓅ㄿ');
	val = val.replace(/fwec/g,'퓅ㅎ');
	val = val.replace(/fweb/g,'퓅ㅂ');
	val = val.replace(/fwep/g,'퓅ㅍ');
	val = val.replace(/fwem/g,'퓅ㅁ');
	val = val.replace(/fwed/g,'퓅ㄷ');
	val = val.replace(/fwet/g,'퓅ㅌ');
	val = val.replace(/fwen/g,'퓅ㄴ');
	val = val.replace(/fwel/g,'퓅ㅉ');
	val = val.replace(/fwez/g,'퓅ㅆ');
	val = val.replace(/fwes/g,'퓅ㅅ');
	val = val.replace(/fyeq/g,'폥');
	val = val.replace(/zyèl/g,'쎨');
	val = val.replace(/fyeg/g,'폥ㄱ');
	val = val.replace(/fyek/g,'폥ㅋ');
	val = val.replace(/zyèz/g,'쎴');
	val = val.replace(/zyès/g,'쎳');
	val = val.replace(/fyev/g,'폥ㅄ');
	val = val.replace(/fyef/g,'폥ㄿ');
	val = val.replace(/fyec/g,'폥ㅎ');
	val = val.replace(/fyeb/g,'폥ㅂ');
	val = val.replace(/fyep/g,'폥ㅍ');
	val = val.replace(/fyem/g,'폥ㅁ');
	val = val.replace(/fyed/g,'폥ㄷ');
	val = val.replace(/fyet/g,'폥ㅌ');
	val = val.replace(/fyen/g,'폥ㄴ');
	val = val.replace(/fyel/g,'폥ㅉ');
	val = val.replace(/fyez/g,'폥ㅆ');
	val = val.replace(/fyes/g,'폥ㅅ');
	val = val.replace(/fwuq/g,'퓽');
	val = val.replace(/zwoq/g,'쑁');
	val = val.replace(/fwug/g,'퓽ㄱ');
	val = val.replace(/fwuk/g,'퓽ㅋ');
	val = val.replace(/zwog/g,'쐭');
	val = val.replace(/gech/g,'겢');
	val = val.replace(/fwuv/g,'퓽ㅄ');
	val = val.replace(/fwuf/g,'퓽ㄿ');
	val = val.replace(/fwuc/g,'퓽ㅎ');
	val = val.replace(/fwub/g,'퓽ㅂ');
	val = val.replace(/fwup/g,'퓽ㅍ');
	val = val.replace(/fwum/g,'퓽ㅁ');
	val = val.replace(/fwud/g,'퓽ㄷ');
	val = val.replace(/fwut/g,'퓽ㅌ');
	val = val.replace(/fwun/g,'퓽ㄴ');
	val = val.replace(/fwul/g,'퓽ㅉ');
	val = val.replace(/fwuz/g,'퓽ㅆ');
	val = val.replace(/fwus/g,'퓽ㅅ');
	val = val.replace(/fyuq/g,'풍');
	val = val.replace(/tsyè/g,'뗘');
	val = val.replace(/fyug/g,'풍ㄱ');
	val = val.replace(/fyuk/g,'풍ㅋ');
	val = val.replace(/gedj/g,'겣');
	val = val.replace(/zwok/g,'쑄');
	val = val.replace(/fyuv/g,'풍ㅄ');
	val = val.replace(/fyuf/g,'풍ㄿ');
	val = val.replace(/fyuc/g,'풍ㅎ');
	val = val.replace(/fyub/g,'풍ㅂ');
	val = val.replace(/fyup/g,'풍ㅍ');
	val = val.replace(/fyum/g,'풍ㅁ');
	val = val.replace(/fyud/g,'풍ㄷ');
	val = val.replace(/fyut/g,'풍ㅌ');
	val = val.replace(/fyun/g,'풍ㄴ');
	val = val.replace(/fyul/g,'풍ㅉ');
	val = val.replace(/fyuz/g,'풍ㅆ');
	val = val.replace(/fyus/g,'풍ㅅ');
	val = val.replace(/fwiq/g,'퓡');
	val = val.replace(/zwov/g,'쐾');
	val = val.replace(/fwig/g,'퓡ㄱ');
	val = val.replace(/fwik/g,'퓡ㅋ');
	val = val.replace(/zwof/g,'쐺');
	val = val.replace(/zwoc/g,'쑇');
	val = val.replace(/fwiv/g,'퓡ㅄ');
	val = val.replace(/fwif/g,'퓡ㄿ');
	val = val.replace(/fwic/g,'퓡ㅎ');
	val = val.replace(/fwib/g,'퓡ㅂ');
	val = val.replace(/fwip/g,'퓡ㅍ');
	val = val.replace(/fwim/g,'퓡ㅁ');
	val = val.replace(/fwid/g,'퓡ㄷ');
	val = val.replace(/fwit/g,'퓡ㅌ');
	val = val.replace(/fwin/g,'퓡ㄴ');
	val = val.replace(/fwil/g,'퓡ㅉ');
	val = val.replace(/fwiz/g,'퓡ㅆ');
	val = val.replace(/fwis/g,'퓡ㅅ');
	val = val.replace(/fyiq/g,'픵');
	val = val.replace(/zwob/g,'쐽');
	val = val.replace(/fyig/g,'픵ㄱ');
	val = val.replace(/fyik/g,'픵ㅋ');
	val = val.replace(/zwop/g,'쑆');
	val = val.replace(/zwom/g,'쐼');
	val = val.replace(/fyiv/g,'픵ㅄ');
	val = val.replace(/fyif/g,'픵ㄿ');
	val = val.replace(/fyic/g,'픵ㅎ');
	val = val.replace(/fyib/g,'픵ㅂ');
	val = val.replace(/fyip/g,'픵ㅍ');
	val = val.replace(/fyim/g,'픵ㅁ');
	val = val.replace(/fyid/g,'픵ㄷ');
	val = val.replace(/fyit/g,'픵ㅌ');
	val = val.replace(/fyin/g,'픵ㄴ');
	val = val.replace(/fyil/g,'픵ㅉ');
	val = val.replace(/fyiz/g,'픵ㅆ');
	val = val.replace(/fyis/g,'픵ㅅ');
	val = val.replace(/zwod/g,'쐳');
	val = val.replace(/zwot/g,'쑅');
	val = val.replace(/zwon/g,'쐰');
	val = val.replace(/zwol/g,'쐴');
	val = val.replace(/fadj/g,'팡ㅊ');
	val = val.replace(/fach/g,'팡ㅈ');
	...
	val = val.replace(/fedj/g,'펭ㅊ');
	val = val.replace(/fech/g,'펭ㅈ');
	...
	val = val.replace(/fodj/g,'퐁ㅊ');
	val = val.replace(/foch/g,'퐁ㅈ');
	...
	val = val.replace(/fèdj/g,'펑ㅊ');
	val = val.replace(/fèch/g,'펑ㅈ');
	...
	val = val.replace(/fùdj/g,'팽ㅊ');
	val = val.replace(/fùch/g,'팽ㅈ');
	...
	val = val.replace(/fidj/g,'핑ㅊ');
	val = val.replace(/fich/g,'핑ㅈ');
	...
	val = val.replace(/fudj/g,'픙ㅊ');
	val = val.replace(/fuch/g,'픙ㅈ');
	...
	val = val.replace(/luch/g,'릉ㅈ');
	val = val.replace(/ludj/g,'릉ㅊ');
	val = val.replace(/pidj/g,'핓');
	val = val.replace(/pich/g,'핒');
	val = val.replace(/lich/g,'링ㅈ');
	val = val.replace(/lidj/g,'링ㅊ');
	val = val.replace(/lùch/g,'랭ㅈ');
	val = val.replace(/lùdj/g,'랭ㅊ');
	val = val.replace(/lèch/g,'렁ㅈ');
	val = val.replace(/lèdj/g,'렁ㅊ');
	val = val.replace(/loch/g,'롱ㅈ');
	val = val.replace(/lodj/g,'롱ㅊ');
	val = val.replace(/lech/g,'렝ㅈ');
	val = val.replace(/ledj/g,'렝ㅊ');
	val = val.replace(/lach/g,'랑ㅈ');
	val = val.replace(/ladj/g,'랑ㅊ');
	val = val.replace(/lyis/g,'릥ㅅ');
	val = val.replace(/lyiz/g,'릥ㅆ');
	val = val.replace(/lyil/g,'릥ㅉ');
	val = val.replace(/lyin/g,'릥ㄴ');
	val = val.replace(/pudj/g,'픛');
	val = val.replace(/puch/g,'픚');
	val = val.replace(/lyit/g,'릥ㅌ');
	val = val.replace(/lyid/g,'릥ㄷ');
	val = val.replace(/lyim/g,'릥ㅁ');
	val = val.replace(/lyip/g,'릥ㅍ');
	val = val.replace(/lyib/g,'릥ㅂ');
	val = val.replace(/lyic/g,'릥ㅎ');
	val = val.replace(/lyif/g,'릥ㄿ');
	val = val.replace(/lyiv/g,'릥ㅄ');
	val = val.replace(/syèq/g,'쪙');
	val = val.replace(/syèg/g,'쪅');
	val = val.replace(/lyik/g,'릥ㅋ');
	val = val.replace(/lyig/g,'릥ㄱ');
	...
	val = val.replace(/lwik/g,'륑ㅋ');
	val = val.replace(/lwig/g,'륑ㄱ');
	val = val.replace(/lwiq/g,'륑');
	val = val.replace(/madj/g,'맟');
	val = val.replace(/mach/g,'맞');
	val = val.replace(/lyus/g,'룽ㅅ');
	val = val.replace(/lyuz/g,'룽ㅆ');
	val = val.replace(/lyul/g,'룽ㅉ');
	val = val.replace(/lyun/g,'룽ㄴ');
	val = val.replace(/lyut/g,'룽ㅌ');
	val = val.replace(/lyud/g,'룽ㄷ');
	val = val.replace(/lyum/g,'룽ㅁ');
	val = val.replace(/lyup/g,'룽ㅍ');
	val = val.replace(/lyub/g,'룽ㅂ');
	val = val.replace(/lyuc/g,'룽ㅎ');
	val = val.replace(/lyuf/g,'룽ㄿ');
	val = val.replace(/lyuv/g,'룽ㅄ');
	val = val.replace(/swoz/g,'쬤');
	val = val.replace(/swos/g,'쬣');
	val = val.replace(/lyuk/g,'룽ㅋ');
	val = val.replace(/lyug/g,'룽ㄱ');
	val = val.replace(/medj/g,'멫');
	val = val.replace(/mech/g,'멪');
	val = val.replace(/lyuq/g,'룽');
	val = val.replace(/lwus/g,'륭ㅅ');
	val = val.replace(/lwuz/g,'륭ㅆ');
	val = val.replace(/lwul/g,'륭ㅉ');
	val = val.replace(/lwun/g,'륭ㄴ');
	val = val.replace(/lwut/g,'륭ㅌ');
	val = val.replace(/lwud/g,'륭ㄷ');
	val = val.replace(/lwum/g,'륭ㅁ');
	val = val.replace(/lwup/g,'륭ㅍ');
	val = val.replace(/lwub/g,'륭ㅂ');
	val = val.replace(/lwuc/g,'륭ㅎ');
	val = val.replace(/lwuf/g,'륭ㄿ');
	val = val.replace(/lwuv/g,'륭ㅄ');
	val = val.replace(/syoq/g,'쭁');
	val = val.replace(/yoch/g,'욪');
	val = val.replace(/lwuk/g,'륭ㅋ');
	val = val.replace(/modj/g,'몿');
	val = val.replace(/moch/g,'몾');
	val = val.replace(/lwug/g,'륭ㄱ');
	val = val.replace(/lwuq/g,'륭');
	val = val.replace(/lyes/g,'롕ㅅ');
	val = val.replace(/lyez/g,'롕ㅆ');
	val = val.replace(/lyel/g,'롕ㅉ');
	val = val.replace(/lyen/g,'롕ㄴ');
	val = val.replace(/lyet/g,'롕ㅌ');
	val = val.replace(/lyed/g,'롕ㄷ');
	val = val.replace(/lyem/g,'롕ㅁ');
	val = val.replace(/lyep/g,'롕ㅍ');
	val = val.replace(/lyeb/g,'롕ㅂ');
	val = val.replace(/lyec/g,'롕ㅎ');
	val = val.replace(/lyef/g,'롕ㄿ');
	val = val.replace(/lyev/g,'롕ㅄ');
	val = val.replace(/yodj/g,'욫');
	val = val.replace(/syog/g,'쬭');
	val = val.replace(/mèdj/g,'멏');
	val = val.replace(/mèch/g,'멎');
	val = val.replace(/lyek/g,'롕ㅋ');
	val = val.replace(/lyeg/g,'롕ㄱ');
	val = val.replace(/lyeq/g,'롕');
	val = val.replace(/lwes/g,'뤵ㅅ');
	val = val.replace(/lwez/g,'뤵ㅆ');
	val = val.replace(/lwel/g,'뤵ㅉ');
	val = val.replace(/lwen/g,'뤵ㄴ');
	val = val.replace(/lwet/g,'뤵ㅌ');
	val = val.replace(/lwed/g,'뤵ㄷ');
	val = val.replace(/lwem/g,'뤵ㅁ');
	val = val.replace(/lwep/g,'뤵ㅍ');
	val = val.replace(/lweb/g,'뤵ㅂ');
	val = val.replace(/lwec/g,'뤵ㅎ');
	val = val.replace(/lwef/g,'뤵ㄿ');
	val = val.replace(/lwev/g,'뤵ㅄ');
	val = val.replace(/syok/g,'쭄');
	val = val.replace(/mùdj/g,'맻');
	val = val.replace(/mùch/g,'맺');
	val = val.replace(/syov/g,'쬾');
	val = val.replace(/lwek/g,'뤵ㅋ');
	val = val.replace(/lweg/g,'뤵ㄱ');
	val = val.replace(/lweq/g,'뤵');
	val = val.replace(/lyos/g,'룡ㅅ');
	val = val.replace(/lyoz/g,'룡ㅆ');
	val = val.replace(/lyol/g,'룡ㅉ');
	val = val.replace(/lyon/g,'룡ㄴ');
	val = val.replace(/lyot/g,'룡ㅌ');
	val = val.replace(/lyod/g,'룡ㄷ');
	val = val.replace(/lyom/g,'룡ㅁ');
	val = val.replace(/lyop/g,'룡ㅍ');
	val = val.replace(/lyob/g,'룡ㅂ');
	val = val.replace(/lyoc/g,'룡ㅎ');
	val = val.replace(/lyof/g,'룡ㄿ');
	val = val.replace(/lyov/g,'룡ㅄ');
	val = val.replace(/midj/g,'및');
	val = val.replace(/mich/g,'밎');
	val = val.replace(/syof/g,'쬺');
	val = val.replace(/syoc/g,'쭇');
	val = val.replace(/lyok/g,'룡ㅋ');
	val = val.replace(/lyog/g,'룡ㄱ');
	val = val.replace(/lyoq/g,'룡');
	val = val.replace(/lwos/g,'룅ㅅ');
	val = val.replace(/lwoz/g,'룅ㅆ');
	val = val.replace(/lwol/g,'룅ㅉ');
	val = val.replace(/lwon/g,'룅ㄴ');
	val = val.replace(/lwot/g,'룅ㅌ');
	val = val.replace(/lwod/g,'룅ㄷ');
	val = val.replace(/lwom/g,'룅ㅁ');
	val = val.replace(/lwop/g,'룅ㅍ');
	val = val.replace(/lwob/g,'룅ㅂ');
	val = val.replace(/lwoc/g,'룅ㅎ');
	val = val.replace(/lwof/g,'룅ㄿ');
	val = val.replace(/mudj/g,'믗');
	val = val.replace(/much/g,'믖');
	val = val.replace(/lwov/g,'룅ㅄ');
	val = val.replace(/syob/g,'쬽');
	val = val.replace(/syop/g,'쭆');
	val = val.replace(/lwok/g,'룅ㅋ');
	val = val.replace(/lwog/g,'룅ㄱ');
	val = val.replace(/lwoq/g,'룅');
	val = val.replace(/lyès/g,'령ㅅ');
	val = val.replace(/lyèz/g,'령ㅆ');
	val = val.replace(/lyèl/g,'령ㅉ');
	val = val.replace(/lyèn/g,'령ㄴ');
	val = val.replace(/lyèt/g,'령ㅌ');
	val = val.replace(/lyèd/g,'령ㄷ');
	val = val.replace(/rwaq/g,'뢍');
	val = val.replace(/lyèm/g,'령ㅁ');
	...
	val = val.replace(/lwèn/g,'뤙ㄴ');
	val = val.replace(/lwèt/g,'뤙ㅌ');
	val = val.replace(/lwèd/g,'뤙ㄷ');
	val = val.replace(/lwèm/g,'뤙ㅁ');
	val = val.replace(/radj/g,'랓');
	val = val.replace(/rach/g,'랒');
	val = val.replace(/lwèp/g,'뤙ㅍ');
	val = val.replace(/lwèb/g,'뤙ㅂ');
	val = val.replace(/lwèc/g,'뤙ㅎ');
	val = val.replace(/lwèf/g,'뤙ㄿ');
	val = val.replace(/lwèv/g,'뤙ㅄ');
	val = val.replace(/syec/g,'쪻');
	val = val.replace(/syeb/g,'쪱');
	val = val.replace(/lwèk/g,'뤙ㅋ');
	val = val.replace(/lwèg/g,'뤙ㄱ');
	val = val.replace(/lwèq/g,'뤙');
	val = val.replace(/lyùs/g,'럥ㅅ');
	val = val.replace(/lyùz/g,'럥ㅆ');
	val = val.replace(/lyùl/g,'럥ㅉ');
	val = val.replace(/lyùn/g,'럥ㄴ');
	val = val.replace(/lyùt/g,'럥ㅌ');
	val = val.replace(/lyùd/g,'럥ㄷ');
	val = val.replace(/redj/g,'렟');
	val = val.replace(/rech/g,'렞');
	val = val.replace(/lyùm/g,'럥ㅁ');
	val = val.replace(/lyùp/g,'럥ㅍ');
	val = val.replace(/lyùb/g,'럥ㅂ');
	val = val.replace(/lyùc/g,'럥ㅎ');
	val = val.replace(/lyùf/g,'럥ㄿ');
	val = val.replace(/lyùv/g,'럥ㅄ');
	val = val.replace(/syep/g,'쪺');
	val = val.replace(/syem/g,'쪰');
	val = val.replace(/lyùk/g,'럥ㅋ');
	val = val.replace(/lyùg/g,'럥ㄱ');
	val = val.replace(/lyùq/g,'럥');
	val = val.replace(/lwùs/g,'뢩ㅅ');
	val = val.replace(/lwùz/g,'뢩ㅆ');
	val = val.replace(/lwùl/g,'뢩ㅉ');
	val = val.replace(/lwùn/g,'뢩ㄴ');
	val = val.replace(/lwùt/g,'뢩ㅌ');
	val = val.replace(/rodj/g,'롳');
	val = val.replace(/roch/g,'롲');
	val = val.replace(/lwùd/g,'뢩ㄷ');
	val = val.replace(/lwùm/g,'뢩ㅁ');
	val = val.replace(/lwùp/g,'뢩ㅍ');
	val = val.replace(/lwùb/g,'뢩ㅂ');
	val = val.replace(/lwùc/g,'뢩ㅎ');
	val = val.replace(/lwùf/g,'뢩ㄿ');
	val = val.replace(/lwùv/g,'뢩ㅄ');
	val = val.replace(/syed/g,'쪧');
	val = val.replace(/syet/g,'쪹');
	val = val.replace(/lwùk/g,'뢩ㅋ');
	val = val.replace(/lwùg/g,'뢩ㄱ');
	val = val.replace(/lwùq/g,'뢩');
	val = val.replace(/lyas/g,'량ㅅ');
	val = val.replace(/lyaz/g,'량ㅆ');
	val = val.replace(/lyal/g,'량ㅉ');
	val = val.replace(/lyan/g,'량ㄴ');
	val = val.replace(/rèdj/g,'렃');
	val = val.replace(/rèch/g,'렂');
	val = val.replace(/lyat/g,'량ㅌ');
	val = val.replace(/lyad/g,'량ㄷ');
	val = val.replace(/lyam/g,'량ㅁ');
	val = val.replace(/lyap/g,'량ㅍ');
	val = val.replace(/lyab/g,'량ㅂ');
	val = val.replace(/lyac/g,'량ㅎ');
	val = val.replace(/lyaf/g,'량ㄿ');
	val = val.replace(/lyav/g,'량ㅄ');
	val = val.replace(/syen/g,'쪤');
	val = val.replace(/syel/g,'쪨');
	val = val.replace(/lyak/g,'량ㅋ');
	val = val.replace(/lyag/g,'량ㄱ');
	val = val.replace(/lyaq/g,'량');
	val = val.replace(/lwas/g,'뢍ㅅ');
	val = val.replace(/lwaz/g,'뢍ㅆ');
	val = val.replace(/lwal/g,'뢍ㅉ');
	val = val.replace(/rùdj/g,'랯');
	val = val.replace(/rùch/g,'랮');
	val = val.replace(/lwan/g,'뢍ㄴ');
	val = val.replace(/lwat/g,'뢍ㅌ');
	val = val.replace(/lwad/g,'뢍ㄷ');
	val = val.replace(/lwam/g,'뢍ㅁ');
	val = val.replace(/lwap/g,'뢍ㅍ');
	val = val.replace(/lwab/g,'뢍ㅂ');
	val = val.replace(/lwac/g,'뢍ㅎ');
	val = val.replace(/lwaf/g,'뢍ㄿ');
	val = val.replace(/lwav/g,'뢍ㅄ');
	val = val.replace(/syez/g,'쪴');
	val = val.replace(/wèch/g,'웢');
	val = val.replace(/lwak/g,'뢍ㅋ');
	val = val.replace(/lwag/g,'뢍ㄱ');
	...
	val = val.replace(/lag/g,'랑ㄱ');
	val = val.replace(/lak/g,'랑ㅋ');
	val = val.replace(/pis/g,'핏');
	val = val.replace(/piz/g,'핐');
	val = val.replace(/lav/g,'랑ㅄ');
	val = val.replace(/laf/g,'랑ㄿ');
	val = val.replace(/lac/g,'랑ㅎ');
	val = val.replace(/lab/g,'랑ㅂ');
	val = val.replace(/lap/g,'랑ㅍ');
	val = val.replace(/lam/g,'랑ㅁ');
	val = val.replace(/lad/g,'랑ㄷ');
	val = val.replace(/lat/g,'랑ㅌ');
	val = val.replace(/lan/g,'랑ㄴ');
	val = val.replace(/lal/g,'랑ㅉ');
	val = val.replace(/laz/g,'랑ㅆ');
	val = val.replace(/las/g,'랑ㅅ');
	val = val.replace(/leq/g,'렝');
	val = val.replace(/wèz/g,'웠');
	val = val.replace(/leg/g,'렝ㄱ');
	val = val.replace(/lek/g,'렝ㅋ');
	val = val.replace(/pil/g,'필');
	val = val.replace(/pin/g,'핀');
	val = val.replace(/lev/g,'렝ㅄ');
	val = val.replace(/lef/g,'렝ㄿ');
	val = val.replace(/lec/g,'렝ㅎ');
	val = val.replace(/leb/g,'렝ㅂ');
	val = val.replace(/lep/g,'렝ㅍ');
	val = val.replace(/lem/g,'렝ㅁ');
	val = val.replace(/led/g,'렝ㄷ');
	val = val.replace(/let/g,'렝ㅌ');
	val = val.replace(/len/g,'렝ㄴ');
	val = val.replace(/lel/g,'렝ㅉ');
	val = val.replace(/lez/g,'렝ㅆ');
	val = val.replace(/les/g,'렝ㅅ');
	val = val.replace(/loq/g,'롱');
	val = val.replace(/wèl/g,'월');
	val = val.replace(/log/g,'롱ㄱ');
	val = val.replace(/lok/g,'롱ㅋ');
	val = val.replace(/pit/g,'핕');
	val = val.replace(/pid/g,'핃');
	val = val.replace(/lov/g,'롱ㅄ');
	val = val.replace(/lof/g,'롱ㄿ');
	val = val.replace(/loc/g,'롱ㅎ');
	val = val.replace(/lob/g,'롱ㅂ');
	val = val.replace(/lop/g,'롱ㅍ');
	val = val.replace(/lom/g,'롱ㅁ');
	val = val.replace(/lod/g,'롱ㄷ');
	val = val.replace(/lot/g,'롱ㅌ');
	val = val.replace(/lon/g,'롱ㄴ');
	val = val.replace(/lol/g,'롱ㅉ');
	val = val.replace(/loz/g,'롱ㅆ');
	val = val.replace(/los/g,'롱ㅅ');
	val = val.replace(/lèq/g,'렁');
	val = val.replace(/wèn/g,'원');
	val = val.replace(/lèg/g,'렁ㄱ');
	val = val.replace(/lèk/g,'렁ㅋ');
	val = val.replace(/pim/g,'핌');
	val = val.replace(/pip/g,'핖');
	val = val.replace(/lèv/g,'렁ㅄ');
	val = val.replace(/lèf/g,'렁ㄿ');
	val = val.replace(/lèc/g,'렁ㅎ');
	val = val.replace(/lèb/g,'렁ㅂ');
	val = val.replace(/lèp/g,'렁ㅍ');
	val = val.replace(/lèm/g,'렁ㅁ');
	val = val.replace(/lèd/g,'렁ㄷ');
	val = val.replace(/lèt/g,'렁ㅌ');
	val = val.replace(/lèn/g,'렁ㄴ');
	val = val.replace(/lèl/g,'렁ㅉ');
	val = val.replace(/lèz/g,'렁ㅆ');
	val = val.replace(/lès/g,'렁ㅅ');
	val = val.replace(/lùq/g,'랭');
	val = val.replace(/wèt/g,'웥');
	val = val.replace(/lùg/g,'랭ㄱ');
	val = val.replace(/lùk/g,'랭ㅋ');
	val = val.replace(/pib/g,'핍');
	val = val.replace(/pic/g,'핗');
	val = val.replace(/lùv/g,'랭ㅄ');
	val = val.replace(/lùf/g,'랭ㄿ');
	val = val.replace(/lùc/g,'랭ㅎ');
	val = val.replace(/lùb/g,'랭ㅂ');
	val = val.replace(/lùp/g,'랭ㅍ');
	val = val.replace(/lùm/g,'랭ㅁ');
	val = val.replace(/lùd/g,'랭ㄷ');
	val = val.replace(/lùt/g,'랭ㅌ');
	val = val.replace(/lùn/g,'랭ㄴ');
	val = val.replace(/lùl/g,'랭ㅉ');
	val = val.replace(/lùz/g,'랭ㅆ');
	val = val.replace(/lùs/g,'랭ㅅ');
	val = val.replace(/liq/g,'링');
	val = val.replace(/wèd/g,'웓');
	val = val.replace(/lig/g,'링ㄱ');
	val = val.replace(/lik/g,'링ㅋ');
	val = val.replace(/pif/g,'핊');
	val = val.replace(/piv/g,'핎');
	val = val.replace(/liv/g,'링ㅄ');
	val = val.replace(/lif/g,'링ㄿ');
	val = val.replace(/lic/g,'링ㅎ');
	val = val.replace(/lib/g,'링ㅂ');
	val = val.replace(/lip/g,'링ㅍ');
	val = val.replace(/lim/g,'링ㅁ');
	val = val.replace(/lid/g,'링ㄷ');
	val = val.replace(/lit/g,'링ㅌ');
	val = val.replace(/lin/g,'링ㄴ');
	val = val.replace(/lil/g,'링ㅉ');
	val = val.replace(/liz/g,'링ㅆ');
	val = val.replace(/lis/g,'링ㅅ');
	val = val.replace(/luq/g,'릉');
	val = val.replace(/wèm/g,'웜');
	val = val.replace(/lug/g,'릉ㄱ');
	val = val.replace(/luk/g,'릉ㅋ');
	val = val.replace(/pik/g,'핔');
	val = val.replace(/pig/g,'픽');
	val = val.replace(/luv/g,'릉ㅄ');
	val = val.replace(/luf/g,'릉ㄿ');
	val = val.replace(/luc/g,'릉ㅎ');
	val = val.replace(/lub/g,'릉ㅂ');
	val = val.replace(/lup/g,'릉ㅍ');
	val = val.replace(/lum/g,'릉ㅁ');
	val = val.replace(/lud/g,'릉ㄷ');
	val = val.replace(/lut/g,'릉ㅌ');
	val = val.replace(/lun/g,'릉ㄴ');
	val = val.replace(/lul/g,'릉ㅉ');
	val = val.replace(/luz/g,'릉ㅆ');
	val = val.replace(/lus/g,'릉ㅅ');
	...
	val = val.replace(/fus/g,'픙ㅅ');
	val = val.replace(/fuz/g,'픙ㅆ');
	val = val.replace(/ful/g,'픙ㅉ');
	val = val.replace(/fun/g,'픙ㄴ');
	val = val.replace(/fut/g,'픙ㅌ');
	val = val.replace(/fud/g,'픙ㄷ');
	val = val.replace(/fum/g,'픙ㅁ');
	val = val.replace(/dzu/g,'쁘');
	val = val.replace(/fup/g,'픙ㅍ');
	val = val.replace(/fub/g,'픙ㅂ');
	val = val.replace(/fuc/g,'픙ㅎ');
	val = val.replace(/fuf/g,'픙ㄿ');
	val = val.replace(/fuv/g,'픙ㅄ');
	val = val.replace(/fuk/g,'픙ㅋ');
	val = val.replace(/fug/g,'픙ㄱ');
	val = val.replace(/yùf/g,'얦');
	val = val.replace(/fuq/g,'픙');
	val = val.replace(/fis/g,'핑ㅅ');
	val = val.replace(/fiz/g,'핑ㅆ');
	val = val.replace(/fil/g,'핑ㅉ');
	val = val.replace(/fin/g,'핑ㄴ');
	val = val.replace(/fit/g,'핑ㅌ');
	val = val.replace(/fid/g,'핑ㄷ');
	val = val.replace(/fim/g,'핑ㅁ');
	val = val.replace(/fip/g,'핑ㅍ');
	val = val.replace(/fib/g,'핑ㅂ');
	val = val.replace(/fic/g,'핑ㅎ');
	val = val.replace(/fif/g,'핑ㄿ');
	val = val.replace(/fiv/g,'핑ㅄ');
	val = val.replace(/fik/g,'핑ㅋ');
	val = val.replace(/fig/g,'핑ㄱ');
	val = val.replace(/yùv/g,'얪');
	val = val.replace(/fiq/g,'핑');
	val = val.replace(/fùs/g,'팽ㅅ');
	val = val.replace(/fùz/g,'팽ㅆ');
	val = val.replace(/fùl/g,'팽ㅉ');
	val = val.replace(/fùn/g,'팽ㄴ');
	val = val.replace(/fùt/g,'팽ㅌ');
	val = val.replace(/fùd/g,'팽ㄷ');
	val = val.replace(/fùm/g,'팽ㅁ');
	val = val.replace(/fùp/g,'팽ㅍ');
	val = val.replace(/fùb/g,'팽ㅂ');
	val = val.replace(/fùc/g,'팽ㅎ');
	val = val.replace(/fùf/g,'팽ㄿ');
	val = val.replace(/fùv/g,'팽ㅄ');
	val = val.replace(/fùk/g,'팽ㅋ');
	val = val.replace(/fùg/g,'팽ㄱ');
	val = val.replace(/yùk/g,'얰');
	val = val.replace(/fùq/g,'팽');
	val = val.replace(/fès/g,'펑ㅅ');
	val = val.replace(/fèz/g,'펑ㅆ');
	val = val.replace(/fèl/g,'펑ㅉ');
	val = val.replace(/fèn/g,'펑ㄴ');
	val = val.replace(/fèt/g,'펑ㅌ');
	val = val.replace(/fèd/g,'펑ㄷ');
	val = val.replace(/fèm/g,'펑ㅁ');
	val = val.replace(/fèp/g,'펑ㅍ');
	val = val.replace(/fèb/g,'펑ㅂ');
	val = val.replace(/fèc/g,'펑ㅎ');
	val = val.replace(/fèf/g,'펑ㄿ');
	val = val.replace(/fèv/g,'펑ㅄ');
	val = val.replace(/fèk/g,'펑ㅋ');
	val = val.replace(/fèg/g,'펑ㄱ');
	val = val.replace(/yùg/g,'얙');
	val = val.replace(/fèq/g,'펑');
	val = val.replace(/fos/g,'퐁ㅅ');
	val = val.replace(/foz/g,'퐁ㅆ');
	val = val.replace(/fol/g,'퐁ㅉ');
	val = val.replace(/fon/g,'퐁ㄴ');
	val = val.replace(/fot/g,'퐁ㅌ');
	val = val.replace(/fod/g,'퐁ㄷ');
	val = val.replace(/fom/g,'퐁ㅁ');
	val = val.replace(/fop/g,'퐁ㅍ');
	val = val.replace(/fob/g,'퐁ㅂ');
	val = val.replace(/foc/g,'퐁ㅎ');
	val = val.replace(/fof/g,'퐁ㄿ');
	val = val.replace(/fov/g,'퐁ㅄ');
	val = val.replace(/fok/g,'퐁ㅋ');
	val = val.replace(/fog/g,'퐁ㄱ');
	val = val.replace(/sib/g,'찝');
	val = val.replace(/foq/g,'퐁');
	val = val.replace(/fes/g,'펭ㅅ');
	val = val.replace(/fez/g,'펭ㅆ');
	val = val.replace(/fel/g,'펭ㅉ');
	val = val.replace(/fen/g,'펭ㄴ');
	val = val.replace(/fet/g,'펭ㅌ');
	val = val.replace(/fed/g,'펭ㄷ');
	val = val.replace(/fem/g,'펭ㅁ');
	val = val.replace(/fep/g,'펭ㅍ');
	val = val.replace(/feb/g,'펭ㅂ');
	val = val.replace(/fec/g,'펭ㅎ');
	val = val.replace(/fef/g,'펭ㄿ');
	val = val.replace(/fev/g,'펭ㅄ');
	val = val.replace(/fek/g,'펭ㅋ');
	val = val.replace(/feg/g,'펭ㄱ');
	val = val.replace(/syu/g,'쭈');
	val = val.replace(/feq/g,'펭');
	val = val.replace(/fas/g,'팡ㅅ');
	val = val.replace(/faz/g,'팡ㅆ');
	val = val.replace(/fal/g,'팡ㅉ');
	val = val.replace(/fan/g,'팡ㄴ');
	val = val.replace(/fat/g,'팡ㅌ');
	val = val.replace(/fad/g,'팡ㄷ');
	val = val.replace(/fam/g,'팡ㅁ');
	val = val.replace(/fap/g,'팡ㅍ');
	val = val.replace(/fab/g,'팡ㅂ');
	val = val.replace(/fac/g,'팡ㅎ');
	val = val.replace(/faf/g,'팡ㄿ');
	val = val.replace(/fav/g,'팡ㅄ');
	val = val.replace(/fak/g,'팡ㅋ');
	val = val.replace(/fag/g,'팡ㄱ');
	val = val.replace(/yùq/g,'얭');
	val = val.replace(/faq/g,'팡');
	val = val.replace(/fyi/g,'픵');
	val = val.replace(/fwi/g,'퓡');
	val = val.replace(/fyu/g,'풍');
	val = val.replace(/fwu/g,'퓽');
	val = val.replace(/fye/g,'폥');
	val = val.replace(/fwe/g,'퓅');
	val = val.replace(/fyo/g,'푱');
	val = val.replace(/fwo/g,'푕');
	val = val.replace(/fyè/g,'평');
	val = val.replace(/fwè/g,'풩');
	val = val.replace(/fyù/g,'퍵');
	val = val.replace(/fwù/g,'퐹');
	val = val.replace(/fya/g,'퍙');
	val = val.replace(/fwa/g,'퐝');
	val = val.replace(/vus/g,'븡ㅅ');
	val = val.replace(/vuz/g,'븡ㅆ');
	val = val.replace(/vul/g,'븡ㅉ');
	val = val.replace(/vun/g,'븡ㄴ');
	val = val.replace(/vut/g,'븡ㅌ');
	val = val.replace(/vud/g,'븡ㄷ');
	val = val.replace(/vum/g,'븡ㅁ');
	val = val.replace(/vup/g,'븡ㅍ');
	val = val.replace(/vub/g,'븡ㅂ');
	val = val.replace(/vuc/g,'븡ㅎ');
	val = val.replace(/vuf/g,'븡ㄿ');
	val = val.replace(/vuv/g,'븡ㅄ');
	val = val.replace(/vuk/g,'븡ㅋ');
	val = val.replace(/vug/g,'븡ㄱ');
	val = val.replace(/wùs/g,'왯');
	val = val.replace(/vuq/g,'븡');
	val = val.replace(/vis/g,'빙ㅅ');
	val = val.replace(/viz/g,'빙ㅆ');
	val = val.replace(/vil/g,'빙ㅉ');
	val = val.replace(/vin/g,'빙ㄴ');
	val = val.replace(/vit/g,'빙ㅌ');
	val = val.replace(/vid/g,'빙ㄷ');
	val = val.replace(/vim/g,'빙ㅁ');
	val = val.replace(/vip/g,'빙ㅍ');
	val = val.replace(/vib/g,'빙ㅂ');
	val = val.replace(/vic/g,'빙ㅎ');
	val = val.replace(/vif/g,'빙ㄿ');
	val = val.replace(/viv/g,'빙ㅄ');
	val = val.replace(/vik/g,'빙ㅋ');
	val = val.replace(/vig/g,'빙ㄱ');
	val = val.replace(/wùz/g,'왰');
	val = val.replace(/viq/g,'빙');
	val = val.replace(/vùs/g,'뱅ㅅ');
	val = val.replace(/vùz/g,'뱅ㅆ');
	val = val.replace(/vùl/g,'뱅ㅉ');
	val = val.replace(/vùn/g,'뱅ㄴ');
	val = val.replace(/vùt/g,'뱅ㅌ');
	val = val.replace(/vùd/g,'뱅ㄷ');
	val = val.replace(/vùm/g,'뱅ㅁ');
	val = val.replace(/vùp/g,'뱅ㅍ');
	val = val.replace(/vùb/g,'뱅ㅂ');
	val = val.replace(/vùc/g,'뱅ㅎ');
	val = val.replace(/vùf/g,'뱅ㄿ');
	val = val.replace(/vùv/g,'뱅ㅄ');
	val = val.replace(/vùk/g,'뱅ㅋ');
	val = val.replace(/vùg/g,'뱅ㄱ');
	val = val.replace(/wùl/g,'왤');
	val = val.replace(/vùq/g,'뱅');
	val = val.replace(/vès/g,'벙ㅅ');
	val = val.replace(/vèz/g,'벙ㅆ');
	val = val.replace(/vèl/g,'벙ㅉ');
	val = val.replace(/vèn/g,'벙ㄴ');
	val = val.replace(/vèt/g,'벙ㅌ');
	val = val.replace(/vèd/g,'벙ㄷ');
	val = val.replace(/vèm/g,'벙ㅁ');
	val = val.replace(/vèp/g,'벙ㅍ');
	val = val.replace(/vèb/g,'벙ㅂ');
	val = val.replace(/vèc/g,'벙ㅎ');
	val = val.replace(/vèf/g,'벙ㄿ');
	val = val.replace(/vèv/g,'벙ㅄ');
	val = val.replace(/vèk/g,'벙ㅋ');
	val = val.replace(/vèg/g,'벙ㄱ');
	val = val.replace(/wùn/g,'왠');
	val = val.replace(/vèq/g,'벙');
	val = val.replace(/vos/g,'봉ㅅ');
	val = val.replace(/voz/g,'봉ㅆ');
	val = val.replace(/vol/g,'봉ㅉ');
	val = val.replace(/von/g,'봉ㄴ');
	val = val.replace(/vot/g,'봉ㅌ');
	val = val.replace(/vod/g,'봉ㄷ');
	val = val.replace(/vom/g,'봉ㅁ');
	val = val.replace(/vop/g,'봉ㅍ');
	val = val.replace(/vob/g,'봉ㅂ');
	val = val.replace(/voc/g,'봉ㅎ');
	val = val.replace(/vof/g,'봉ㄿ');
	val = val.replace(/vov/g,'봉ㅄ');
	val = val.replace(/vok/g,'봉ㅋ');
	val = val.replace(/vog/g,'봉ㄱ');
	val = val.replace(/wùt/g,'왵');
	val = val.replace(/voq/g,'봉');
	val = val.replace(/ves/g,'벵ㅅ');
	val = val.replace(/vez/g,'벵ㅆ');
	val = val.replace(/vel/g,'벵ㅉ');
	val = val.replace(/ven/g,'벵ㄴ');
	val = val.replace(/vet/g,'벵ㅌ');
	val = val.replace(/ved/g,'벵ㄷ');
	val = val.replace(/vem/g,'벵ㅁ');
	val = val.replace(/vep/g,'벵ㅍ');
	val = val.replace(/veb/g,'벵ㅂ');
	val = val.replace(/vec/g,'벵ㅎ');
	val = val.replace(/vef/g,'벵ㄿ');
	val = val.replace(/vev/g,'벵ㅄ');
	val = val.replace(/vek/g,'벵ㅋ');
	val = val.replace(/veg/g,'벵ㄱ');
	val = val.replace(/wùd/g,'왣');
	val = val.replace(/veq/g,'벵');
	val = val.replace(/vas/g,'방ㅅ');
	val = val.replace(/vaz/g,'방ㅆ');
	val = val.replace(/val/g,'방ㅉ');
	val = val.replace(/van/g,'방ㄴ');
	val = val.replace(/vat/g,'방ㅌ');
	val = val.replace(/vad/g,'방ㄷ');
	val = val.replace(/vam/g,'방ㅁ');
	val = val.replace(/vap/g,'방ㅍ');
	val = val.replace(/vab/g,'방ㅂ');
	val = val.replace(/vac/g,'방ㅎ');
	val = val.replace(/vaf/g,'방ㄿ');
	val = val.replace(/vav/g,'방ㅄ');
	val = val.replace(/vak/g,'방ㅋ');
	val = val.replace(/vag/g,'방ㄱ');
	val = val.replace(/wùm/g,'왬');
	val = val.replace(/vaq/g,'방');
	val = val.replace(/vyi/g,'븽');
	val = val.replace(/vwi/g,'뷩');
	val = val.replace(/vyu/g,'붕');
	val = val.replace(/vwu/g,'븅');
	val = val.replace(/vye/g,'볭');
	val = val.replace(/vwe/g,'뷍');
	val = val.replace(/vyo/g,'뵹');
	val = val.replace(/vwo/g,'뵝');
	val = val.replace(/vyè/g,'병');
	val = val.replace(/vwè/g,'붱');
	val = val.replace(/vyù/g,'뱽');
	val = val.replace(/vwù/g,'뵁');
	val = val.replace(/vya/g,'뱡');
	val = val.replace(/vwa/g,'봥');
	...
	val = val.replace(/la/g,'랑');
	val = val.replace(/le/g,'렝');
	val = val.replace(/lo/g,'롱');
	val = val.replace(/lè/g,'렁');
	val = val.replace(/lù/g,'랭');
	val = val.replace(/li/g,'링');
	val = val.replace(/lu/g,'릉');
	...
	val = val.replace(/fu/g,'픙');
	val = val.replace(/fi/g,'핑');
	val = val.replace(/fù/g,'팽');
	val = val.replace(/fè/g,'펑');
	val = val.replace(/fo/g,'퐁');
	val = val.replace(/fe/g,'펭');
	val = val.replace(/fa/g,'팡');
	val = val.replace(/vu/g,'븡');
	val = val.replace(/vi/g,'빙');
	val = val.replace(/vù/g,'뱅');
	val = val.replace(/vè/g,'벙');
	val = val.replace(/vo/g,'봉');
	val = val.replace(/ve/g,'벵');
	val = val.replace(/va/g,'방');
